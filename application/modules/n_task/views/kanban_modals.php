            ...
            <div class="modal-body">
                ...
                <div class="tab-content bck">
                                ...
                                <select class="form-control task_container" id="task_container_edit"
                                    ...
                                    <?php foreach ($containers as $container) : ?>
                                        <option value="<?php echo $container['container_id']; ?>"
                                                style="color:<?php echo $container['container_color']; ?>"><?php echo $container['container_name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                    ...
                    <div id="tab_attachments" class="tab-pane fade in">
                        ...
                        <form action="/n_task/upload-target" class="dropzone dropzone-area dz-clickable p-0"
                              id="dropzone_form">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        ...
                        <a href="<?php echo base_url(); ?>n_task/delete_r/task_periods/task_periods_id/<?php echo $task_standby['task_periods_id']; ?>"
                                                    ...
                                                    <li class="list-group-item"
                                                        ...
                                                        <span class="handle"
                                                              style="color:<?php echo $container['container_color']; ?>;"><i
                                                                    class="fas fa-circle"></i></span> <?php echo $container['container_name']; ?>
