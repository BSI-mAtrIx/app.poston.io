    ...
    <div class="section-body">
        ...
        <div class="row pl-1">
            <div id="timer_container"
                 class="width-300 badge badge-light-primary mb-1 d-inline-flex align-items-center ml-2"
    ...
    <i class="bx bx-x"></i>
                            ...
                            <div class="todo-app-menu">
                                <div class="form-group text-center add-task pl-0 pr-0">
                                    ...
                                    <button href="#" class="btn btn-primary mb-1 ml-2" data-toggle="modal"
                                    ...
                                    <div class="todo-app-list">
                                        ...
                                        <div class="todo-task-list list-group">
                                            ...
                                            <div class="card-header pb-0 mb-0">
                                                <h4 class="card-title mb-0"><?php echo $board_name_active; ?>
                                                    <button class="kanban-title-button btn btn-primary btn-xs nodrag float-right"
                                                            data-toggle="modal" data-target="#addColumnModal"
