...
$lang["the_image_was_not_uploaded"] = "The image was not uploaded successfully.";
...
$lang["ad_preview_not_created_successfully"] = "Ad preview wasn't created created successfully";
...
$lang["supported_campaign_objectives: link_clicks, page_likes, post_engagement, facebook_ads_video_views"] = "Supported campaign objectives: link_clicks, page_likes, post_engagement, facebook_ads_video_views, sponsored messages";
...
$lang["ad_preview_not_created"] = "Ad Preview wasn't created created successfully";
...
$lang["an_image_is_required_to_create_ad_preview"] = "You have to upload an image to create a Ad Preview.";
...
$lang["detailed_targeting"] = "Search interest suggestions to target";
$lang["search_for_suggestions"] = "Search for suggestions ...";
$lang["no_suggestions_found"] = "No interest suggestions found.";
$lang["detailed_targeting_description"] = "Search for interest sugestions and select up to 5 interest suggestions.";
$lang["only_five_interest_suggestions"] = "Only 5 interest suggestions are supported.";
$lang["ad_set_name_missing"] = "Ad Set's name missing ";
$lang["ad_set_name_missing_description"] = "Please enter an Ad Set's name for your Ad Set.";
$lang["oman"] = "Oman";
$lang["bahrain"] = "Bahrain";
$lang["yaman"] = "Yaman";
$lang["middle_east"] = "Middle East";
$lang["cambodia"] = "Cambodia";
$lang["select_country"] = "Select a Country";
$lang["search_for_countries"] = "Search for countries";
$lang["no_countries_found"] = "No countries found.";
$lang["select_facebook_page"] = "Facebook Pages";
$lang["select_facebook_page_description"] = "You have to select a Facebook Page which you want to promote. Select it only if you've selected the Page Likes or Messages objective for Campaign.";
$lang["select_facebook_page_btn"] = "Select Facebook Page";
$lang["no_facebook_pages_found"] = "No Facebook Pages found.";
$lang["facebook_ads_video_views"] = "Video Views";
$lang["facebook_ads_thruplay"] = "Thruplay";
$lang["facebook_ads_two_2_second_continuous_video_views"] = "2-second continuous video views";
$lang["facebook_ads_video_views_optimization_not_supported"] = "For Campaign's objective Video Views the supported optimizations are Thruplay and 2-second continuous video views.";


$lang["facebook_ads_sponsored_message_optimization_not_supported"] = "For Campaign's objective Sponsored Messages the supported optimizations are Impressions.";

$lang["account_currency_not_loaded_successfully"] = "Account currency not loaded successfully";


$lang["facebook_ads_video_is_required"] = "A video is required.";

$lang["ads_image_size"] = "ads_image_size";
$lang["ads_video_size"] = "ads_video_size";
$lang["Facebook ADS Manager"] = "Facebook ADS Manager";
$lang["Meta ADS Manager"] = "Meta ADS Manager";
$lang["Ad Accounts"] = "Ad Accounts";
$lang["Admin Settings"] = "Admin Settings";
$lang["AD Account"] = "AD Account";
$lang["Add Sandbox Token to User ID"] = "Add Sandbox Token to User ID";
$lang["User Token"] = "User Token";
$lang["Server Settings"] = "Server Settings";
$lang["Current"] = "Current";
$lang["Test new value"] = "Test new value";
$lang["Recommend"] = "Recommend";
$lang["Cant change via code"] = "Cant change via code";
$lang["important"] = "important";
$lang["Maximum file size for image upload"] = "Maximum file size for image upload";
$lang["Maximum file size for image upload (MB)"] = "Maximum file size for image upload (MB)";
$lang["Maximum file size for video upload. 0 = disabled video views ads. (MB)"] = "Maximum file size for video upload. 0 = disabled video views ads. (MB)";
$lang["Maximum file size for video upload"] = "Maximum file size for video upload";
$lang["Ad Account Overview"] = "Ad Account Overview";
$lang["Your package allows you to manage ad accounts:"] = "Your package allows you to manage ad accounts:";
$lang["For the best experience, please create a new Facebook Ad account and don't touch it."] = "For the best experience, please create a new Facebook Ad account and don't touch it.";
$lang["You don't have an active account in our system. Please select which account you want to use. After selecting, click the button."] = "You don't have an active account in our system. Please select which account you want to use. After selecting, click the button.";
$lang["I want to use this account:"] = "I want to use this account:";
$lang["You can't change your ad account until 28 days."] = "You can't change your ad account until 28 days.";
$lang["ARCHIVED"] = "ARCHIVED";
$lang["Or create new campaign"] = "Or create new campaign";
$lang["Or create new ad set"] = "Or create new ad set";
$lang["To generate Ad Preview first fill all required fields."] = "To generate Ad Preview first fill all required fields.";
$lang["Facebook Pixel"] = "Facebook Pixel";
$lang["Description your article. Use only keywords for best results."] = "Description your article. Use only keywords for best results.";
$lang["Copy here your section topic."] = "Copy here your section topic.";
$lang["Description your section topic. Use only keywords for best results. (option)"] = "Description your section topic. Use only keywords for best results. (option)";
$lang["Bad response. Please contact with administration."] = "Bad response. Please contact with administration.";
$lang["Do you really want to use this account?"] = "Do you really want to use this account?";
$lang["store_visits"] = "store_visits";
$lang["First, select or create a campaign."] = "First, select or create a campaign.";
$lang["First, select or create a ad set."] = "First, select or create a ad set.";
$lang["search_for_pixel_n"] = "search_for_pixel_n";
$lang["Cropping tool"] = "Cropping tool";
$lang["Full"] = "Full";
$lang["Crop & upload"] = "Crop & upload";
$lang["Create AD Set"] = "Create AD Set";

$lang["You haven't connected any Ads account yet."] = "You haven't connected any Ads account yet.";
$lang["you must be logged in your facebook account for which you want to refresh your access token. for synch your new page, simply refresh your token. if any access token is restricted for any action, refresh your access token."] = "you must be logged in your facebook account for which you want to refresh your access token. for synch your new page, simply refresh your token. if any access token is restricted for any action, refresh your access token.";
$lang["Classic Ads Manager"] = "Classic Ads Manager";
$lang["AD Set"] = "AD Set";
$lang["Conversion Tracking"] = "Conversion Tracking";
$lang["Custom audiences"] = "Custom audiences";
$lang["This account is used in our system:"] = "This account is used in our system:";
$lang["Auto renew for this ad account is not enabled."] = "Auto renew for this ad account is not enabled.";
$lang["New Ad"] = "New Ad";
$lang["New custom audiences"] = "New custom audiences";
$lang["Recommended image size: 1200 x 628 pixels"] = "Recommended image size: 1200 x 628 pixels";
$lang["Image title"] = "Image title";
$lang["Image Subtitle"] = "Image Subtitle";
$lang["Generate text"] = "Generate text";
$lang["Add image"] = "Add image";
$lang["Messages buttons"] = "Messages buttons";
$lang["Select the action you want people to take. Suggest quick replies for customers to tap, or use a button to send people to your site."] = "Full";
$lang["Add button"] = "Add button";
$lang["Ad Account"] = "Ad Account";
$lang["Do you really want to stop using this account to automatically renew?"] = "Do you really want to stop using this account to automatically renew?";
$lang["Ready"] = "Ready";
$lang["Updating"] = "Updating";
$lang["Can't used"] = "Can't used";
$lang["Search for Bot"] = "Search for Bot";
$lang["Search for custom audiences"] = "Search for custom audiences";
$lang["Preview for Sponsored Message is not supported by Meta API."] = "Preview for Sponsored Message is not supported by Meta API.";
$lang["Limit buttons is reached."] = "Limit buttons is reached.";
$lang["Label / Text reply"] = "Label / Text reply";
$lang["website url"] = "website url";
$lang["Website url"] = "Website url";
$lang["Search for message"] = "Search for message";
$lang["Include Custom Audience"] = "Include Custom Audience";
$lang["Exclude Custom Audience"] = "Exclude Custom Audience";
$lang["Create Ad Set"] = "Create Ad Set";
$lang["Create custom audiences"] = "Create custom audiences";
$lang["Custom Audience Name"] = "Custom Audience Name";
$lang["Enter Custom Audience Name"] = "Enter Custom Audience Name";
$lang["Custom Audience Description"] = "Custom Audience Description";
$lang["Enter Custom Audience Description"] = "Enter Custom Audience Description";
$lang["Create Custom Audience from:"] = "Create Custom Audience from:";
$lang["Messenger Subscribers ID"] = "Messenger Subscribers ID";
$lang["WhatsApp Phone Numbers"] = "WhatsApp Phone Numbers";
$lang["Telegram Phone Numbers"] = "Telegram Phone Numbers";
$lang["Select bot from selected source"] = "Select bot from selected source";
$lang["Select labels from selected source"] = "Select labels from selected source";
$lang["Do not close this window until process done."] = "Creating custom audiences done. You can close now this window.";
$lang["Save custom audience"] = "Save custom audience";
$lang["Generate message using AI"] = "Generate message using AI";
$lang["Description about mesasge"] = "Description about mesasge";
...
$lang["Creating custom audiences done. You can close now this window."] = "Creating custom audiences done. You can close now this window.";
$lang["Start date campaign"] = "Start date campaign";
$lang["End date campaign"] = "End date campaign";
$lang["Start date ad set"] = "Start date ad set";
$lang["End date ad set"] = "End date ad set";
$lang["Ad Creativity Status"] = "Ad Creativity Status";
$lang["Ad set end date is not set for lifetime budget."] = "Ad set end date is not set for lifetime budget.";
$lang["Start date campaign"] = "Start date campaign";
$lang["End date campaign"] = "End date campaign";
$lang["Ad Set Status"] = "Ad Set Status";
$lang["Ad Set Budget"] = "Ad Set Budget";
$lang["Daily budget"] = "Daily budget";
$lang["Lifetime budget"] = "Lifetime budget";
$lang["Lifetime Budget"] = "Lifetime Budget";
$lang["The lifetime budget of the set defined in your account currency."] = "The lifetime budget of the set defined in your account currency.";
$lang["Enter the Ad Set`s lifetime budget"] = "Enter the Ad Set`s lifetime budget";
$lang["Start date ad set"] = "Start date ad set";
$lang["End date ad set"] = "End date ad set";