...
<?php if (!defined('NVX')) { ?>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/thirdn/jodit-3.10.2/build/jodit.min.css">
    <script src="<?php echo base_url(); ?>assets/thirdn/jodit-3.10.2/build/jodit.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/thirdn/jquery.blockUI.js"></script>
    <style>
                                        ...
                                        <div class="tab-content pl-0 tabs_action">
                                            <div role="tabpanel" class="tab-pane active" id="home-fill"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-sm-12 filter_frameworks_select">
                                                        <div class="form-group">
                                                            <select name="filter_frameworks" id="filter_frameworks"
                                                                    class="select2 form-control">
                                                                <option value="all"><?php echo $this->lang->line("Filter"); ?></option>
                                                                <option value="filter_blog"><?php echo $this->lang->line("Blog"); ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <ul class="list-group list-group-flush" id="filters">
                                                    ...
                                                    <li class="filter_blog list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between pointer"
                                                        action="blog_idea_outline" count_limit="250"
                                                        textarea_title="keywords">
                                                        <div class="list-left d-flex">
                                                            ...
                                                            <div class="list-content">
                                                                <span class="list-title"><?php echo $this->lang->line("Blog Idea and Outline"); ?></span>
                                                                <small class="text-muted d-block"><?php echo $this->lang->line("Generate ideas and content structure for articles"); ?>
                                                    ...
                                                    <li class="filter_blog list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between pointer"
                                                        action="blog_section_writer" count_limit="125"
                                                        c1_count_limit="125" textarea_title="section_topic"
                                                        custom1_editor="section_keywords">
                                                        <div class="list-left d-flex">
                                                            <div class="list-icon mr-1">
                                                                <div class="avatar bg-rgba-primary m-0 p-25">
                                                                    <div class="avatar-content">
                                                            ...
                                                            <div class="list-content">
                                                                <span class="list-title"><?php echo $this->lang->line("Blog Section Writer"); ?></span>
                                                                <small class="text-muted d-block"><?php echo $this->lang->line("Write articles based on section topics & headlines"); ?>
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset class="form-label-group mb-0">
                                                            <h6 id="main_title"></h6>
                                                            <textarea data-length="0" class="form-control char-textarea"
