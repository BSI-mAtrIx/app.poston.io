            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-12">
                        ...
                        <p class="font-weight-bold"><?php echo $this->lang->line('After that send request approve app. Instruction here: https://nvxgroup.com/docs/'); ?></p>
...
Log in to your account and enter text into the Playground. The counter in the footer will display how many tokens are in your text.'); ?></p>
                        ...
                        <p><?php echo $this->lang->line('Version 1.0 only credits works.'); ?></p>



                    </div>

                    <form class="form-horizontal text-c" action="<?php echo site_url().'n_generator/config';?>" method="POST">
                        ...
                        <div class="col-12 mb-1">
                            <fieldset>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="openai_api" name="openai_api" class="form-control" value="<?php echo $openai_api; ?>">
                                </div>
                        ...
                        <div class="col-12 mb-1">
                            <fieldset>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="cost_per1k_tokens" name="cost_per1k_tokens" class="form-control" value="<?php echo $cost_per1k_tokens; ?>">
                                </div>
