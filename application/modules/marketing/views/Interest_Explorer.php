        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a
                            href="<?php echo base_url('marketing/get_interest'); ?>"><?php echo $this->lang->line('interest_explorer'); ?></a>
                </div>
                    ...
                    <div class="card-body">
                        <div class="empty-state">
                            ...
                            <a href="/social_accounts" class="btn btn-outline-primary mt-4"><i
                                        class="fas fa-arrow-circle-right"></i> <?php echo $this->lang->line('Continue'); ?>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <section class="section section_custom">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div id="alert_success" class="alert alert-success mb-2" style="display:none;" role="alert">
                        ...
                        <div id="alert_danger" class="alert alert-danger mb-2" role="alert" style="display:none;">
                            <div class="d-flex align-items-center">
                                        ...
                                        <form action="#" enctype="multipart/form-data"
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <button style='width:100%; max-width:350px; margin-bottom:10px;'
                                                        class="btn btn-lg btn-primary center-block get_button"
                                                        id="get_button" name="get_button" type="button"
                                                        value="get_records" onclick="get_button_data('get_interest')"><i
                                                            class="fa fa-tasks"></i> <?php echo $this->lang->line("Get Interest"); ?>
                                                </button>
                                                <button style='width:100%; max-width:350px; margin-bottom:10px;'
                                                        class="btn btn-lg btn-primary center-block get_button"
                                                        name="get_button" type="button" value="get_csv"
                                                        onclick="get_button_csv('get_csv')"><i
                                                            class="fa fa-file-csv"></i> <?php echo $this->lang->line("Get CSV"); ?>
                                                </button>
                                                <!-- </div> -->
                                            </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <form action="#" style="padding-right: 15px">
                                            ...
                                            <button style='width:45%; max-width:350px; margin-bottom:10px;'
                                                    ...
                                                    onclick="copyToClipboard('textarea#list_keywords')"
                                                    name="get_button" type="button" value="get_csv"><i
                                                        class="fa fa-copy"></i> <?php echo $this->lang->line("Copy to clipboard"); ?>
                                            </button>
                                            <button style='width:45%; max-width:350px; margin-bottom:10px;'
                                                    class="btn btn-lg btn-primary center-block"
                                                    onclick="exportToCSV(keys_id)" name="get_button" type="button"
                                                    value="get_csv"><i
                                                        class="fa fa-file-csv"></i> <?php echo $this->lang->line("Export to CSV"); ?>
                                            </button>
                                        </form>
                                    </div>
                                </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="box box-warning">
                            <div class="box-header ui-sortable-handle blue text-center"
                                 style="cursor: move;margin-bottom: 0px;border-bottom: 1px solid #ddd;">
                                <h3 class="box-title"><?php echo $this->lang->line("Interest Explorer Result"); ?>:
                                    <span id="counterlist"></span></h3>
                            </div>
                            <div class="box-body">
