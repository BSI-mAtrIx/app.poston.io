...
<div class="card" id="nodata">
  <div class="card-body">
    <div class="empty-state">
      ...
      <a href="<?php echo base_url('gmb/business_accounts'); ?>" class="btn btn-outline-primary mt-4"><i class="fa fa-cloud-download-alt"></i> <?php echo $this->lang->line("Import Account");?></a>
    </div>
  </div>
</div>
