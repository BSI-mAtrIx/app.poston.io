...
<script src="<?php echo base_url(); ?>assets/gen_thirdn/toast_editor.js"></script>
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/gen_thirdn/toast.css">
                    ...
                    <div class="row">
                                            ...
                                            <div role="tabpanel" class="tab-pane active" id="home-fill"
                                                ...
                                                <ul class="list-group list-group-flush" id="filters">
                                                    <?php foreach($frameworks_data as $k => $v){
                                                        ...
                                                        ?>
                                                    <li class="filter_<?php echo $v['category']; ?> list-group-item list-group-item-action border-0 p-0 mb-1 d-flex align-items-center justify-content-between pointer"
                                                            ...
                                                            <div class="list-icon mr-1">
                                                                <div class="avatar bg-rgba-primary m-0 p-25">
                                                                    <div class="avatar-content">
                                                                        <i class="<?php echo $v['icon']; ?> text-primary font-medium-5"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="col-sm-12 col-md-8 ">
                            <form>
                                ...
                                <textarea id="document" name="document" class="d-none">
                                    <?php if (!empty($doc_id)) {
