<div class="modal fade" id="sadad_payment_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><?php echo $this->lang->line("Sadad Payment"); ?></h3>
            ...
            <div class="modal-body">
                ...
                <div id="sadad_otp_field" style="display: none;">
                    ...
                    <a class="float-right pointer" id="sadad_resend_otp"><?php echo $this->lang->line("If you not receive OTP code, click here for resend"); ?></a>
            ...
            <div class="modal-footer">
                <a class="btn btn-outline-secondary float-right" id="sadad_confirm"><?php echo $this->lang->line("Next step"); ?></a>
                <a class="btn btn-outline-secondary float-right " id="sadad_confirm_otp" style="display: none;"><?php echo $this->lang->line("Verify OTP"); ?></a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function ($) {
        ...
        $(document).on('click', '#pay_sadad', function (event) {
            ...
            $('#sadad_payment_modal').modal('show');
        ...
        $(document).on('click', '#sadad_confirm', function (event) {
            ...
            $('#sadad_payment_modal .modal-content').block({
            ...
            $.ajax({
                ...
                data: to_send,
                dataType: 'JSON',
                url: base_url + 'n_sadad/payment_button/' + <?php echo $package_id; ?>,
                success: function (response) {
                    ...
                    $('#sadad_payment_modal .modal-content').unblock();
                }
            });
        ...
        $(document).on('click', '#sadad_confirm_otp', function (event) {
            ...
            $.ajax({
                ...
                data: to_send,
                dataType: 'JSON',
                url: base_url + 'n_sadad/webhook/' + <?php echo $package_id; ?>,
                success: function (response) {
