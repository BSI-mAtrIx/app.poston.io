<script>
    ...
    $(document).ready(function () {
        ...
        var table = $("#mytable").DataTable({
            ...
            ajax: {
                "url": base_url + 'price/api_admin/coupons',
                "type": 'POST',
                data: {
        ...
        $(document).on('click', '.delete_coupon', function (e) {
            ...
            swal.fire({
                text: '<?php echo $this->lang->line('Are you sure you want to delete coupon code? This process is irreversible.'); ?>',
                icon: 'warning',
                confirmButtonText: "<?php echo $this->lang->line('Yes, remove coupon'); ?>",
                ...
                if (sa_confirmed) {
                    $.ajax({
                        context: this,
                        type: 'POST',
                        url: base_url+"price/api_admin/coupon_delete",
                        dataType: 'json',
