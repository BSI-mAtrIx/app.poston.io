        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url('price/coupon_edit'); ?>"><span
                                class="align-middle ml-25"><?php echo $this->lang->line("New Coupon"); ?></span></a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table row-grouping" id="mytable" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th><?php echo $this->lang->line("Code clean"); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
