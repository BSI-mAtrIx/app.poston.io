        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td bgcolor="#FFA73B" align="center" style="padding: 0px 10px 0px 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111;line-height: 48px;">
                                <?php if($status=='0') : ?>
                                ...
                                <?php endif; ?>
                                <img src=" https://img.icons8.com/clouds/100/000000/handshake.png" width="200" height="200" style="display: block; border: 0px;" />
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr id="default_msg">
                            <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <?php if($status=='1') : ?>
                                    <h4 class="text-center" style="margin: 0;"><?php echo $this->lang->line("You already subscribed to our system."); ?></h4>
                                <?php else : ?>
                        ...
                        <tr>
                            <td id="alert_msg" bgcolor="#ffffff" align="left" style="display: none;color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                        ...
                                        <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="sequence_ids" id="sequence_ids" value="<?php echo $sequence_ids; ?>">
                                                    <td align="center" style="border-radius: 3px;" bgcolor="#FFA73B">
                                                        <a href="#" id="submit" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid #FFA73B; display: inline-block;">
