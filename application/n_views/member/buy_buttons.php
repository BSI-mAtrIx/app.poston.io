 ...
 ?>
            ...
            <div id="payment_options">
                ...
                <div class="row">
                    ...
                    if ($n_config['n_paymongo_gateway_enabled'] == 'true' and $payment_package_sorted[$package_id]['price'] >= 100) { ?>
                    ...
                    <?php if ($n_config['n_paymongo_gateway_gcash_enabled'] == 'true' and $payment_package_sorted[$package_id]['price'] >= 100) { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php if ($n_config['n_paymongo_gateway_paymaya_enabled'] == 'true' and $payment_package_sorted[$package_id]['price'] >= 100) { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php if ($n_config['n_paymongo_gateway_grab_enabled'] == 'true' and $payment_package_sorted[$package_id]['price'] >= 100) { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php if ($n_config['n_paymentwall_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php if ($n_config['n_payu_latam_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php if ($n_config['n_coinbase_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php if ($n_config['n_moamalat_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php if ($n_config['n_sadad_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                            <a href="#" id="pay_sadad"
                               class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="d-flex w-100 align-items-center">
                    ...
                    <?php if ($n_config['n_tdsp_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                            <a href="#" id="pay_tdsp"
                               class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="d-flex w-100 align-items-center">
                    ...
                    <?php if ($n_config['n_stripe_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    if ($n_config['n_tap_on'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                            <a href="<?php echo base_url('n_tap/payment_button/' . $package_id); ?>" class="list-group-item list-group-item-action flex-column align-items-start"
                               id="tap-button">
                                <div class="d-flex w-100 align-items-center">
                                    <small class="text-muted"><img class="rounded" height="40"
                    ...
                    AND ($payment_package_sorted[$package_id]['validity'] == 30 OR $payment_package_sorted[$package_id]['validity'] == 365)
                    ) { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php if ($n_config['n_mastercard_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php
                    if ($n_config['n_epayco_enabled'] == 'true' AND ($currency == 'USD' OR $currency == 'COP')) { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    <?php
                    //$currency = 'USD';
                    if ($n_config['n_epayco_subs_enabled'] == 'true' AND ($currency == 'USD' OR $currency == 'COP')) { ?>
                        <div class="col-md-4 pt-3">
                    ...
                    if ($n_config['n_sellix_enabled'] == 'true') { ?>
                    ...
                    if ($n_config['n_sellix_subs_enabled'] == 'true') { ?>
                    ...
                    <?php if ($n_config['n_chapa_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
                            <a href="#" id="pay_chapa"
                               class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="d-flex w-100 align-items-center">
                    ...
                    <?php if ($n_config['n_zaincash_enabled'] == 'true') { ?>
                        <div class="col-md-4 pt-3">
