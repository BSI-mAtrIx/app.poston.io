<div class="section-header">
    <h1><i class="bx bx-sort-up"></i> <?php echo $this->config->item("product_name"); ?>
        : <?php echo $this->lang->line("Updates"); ?></h1>
</div>
...
<div class="section-body">
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"><?php echo $update_version->name; ?> <?php echo $update_version->version; ?>
    ...
    <?php if (!empty($add_ons)) : ?>
        <br><br>
        <div class="section-header">
            <h1><i class="bx bx-plug"></i> <?php echo $this->config->item("product_name"); ?>
                : <?php echo $this->lang->line("Add-on Updates"); ?></h1>
                                    ...
                                    <td style='text-align: center;'>
                                        ...
                                        <div id="<?php echo $modal; ?>" class="modal fade" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"><?php echo $add_on_update_version->name; ?> <?php echo $add_on_update_version->version; ?>
                                                            ( <?php echo $this->lang->line('Change Log'); ?> )</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                            <i class="bx bx-x"></i>
