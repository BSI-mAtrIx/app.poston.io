            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item"><a
                                href="<?php echo base_url("addons/lists"); ?>"><?php echo $this->lang->line("Add-on Manager"); ?></a>
                    </li>
        ...
        <div class="col-12 col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4><i class="bx bx-cloud-upload"></i> <?php echo $this->lang->line("Upload New Add-on"); ?></h4>
                </div>
                <div class="card-body">
