        ...
        <div class="breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item"><a
                                href="<?php echo base_url('social_apps/wordpress_settings'); ?>"><?php echo $this->lang->line("Wordpress app settings"); ?></a>
                    </li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <b><?php echo $this->lang->line("Redirect URLs") . "</b> : <span class='blue'>" . base_url('comboposter/login_callback/wordpress'); ?></span>
                    <br/>
            </div>
        </div>
    </div>
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <form action="<?php echo base_url("social_apps/wordpress_settings_update_action"); ?>" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input name="app_name"
                                   value="<?php echo isset($wordpress_settings['app_name']) ? $wordpress_settings['app_name'] : set_value('app_name'); ?>"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="client_id"
                                           value="<?php echo isset($wordpress_settings['client_id']) ? $wordpress_settings['client_id'] : set_value('client_id'); ?>"
                                           class="form-control" type="text">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="client_secret"
                                           value="<?php echo isset($wordpress_settings['client_secret']) ? $wordpress_settings['client_secret'] : set_value('client_secret'); ?>"
                                           class="form-control" type="text">
                        ...
                        <div class="form-group">
                            <?php
                            $status = isset($wordpress_settings['status']) ? $wordpress_settings['status'] : "";
                            if ($status == '') $status = '1';
                            ?>
