        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br/><br/>
                    <b><?php echo $this->lang->line("Blogger Redirect URL") . "</b> : <span class='blue'>" . base_url("comboposter/login_callback/blogger"); ?></span>
                        <br/>
                </div>
            </div>
        </div>
            ...
            <div class="card" style="min-height: 250px;">
                <div class="card-body">
                    <b><?php echo $this->lang->line("Enable APIs") . "</b>: <br>"; ?><br>
                        ...
                        <p>Enable this API after getting approval & whitelisted for this Specific Google API . Submit
                            for approval from <b><a
                                        href="https://docs.google.com/forms/d/e/1FAIpQLSfC_FKSWzbSae_5rOpgwFeIUzXUF1JCQnlsZM_gC1I2UHjA3w/viewform"
            ...
            <form action="<?php echo base_url("social_apps/google_settings_action"); ?>" method="POST">
                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-pencil"></i> <?php echo $this->lang->line("App Name"); ?>
                                    </label>
                                    <input name="app_name"
                                           value="<?php echo isset($google_settings['app_name']) ? $google_settings['app_name'] : set_value('app_name'); ?>"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="ion ion-key"></i> <?php echo $this->lang->line("API Key"); ?>
                                    </label>
                                    <input name="api_key"
                                           value="<?php echo isset($google_settings['api_key']) ? $google_settings['api_key'] : set_value('api_key'); ?>"
                                           class="form-control" type="text">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="google_client_id"
                                           value="<?php echo isset($google_settings['google_client_id']) ? $google_settings['google_client_id'] : set_value('google_client_id'); ?>"
                                           class="form-control" type="text">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="google_client_secret"
                                           value="<?php echo isset($google_settings['google_client_secret']) ? $google_settings['google_client_secret'] : set_value('google_client_secret'); ?>"
                                           class="form-control" type="text">
                    ...
                    <div class="card-footer bg-whitesmoke">
                        ...
                        <button class="btn btn-secondary float-right" onclick='goBack("social_apps/settings")'
