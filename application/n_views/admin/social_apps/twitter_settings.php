...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <b><?php echo $this->lang->line("Redirect URLs") . "</b> : <span class='blue'>" . base_url('comboposter/login_callback/twitter'); ?></span>
                    <br/>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input name="app_name"
                                   value="<?php echo isset($twitter_settings['app_name']) ? $twitter_settings['app_name'] : set_value('app_name'); ?>"
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-id-card"></i> <?php echo $this->lang->line("Consumer ID"); ?>
                                    </label>
                                    <input name="consumer_id"
                                           value="<?php echo isset($twitter_settings['consumer_id']) ? $twitter_settings['consumer_id'] : set_value('consumer_id'); ?>"
                                           class="form-control" type="text">
                                    <span class="text-danger"><?php echo form_error('consumer_id'); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Consumer Secret"); ?>
                                    </label>
                                    <input name="consumer_secret"
                                           value="<?php echo isset($twitter_settings['consumer_secret']) ? $twitter_settings['consumer_secret'] : set_value('consumer_secret'); ?>"
                                           class="form-control" type="text">
                        ...
                        <div class="form-group">
                            <?php
                            $status = isset($twitter_settings['status']) ? $twitter_settings['status'] : "";
                            if ($status == '') $status = '1';
                            ?>
