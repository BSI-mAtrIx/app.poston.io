                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-at"></i> <?php echo $this->lang->line("Paypal Email"); ?>
                                    </label>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="paypal_payment_type"><i
                                                class="bx bx-dollar-circle"></i> <?php echo $this->lang->line('Paypal Recurring Payment'); ?>
                                    </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="custom-switch mt-2">
                                            <input type="checkbox" name="paypal_payment_type" id="paypal_payment_type"
                                                   value="recurring"
                                                   class="custom-control-input" <?php if ($paypal_payment_type == 'recurring') echo 'checked'; ?>>
                                            <label class="custom-control-label mr-1" for="paypal_payment_type"></label>
                                            <span><?php echo $this->lang->line('Enable'); ?></span>
                                            <span class="text-danger"><?php echo form_error('paypal_payment_type'); ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bxs-vial"></i> <?php echo $this->lang->line('Paypal Sandbox Mode'); ?>
                                    </label>
                                    <br>
                                    <?php
                                    ...
                                    ?>
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="paypal_mode" id="paypal_mode" value="sandbox"
                                               class="custom-control-input" <?php if ($paypal_mode == 'sandbox') echo 'checked'; ?>>
                                        <label class="custom-control-label mr-1" for="paypal_mode"></label>
                                        <span><?php echo $this->lang->line('Enable'); ?></span>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Stripe Secret Key"); ?>
                                    </label>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Stripe Publishable Key"); ?>
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-8">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Mollie API Key"); ?>
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Razorpay Key ID"); ?>
                                    </label>
                            ...
                            <div class="col-6 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Razorpay Key Secret"); ?>
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Paystack Secret Key"); ?>
                                    </label>
                            ...
                            <div class="col-6 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Paystack Public Key"); ?>
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Mercadopago Public Key"); ?>
                                    </label>
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Mercadopago Access Token"); ?>
                                    </label>
                                    <input name="mercadopago_access_token"
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-globe"></i> <?php echo $this->lang->line("Mercadopago Country"); ?>
                                    </label>
                                    <select name='marcado_country' class='select2 form-control'
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("SSLCommerz Store ID"); ?>
                                    </label>
                                    <input name="sslcommerz_store_id"
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("SSLCommerz Store Password"); ?>
                                    </label>
                                    <input name="sslcommerz_store_password"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bxs-vial"></i> <?php echo $this->lang->line('SSLCommerz Sandbox Mode'); ?>
                                    </label>
                                    <br>
                                    <?php
                                    ...
                                    ?>
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="sslcommers_mode" id="sslcommers_mode"
                                               value="sandbox"
                                               class="custom-control-input" <?php if ($sslcommers_mode == 'sandbox') echo 'checked'; ?>>
                                        <label class="custom-control-label mr-1" for="sslcommers_mode"></label>
                                        <span><?php echo $this->lang->line('Enable'); ?></span>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4">
                                <div class="form-group mb-0">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("SenangPay Merchant Id"); ?>
                                    </label>
                                    <input name="senangpay_merchent_id"
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-group mb-0">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("SenangPay Secret Key"); ?>
                                    </label>
                                    <input name="senangpay_secret_key"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group mb-0">
                                    <label for=""><i
                                                class="bx bxs-vial"></i> <?php echo $this->lang->line('SenangPay Sandbox Mode'); ?>
                                    </label>
                                    <br>
                                    <?php
                                    ...
                                    ?>
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="senangpay_mode" id="senangpay_mode" value="sandbox"
                                               class="custom-control-input" <?php if ($senangpay_mode == 'sandbox') echo 'checked'; ?>>
                                        <label class="custom-control-label mr-1" for="senangpay_mode"></label>
                                        <span><?php echo $this->lang->line('Enable'); ?></span>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <small class="text-dark mt-2 d-block"><b><?php echo $this->lang->line('Senangpay return url :'); ?></b> <?php echo "<span class='badge badge-danger p-1 pl-2 pr-2'>" . $red_url . "</span>"; ?>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Instamojo Private Api Key"); ?>
                                    </label>
                                    <input name="instamojo_api_key"
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Instamojo Private Auth Token"); ?>
                                    </label>
                                    <input name="instamojo_auth_token"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bxs-vial"></i> <?php echo $this->lang->line('Instamojo Sandbox Mode'); ?>
                                    </label>
                                    <br>
                                    <?php
                                    ...
                                    ?>
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="instamojo_mode" id="instamojo_mode" value="sandbox"
                                               class="custom-control-input" <?php if ($instamojo_mode == 'sandbox') echo 'checked'; ?>>
                                        <label class="custom-control-label mr-1" for="instamojo_mode"></label>
                                        <span><?php echo $this->lang->line('Enable'); ?></span>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Toyyibpay Secret Key"); ?>
                                    </label>
                                    <input name="toyyibpay_secret_key"
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Toyyibpay Category code"); ?>
                                    </label>
                                    <input name="toyyibpay_category_code"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-vial"></i> <?php echo $this->lang->line('Toyyibpay Sandbox Mode'); ?>
                                    </label>
                                    <br>
                                    <?php
                                    ...
                                    ?>
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="toyyibpay_mode" value="sandbox"
                                               class="custom-switch-input" <?php if ($toyyibpay_mode == 'sandbox') echo 'checked'; ?>>
                                        <span class="custom-switch-indicator"></span>
                                        <span class="custom-switch-description"><?php echo $this->lang->line('Enable'); ?></span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Xendit Secret Api Key"); ?>
                                    </label>
                                    <input name="xendit_secret_api_key"
                        ...
                        <div class="row">
                            <div class="col-6 col-md-8">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Myfatoorah Api Key"); ?>
                                        <a href="#" data-placement="top" data-toggle="popover" title=""
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bxs-vial"></i> <?php echo $this->lang->line('Myfatoorah Sandbox Mode'); ?>
                                    </label>
                                    <br>
                                    <?php
                                    ...
                                    ?>
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="myfatoorah_mode" value="sandbox"
                                               class="custom-switch-input" <?php if ($myfatoorah_mode == 'sandbox') echo 'checked'; ?>>
                                        <span class="custom-switch-indicator"></span>
                                        <span class="custom-switch-description"><?php echo $this->lang->line('Enable'); ?></span>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Paymaya Public Key"); ?>
                                    </label>
                                    <input name="paymaya_public_key"
                            ...
                            <div class="col-6 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-key"></i> <?php echo $this->lang->line("Paymaya Secret Key"); ?>
                                    </label>
                                    <input name="paymaya_secret_key"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-vial"></i> <?php echo $this->lang->line('Paymaya Sandbox Mode'); ?>
                                    </label>
                                    <br>
                                    <?php
                                    ...
                                    ?>
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="paymaya_mode" value="sandbox"
                                               class="custom-switch-input" <?php if ($paymaya_mode == 'sandbox') echo 'checked'; ?>>
                                        <span class="custom-switch-indicator"></span>
                                        <span class="custom-switch-description"><?php echo $this->lang->line('Enable'); ?></span>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name='currency' class='select2 form-control' style='width:100% !important;'>
                                        <?php
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for=""><i
                                                class="bx bx-receipt"></i> <?php echo $this->lang->line('Enable manual payment'); ?>
                                    </label>
                                    <br>
                                    <?php
                                    ...
                                    ?>
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="manual_payment" id="manual_payment"
                                               class="custom-control-input"
                                               value="yes" <?php if ($manual_payment == "yes") echo "checked"; ?>>
                                        <label class="custom-control-label mr-1" for="manual_payment"></label>
                                        <span><?php echo $this->lang->line('Enable'); ?></span>
                                        <span class="text-danger"><?php echo form_error('manual_payment'); ?></span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div id="manual-payins" class="col-12">
                                <div class="form-group">
                                    <label><i class="bx bx-info-circle"></i> <?php echo $this->lang->line('Manual payment instructions'); ?>
                                    </label>
                                    <textarea name="manual_payment_instruction" class="summernote form-control"
                                              style="height: 200px !important"><?php echo set_value('manual_payment_instruction', isset($xvalue['manual_payment_instruction']) ? $xvalue['manual_payment_instruction'] : ""); ?></textarea>
