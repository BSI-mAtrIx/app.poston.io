...
<head>
    ...
    <link rel="shortcut icon"
          href="<?php echo (isset($favicon) && $favicon != "") ? $favicon : base_url('assets/img/favicon.png'); ?>">
    ...
    <link rel="stylesheet"
          href="https://cdn.linearicons.com/free/1.0.0/icon-font.min.css?ver=<?php echo $n_config['theme_version']; ?>">
    <link rel="stylesheet"
    ...
    <!-- Template CSS -->
    <!-- <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/style.css?ver=<?php echo $n_config['theme_version']; ?>"> -->

    <?php
    $PRIMARY_COLOR = isset($ecommerce_config['theme_color']) ? $ecommerce_config['theme_color'] : "#6777ef";
    if ($PRIMARY_COLOR == '') $PRIMARY_COLOR = '#6777ef';
    ...
    include("application/n_views/admin/theme/style_theme.php");
    ?>
    <style type="text/css">
                ...
                <?php if ($show_search): ?>
                    <div class='m-0 mt-3 w-100 search_form'>
                        <div class="input-group">
                            ...
                            ?>
                            <input type="text" onkeyup="search_product(this,'product-container')" autofocus=""
                                   class="form-control" name="search" id="search"
                                   value="<?php echo $this->session->userdata('search_search'); ?>"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".print-options").click(function () {
            ...
            if (id == "mobile-print")
                frameDoc.document.write('<link href="<?php echo base_url();?>assets/css/print/ecommerce-thermal-mobile-print.css?ver=<?php echo $n_config['theme_version']; ?>" rel="stylesheet" type="text/css" />');
            else if (id == "thermal-print")
                frameDoc.document.write('<link href="<?php echo base_url();?>assets/css/print/ecommerce-thermal-print.css?ver=<?php echo $n_config['theme_version']; ?>" rel="stylesheet" type="text/css" />');
            else frameDoc.document.write('<link href="<?php echo base_url();?>assets/css/print/ecommerce-print.css?ver=<?php echo $n_config['theme_version']; ?>" rel="stylesheet" type="text/css" />');
        ...
        $(document).on('click', '#login_submit', function (e) {
            ...
            if (email == "" || password == "") {
                swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line("Email and password are required."); ?>", 'error');
                return;
            }
        ...
        $(document).on('click', '#register_submit', function (e) {
            ...
            if (register_first_name == "" || register_last_name == "" || register_email == "" || register_password == "" || register_password_confirm == "") {
                swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line("Please fill the required fields."); ?>", 'error');
                return;
            }
        ...
        $(document).on('click', '#save_profile', function (e) {
            ...
            if (first_name == "" || last_name == "" || street == "") {
                swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line("Please input the required fields."); ?>", 'error');
                return;
            }
            $("#save_profile").addClass('btn-progress');
        ...
        $(document).on('click', '#delete_address', function (e) {
            ...
            swal.fire({
                title: '<?php echo $this->lang->line("Delete Address"); ?>',
                    ...
                    if (willDelete.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                iziToast.success({
                                    title: "",
                                    message: '<?php echo $this->lang->line("Address has been deleted successfully.");?>',
                                    position: 'bottomRight',
                                    timeout: 3000
                                });
                                $("#deliveryAddressModal").modal('hide');
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="profileModalLabel"><i
                            class="bx bx-user-circle"></i> <?php echo $this->lang->line("Profile"); ?></h5>
            ...
            <div class="modal-footer p-0">
                <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="bx bx-time"></i> <span class="align-middle ml-25"><?php echo $this->lang->line("close"); ?></span></button> -->
                <button type="button" id="save_profile" class="btn btn-primary btn-block no_radius p-3 m-0"><i
                            class="bx bxs-save"></i> <?php echo $this->lang->line("Save Profile"); ?></button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="deliveryAddressModal" tabindex="-1" role="dialog"
     aria-labelledby="deliveryAddressModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deliveryAddressModalLabel"><i
                            class="bx bx-truck"></i> <?php echo $this->lang->line("Delivery Address"); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="bx bx-chevron-left"></i></span>
                </button>
            </div>
            ...
            <div class="modal-footer p-0">
                ...
                <button type="button" id="new_address" class="btn btn-primary btn-block no_radius p-3 m-0"><i
                            class="bx bx-plus-circle"></i> <?php echo $this->lang->line("Add Address"); ?></button>
                <button type="button" id="save_address" data-close="0"
                        class="btn btn-primary btn-block no_radius p-3 m-0 d-none"><i
                            class="bx bxs-save"></i> <?php echo $this->lang->line("Save Address"); ?> </button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="TermsModal" tabindex="-1" role="dialog" aria-labelledby="TermsModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="TermsModalLabel"><i
                            class="lnr lnr-license"></i> <?php echo $this->lang->line("Terms of Use"); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="bx bx-chevron-left"></i></span>
                </button>
            </div>
...
<div class="modal fade" id="RefundModal" tabindex="-1" role="dialog" aria-labelledby="RefundModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="RefundModalLabel"><i
                            class="lnr lnr-book"></i> <?php echo $this->lang->line("Refund Policy"); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="bx bx-chevron-left"></i></span>
                </button>
            </div>
...
<div class="modal fade" id="LoginModal" tabindex="-1" role="dialog" aria-labelledby="LoginModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="LoginModalLabel"><i
                            class="bx bx-log-in"></i> <?php echo $this->lang->line("Login"); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="bx bx-chevron-left"></i></span>
                </button>
            </div>
            <div class="modal-body text-justify" id="LoginModalBody">
                <form method="POST" action="#" class="needs-validation" novalidate="" _lpchecked="1">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="login_email" name=""
                               placeholder="<?php echo $this->lang->line("Email"); ?>" required autofocus
                               autocomplete="off">
                    ...
                    <div class="form-group">
                        <div class="d-block">
                            <label for="password" class="control-label"><?php echo $this->lang->line("Password"); ?>
                                *</label>
                        </div>
                        <input type="password" id="login_password" class="form-control" name=""
                               placeholder="<?php echo $this->lang->line("Password"); ?>" required autocomplete="off">
                        <div class="invalid-feedback"></div>

                        <div class="form-group mt-2">
                            <button type="submit" id="login_submit" class="btn btn-primary btn-block" tabindex="4">
                                <?php echo $this->lang->line("Login"); ?>
                            </button>
                        </div>
                </form>
                <div class="<?php echo $is_guest_login == '1' ? '' : 'text-center'; ?> mt-4 mb-3">
                    <div class="text-job text-muted"><a href=""
                                                        class="pointer <?php echo $is_guest_login == '1' ? 'float-left' : ''; ?>"
                                                        id="register_form"><i
                                    class="bx bx-user-circle"></i> <?php echo $this->lang->line("Register Now"); ?></a>
                    </div>
                    <div class="text-job text-muted"><a href=""
                                                        class="pointer <?php echo $is_guest_login == '1' ? 'float-right' : 'd-none'; ?>"
                                                        id="guest_register_form"><i
                                    class="bx bx-user-secret"></i> <?php echo $this->lang->line("Checkout as Guest"); ?>
                        </a></div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="RegisterModal" tabindex="-1" role="dialog" aria-labelledby="RegisterModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="RegisterModalLabel"><i
                            class="bx bx-log-in"></i> <?php echo $this->lang->line("Register"); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><i class="bx bx-chevron-left"></i></span>
                </button>
            </div>
                ...
                <form method="POST" action="#" class="needs-validation" novalidate="" _lpchecked="1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control"
                                   placeholder="<?php echo $this->lang->line("First Name"); ?>" id="register_first_name"
                                   name="" required autofocus autocomplete="off">
                            <input type="text" class="form-control"
                                   placeholder="<?php echo $this->lang->line("Last Name"); ?>" id="register_last_name"
                                   name="" required autofocus autocomplete="off">
                        </div>
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="<?php echo $this->lang->line("Email"); ?>"
                               id="register_email" name="" required autofocus autocomplete="off">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group mt-2">
                            <button type="submit" id="register_submit" class="btn btn-primary btn-block" tabindex="4">
