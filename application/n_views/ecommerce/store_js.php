<script>
    function get_button() {
        ...
        if ($("#store_name").val() == "") {
            swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please put your store name.'); ?>", 'error');
            return false;
        }

        if ($("#store_email").val() == "") {
            swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please put your store email.'); ?>", 'error');
            return false;
        }

        if ($("#store_country").val() == "") {
            swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please put your store country.'); ?>", 'error');
            return false;
        }

        if ($("#store_state").val() == "") {
            swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please put your store state.'); ?>", 'error');
            return false;
        }

        if ($("#store_city").val() == "") {
            swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please put your store city.'); ?>", 'error');
            return false;
        }


        if ($("#store_address").val() == "") {
            swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please put your store address.'); ?>", 'error');
            return false;
        }


        if ($("#store_zip").val() == "") {
            swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please put your store postal code.'); ?>", 'error');
            return false;
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status == '1') {
                    swal.fire(success_title, response.message, 'success').then((value) => {
