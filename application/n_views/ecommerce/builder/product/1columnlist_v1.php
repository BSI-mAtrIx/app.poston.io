...
<div class="product product-list product-select product-<?php echo $value['id']; ?>">
    ...
    <div class="product-details">
        ...
        <div class="product-price"><?php echo $display_price; ?></div>
        <!--        <div class="product-desc">-->
        <!--            --><?php //echo //substr($value['product_description'],0,250)."..."; ?>
        <!--        </div>-->
