...
if ($n_eco_builder_config['front_deals_products_show'] == 'true') {
    if (!empty($deals_list)) {
        ...
        <div class="title-link-wrapper pb-1 mb-4">
            ...
            <?php
            $n_special_generate = _link('ecommerce/sales/' . $js_store_unique_id);
    ...
    <div class="<?php columns_width($n_eco_builder_config['front_deals_products_rows'], $n_eco_builder_config['mobile_columns_div']); ?>">
