                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="coupon_code" value="<?php echo set_value('coupon_code'); ?>"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="coupon_amount" value="<?php echo set_value('coupon_amount'); ?>"
                                       class="form-control" type="text">
                    ...
                    <div class="row" id="hidden">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="max_usage_limit" value="<?php echo set_value('max_usage_limit'); ?>"
