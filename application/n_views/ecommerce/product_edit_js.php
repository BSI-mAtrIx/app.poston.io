...
<script>
    $(document).ready(function () {
        ...
        beforeSubmit = function () {
            $('.product_description').val($('.product_desc .jodit-wysiwyg').html().replaceAll('style', 'stzle'));
            $('.purchase_note').val($('.purchase_no_before .jodit-wysiwyg').html().replaceAll('style', 'stzle'));
