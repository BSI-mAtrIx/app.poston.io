...
<div class="row">
    <div class="col-12">
        ...
        $save_button = ($operation == 'clone') ? '<i class="bx bx-duplicate"></i> ' . $this->lang->line("Clone") : '<i class="bx bxs-save"></i> ' . $this->lang->line("Save");
            ...
            <div class="card shadow-none">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input name="product_name" value="<?php echo $default_pro; ?>" class="form-control"
                                       type="text">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="original_price" value="<?php echo $default_op; ?>" class="form-control"
                                           type="text">
                                </div>
                        ...
                        <div class="col-6 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="sell_price" value="<?php echo $default_sl; ?>" class="form-control"
                                           type="text">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 d-none">
                            <div class="form-group">
                                ...
                                <?php echo form_dropdown('', $store_list, $default_store, 'disabled class="select2 form-control"'); ?>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_dropdown('category_id', $category_list, $default_cat, 'class="select2 form-control" id="category_id"'); ?>
                            </div>
                        ...
                        <div class="col-12 col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo form_dropdown('attribute_ids[]', $attribute_list, $default_att, 'class="select2 form-control" id="attribute_ids" multiple'); ?>
                        ...
                        <div class="col-12 col-md-8 d-none">
                            <div class="form-group">
                                ...
                                <input name="product_video_id" value="<?php echo $default_vd; ?>" class="form-control"
                                       type="text"
                        ...
                        <div class="col-12 col-md-12 product_desc">
                            <div class="form-group">
                                ...
                                <textarea name="product_description"
                                          class="form-control product_description"><?php echo str_replace('stzle', 'style', $default_pd); ?></textarea>
                        ...
                        <div class="col-12 col-md-12 purchase_no_before">
                            <div class="form-group">
                                ...
                                <textarea name="purchase_note"
                                          class="form-control purchase_note"><?php echo str_replace('stzle', 'style', $default_pn); ?></textarea>
                            ...
                            <div class="form-group">
                                <label class="full_width"><?php echo $this->lang->line('Thumbnail'); ?>
                                    ...
                                    <?php if ($default_tb != '' && $operation == 'edit') { ?>
                                        <span id="tmb_preview" class="float-right pointer text-primary"
                                              data-toggle="modal" data-target="#exampleModal"><i
                                                    class="bx bx-bullseye"></i> <?php echo $this->lang->line('Preview'); ?></span>
                                    <?php } ?>
                                </label>
                            ...
                            <div class="form-group">
                                <label><?php echo $this->lang->line('Featured  Images'); ?>
                                    <a href="#" data-placement="top" data-toggle="popover" data-trigger="focus"
                                       ...
                                       data-content="<?php echo $this->lang->line("Upto 3 images, Maximum: 1MB each, Format: JPG/PNG, Preference: Square image, Recommended dimension : 500x500. Uploading new images will overwrite previous images."); ?>"><i
                                                class='bx bx-info-circle'></i> </a>
                                </label>
                                    ...
                                    <div id="product-file-dropzone" class="dropzone mb-1">
                                        <div class="dz-default dz-message">
                                            <input class="form-control" name="product_file" id="uploaded-product-file"
                                                   type="hidden" value="<?php echo $xdata['digital_product_file']; ?>">
                                            <span style="font-size: 20px;"><i class="bx bx-cloud-upload"
                                                                              style="font-size: 35px;color: #6777ef;"></i> <?php echo $this->lang->line('Upload'); ?></span>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           value="<?php echo $preparation_time; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="custom-switch mt-2">
                                            <input type="checkbox" name="is_featured" value="1"
                                                   class="custom-switch-input" <?php echo $is_featured; ?>>
                ...
                <div class="card-footer p-0" style="margin-bottom: 200px">
                    <button name="submit" type="submit" class="btn btn-primary"
                            onclick="beforeSubmit();"><?php echo $save_button; ?></button>
