<script>
    ...
    $("document").ready(function () {
        ...
        $(document).on('click', '.add_to_cart', function (e) {
            ...
            if (exit) {
                swal.fire("<?php echo $this->lang->line('Error'); ?>", "<?php echo $this->lang->line('Please choose the required options.'); ?> (*)", 'error');
                return false;
            }
            ...
            if (item_count == 0 && action == "remove") {
                swal.fire("<?php echo $this->lang->line('Error'); ?>", '<?php echo $this->lang->line("Item can not be removed. It is not in cart anymore.");?>', 'error');
                return false;
            }
            var new_count = 0;
            var param = {
