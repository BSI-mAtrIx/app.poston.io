                            ...
                            <div class="activity">
                                <div class="activity-detail w-100 mb-2">
                                    <div class="mb-2">
                                        ...
                                        <a class="text-job text-primary" href="<?php echo $invoice; ?>">
                                            #<?php echo $value['cart_id'] . ' (' . $payment_amount . ')' ?></a>
                                        <div class="float-right dropdown ml-3">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="<?php echo base_url("ecommerce/download_item/" . $value['id'] . "?subscriber_id=" . $value['subscriber_id']); ?>"
