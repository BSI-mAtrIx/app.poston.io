...
<script src="<?php echo base_url(); ?>assets/modules/fullcalendar/main.min.js?ver=<?php echo $n_config['theme_version']; ?>"></script>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('.fa-chevron-left').addClass('bx bx-chevron-left');
        $('.fa-chevron-right').addClass('bx bx-chevron-right');
    });
