<script type="text/javascript">
    ...
    $("document").ready(function () {
        ...
        $(document).on('click', '#submit_btn', function (e) {
            ...
            if (campaign_name == "") {
                swal.fire('<?php echo $this->lang->line("Error"); ?>', "<?php echo $this->lang->line('Campaign Name is required.')?>", 'error');
                return;
            }
            ...
            if (campaign_types == "email" && $("#email_api_id").val() == "") {
                swal.fire('<?php echo $this->lang->line("Error"); ?>', "<?php echo $this->lang->line('Email API is required.')?>", 'error');
                return;
            } else if (campaign_types == "sms" && $("#sms_api_id").val() == "") {
                swal.fire('<?php echo $this->lang->line("Error"); ?>', "<?php echo $this->lang->line('SMS API is required.')?>", 'error');
                return;
            }
