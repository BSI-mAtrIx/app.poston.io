...
<div class="row">
    <div class="col-12">
        <a class="btn btn-primary mb-1" id="add_feed" data-toggle="modal" href='#add_feed_modal'>
            <i class="bx bx-plus-circle"></i> <?php echo $this->lang->line('Add new wordpress blog'); ?>
        </a>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="padding-left: 30px;padding-right: 30px;">
                <button type="button" class="btn btn-default float-right" data-dismiss="modal" id="close_settings"><i
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i
                            class="bx bxl-wordpress"></i> <?php echo $this->lang->line("Wordpress post auto-posting") ?>
                </h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="bx bx-x"></i>
                </button>
            </div>
            <form action="#" id="add_feed_form">
                <div class="modal-body">
                    ...
                    <div class="space"></div>
                    <label class="margin-bottom-label" style="color: rgb(0, 0, 0);">
                        <?php echo $this->lang->line("Wordpress blog URL") ?> *
                    </label>
                    <?php echo form_dropdown('wordpress_blog_url', $wordpress_blogs, null, 'class="select2 form-control"'); ?>
                    <div class="space"></div>
                    <div class="space"></div>
                </div>
