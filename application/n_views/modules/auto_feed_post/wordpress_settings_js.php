    ...
    $("document").ready(function () {
        ...
        $(document).on('click', '.force_process', function (e) {
            ...
            swal.fire({
                ...
                text: '<?php echo $this->lang->line("Do you really want to force process this campaign? This can be helpful if your Wordpress blog posting tools have stopped for some unknown reasons and not responding."); ?>',
                icon: 'warning',
                confirmButtonText: "<?php echo $this->lang->line('Yes'); ?>",
                cancelButtonText: "<?php echo $this->lang->line('No'); ?>",
                showCancelButton: true,
        ...
        $(document).on('click', '#add_feed_submit', function () {
            ...
            var wordpress_blog_url = $("#wordpress_blog_url").val();
            ...
            if (wordpress_blog_url == '') {
                swal.fire('<?php echo $this->lang->line("Error"); ?>', "<?php echo $this->lang->line('Wordpress blog URL can not be empty');?>", 'error');
                return;
            }
