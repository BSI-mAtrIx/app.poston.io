<section class="section mt-2">
    <div class="section-header p-0 shadow-none bg-light mb-0">
        <?php
        ...
        <form class='m-0 mt-2 w-100 search_form'>
            <div class="input-group">
                ...
                ?>
                <input type="text" onkeyup="search_product(this,'product-container')" class="form-control" name="search"
                       id="search" value="<?php echo $this->session->userdata('search_search'); ?>"
    ...
    <div class="section-body">
        ...
        if (empty($product_list)) { ?>
            <div class="card shadow-none mt-2" id="nodata">
                <div class="card-body">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-4 product-single" data-cat="<?php echo $category_id; ?>">
                    <ul class="list-unstyled list-unstyled-border bg-white mb-1 mt-2 rounded bordered">
                        <li class="media align-items-center">
                            ...
                            ?>
                            <a href="<?php echo $product_link; ?>"><img width="110" height="110"
                                                                        class="mr-2 rounded-left bordered-right"
                                                                        src="<?php echo $imgSrc; ?>"/>
                            </a>
                            <div class="media-body pl-0 pr-2">
                                <div class="media-title mb-1">
                                    <a href="<?php echo $product_link; ?>"
                                       class="text-dark text-small"><?php echo $value['product_name']; ?></a><br>
                                    <span class="mt-1 text-small"><?php echo $value['price_html']; ?> </span>
                                </div>
                                <p class="text-small text-muted m-0 mb-1"
                                   style="line-height: normal !important"><?php echo strlen(strip_tags($value['product_description'])) > 30 ? substr(strip_tags($value['product_description']), 0, 30) . '...' : strip_tags($value['product_description']); ?></p>
                                <p class="d-none"><?php echo strip_tags($value['product_description']); ?></p>

                                <a href="<?php echo $product_link; ?>" class="btn btn-sm btn-primary" data-attributes=""
                                   data-product-id="<?php echo $value['id']; ?>" data-action=''><i
        ...
        <div class="card shadow-none d-none w-100 mt-2" id="nodata_search">
            <div class="card-body">
                <div class="empty-state">
                    <img class="img-fluid" style="height: 200px"
                         src="<?php echo base_url('assets/img/drawkit/drawkit-full-stack-man-colour.svg'); ?>"
