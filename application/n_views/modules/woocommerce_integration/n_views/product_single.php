...
<div class="row bg-white pb-3 margin_md">
    ...
    <div class="col-12 col-sm-12 <?php if ($carousel) echo 'col-md-6 col-lg-8'; ?>">
        <div class="card shadow-none mt-3 mb-0 remove-margin">
            <div class="card-header p-2" style="border:none">
                <h4 class="full_width pr-0">
                    <?php echo $product_data['product_name']; ?>
                    <span class="float-right"
                          id="calculated_price_basedon_attribute"><?php echo $product_data['price_html']; ?></span>
                </h4>
            </div>
        </div>
        ...
        <div class="hero p-2" style="border-radius: 0 0 3px 3px;">
            <div class="hero-inner">
                <ul class="nav nav-tabs" id="myTab2" role="tablist">
                    ...
                    <?php if (!empty($product_data['product_description'])): ?>
                        <li class="nav-item">
                            <a class="nav-link active show" id="description-tab2" data-toggle="tab" href="#description"
                    ...
                    <?php if ($have_attributes): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo empty($product_data['product_description']) ? 'active show' : ''; ?>"
                               id="details-tab2" data-toggle="tab" href="#details" role="tab" aria-controls="details"
                               aria-selected="false"><?php echo $this->lang->line("Options"); ?></a>
                        </li>
                    <?php endif; ?>
                ...
                <div class="tab-content tab-bordered mb-2" id="myTab3Content">
                    ...
                    <?php if ($have_attributes): ?>
                        <div style="overflow-x: auto"
                             class="tab-pane fade p-2 pb-0 makescroll <?php echo empty($product_data['product_description']) ? 'active show' : ''; ?>"
                             id="details" role="tabpanel" aria-labelledby="details-tab2">
                            <?php
            ...
            <a href="<?php echo $product_link; ?>" class="btn btn-outline-primary btn-block no_radius"
               data-attributes="" data-product-id="<?php echo $product_data['id']; ?>" data-action=''><i
                        class="bx bx-credit-card-alt"></i> <?php echo $this->lang->line($buy_button_title); ?></a>
        </div>
