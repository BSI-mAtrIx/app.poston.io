...
<div class="row">
    <div class="col-12">
        ...
        <form class="form-horizontal" action="<?php echo site_url() . 'simplesupport/edit_category_action'; ?>"
              method="POST">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="category_name" value="<?php echo $xdata['category_name']; ?>" class="form-control"
                               type="text">
