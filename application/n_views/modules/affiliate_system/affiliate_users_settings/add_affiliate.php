...
<div class="row">
    <div class="col-12">
        ...
        <form class="form-horizontal" action="<?php echo site_url() . 'affiliate_system/add_affiliate_action'; ?>"
              method="POST">
                                ...
                                <div class="card-body" style="border:1px solid #e4e6fc">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group mt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" value="1" id="by_signup"
                                                           ...
                                                           class="custom-control-input" <?php if ($general_signup_commission == '1') echo "checked"; ?>>
                                            ...
                                            <div class="form-group"
                                                 id="signup_sec_div" <?php if ($general_signup_commission == '1') echo 'style="display: block;"'; else echo 'style="display: none;"'; ?>>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="signup_amount"
                                                           id="signup_amount"
                                                           value="<?php echo $general_sign_up_amount; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mt-2">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" value="1" id="by_payment" name="is_payment"
                                                           class="custom-control-input" <?php if ($general_payment_commission == '1') echo "checked"; ?>>
                                                    <label class="custom-control-label pointer"
                                            ...
                                            <div id="payment_sec_div" <?php if ($general_payment_commission == '1') echo 'style="display: block;"'; else echo 'style="display: none;"'; ?> >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label class="custom-switch mt-2">
                                                                <input type="radio" name="payment_type"
                                                                       ...
                                                                       class="custom-switch-input" <?php if ($general_payment_type != '' && $general_payment_type == 'fixed') echo 'checked'; ?>>
                                                                <span class="custom-switch-indicator"></span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label class="custom-switch mt-2">
                                                                <input type="radio" name="payment_type"
                                                                       ...
                                                                       class="custom-switch-input" <?php if ($general_payment_type != '' && $general_payment_type == 'percentage') echo 'checked'; ?>>
                                                                <span class="custom-switch-indicator"></span>
                                                                <span class="custom-switch-description"><?php echo $this->lang->line('Enable'); ?></span>
                                                                <span class="text-danger"><?php echo form_error('payment_type'); ?></span>
                                                            </label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label class="custom-switch mt-2">
                                                                <input type="checkbox" name="is_recurring"
                                                                       ...
                                                                       class="custom-switch-input" <?php if ($general_is_recurring == '1') echo 'checked'; ?>>
                                                                <span class="custom-switch-indicator"></span>
                                                                <span class="custom-switch-description"><?php echo $this->lang->line('Enable'); ?></span>
                                                ...
                                                <div class="form-group"
                                                     id="fixed_amount_div" <?php if ($general_payment_type == 'fixed') echo 'style="display: block;"'; else echo 'style="display: none;"'; ?>>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"
                                                             title="<?php echo $this->lang->line('Currency'); ?>">
                                                            <div class="input-group-text">
                                                        ...
                                                        <input type="text" class="form-control" name="fixed_amount"
                                                               id="fixed_amount"
                                                               value="<?php echo $general_payment_fixed_amount; ?>">
                                                        <span class="text-danger"><?php echo form_error('fixed_amount'); ?></span>
                                                    </div>
                                                </div>

                                                <div class="form-group"
                                                     id="percentage_div" <?php if ($general_payment_type == 'percentage') echo 'style="display: block;"'; else echo 'style="display: none;"'; ?>>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                        ...
                                                        <input type="text" class="form-control" name="percent_amount"
                                                               id="percent_amount"
                                                               value="<?php echo $general_payment_percentage; ?>">
