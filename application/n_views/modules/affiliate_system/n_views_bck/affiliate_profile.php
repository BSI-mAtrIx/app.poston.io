...
<section class="section">
    <div class="section-header">
        <h1 class="page_title"><i class="bx bx-user"></i> <?php echo $page_title; ?></h1>
            ...
            <div class="col-12 col-md-4">
                <div class="card profile-widget mt-0 pointer">
                    <div class="profile-widget-header text-center mb-0 bg-primary p-4">
                        <img alt="image" src="<?php echo $logo; ?>"
                             class="rounded-circle profile-widget-picture img-thumbnail float-none m-0"
                             style="width:120px !important;">
                    </div>
                    <div class="profile-widget-description text-center"
                         style="border: solid 3px #6777ef;line-height:25px;">
                        <div class="mb-0 font-weight-bold text-primary" id="my_name"><?php echo $name; ?></div>
                        <div class="font-weight-normal mb-0" id="my_username"><small>@<?php echo $username; ?></small>
                        </div>
                        <div id="email"><span><?php echo $email; ?></span></div>
                        <div id="phone"><i class="bx bx-mobile-alt"></i>
                            <small> <?php echo !empty($mobile) ? $mobile : $this->lang->line("Not Available"); ?> </small>
                        </div>
                        <div id="address"><sup><i class="bx bx-map-pin"></i></sup>
                            <small><?php echo !empty($address) ? $address : $this->lang->line("Not Available"); ?></small>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-8">
                <div class="card" readonly="">
                    <form class="form-horizontal" enctype="multipart/form-data"
                          action="<?php echo site_url() . 'affiliate_system/edit_profile_action'; ?>" method="POST"
                          id="affiliate_profile_form">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    <label class="control-label" for=""><i
                                                class="bx bx-rocket"></i> <?php echo $this->lang->line("Name"); ?>
                                        *</label>
                                    <div>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    <label class="control-label" for=""><i
                                                class="bx bx-user-tag"></i> <?php echo $this->lang->line("Username"); ?>
                                        *</label>
                                    <div>
                                        <input readonly="" name="username" value="<?php echo $username; ?>"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    <label class="control-label" for=""><i
                                                class="bx bx-envelope"></i> <?php echo $this->lang->line("Email"); ?> *</label>
                                    <div>
                                ...
                                <div class="form-group col-md-6 col-12">
                                    <label class="control-label" for=""><i
                                                class="bx bx-phone"></i> <?php echo $this->lang->line("Phone"); ?>
                                    </label>
                                    <div>
                                        <input name="mobile" value="<?php echo $mobile; ?>" class="form-control"
                                               type="text">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    <label class="control-label" for=""><i
                                                class="bx bxs-map"></i> <?php echo $this->lang->line("Address"); ?>
                                    </label>
                                    <div>
                        ...
                        <div class="card-footer">
                            <button class="btn btn-primary btn-block" id="save-btn" type="submit"><i
