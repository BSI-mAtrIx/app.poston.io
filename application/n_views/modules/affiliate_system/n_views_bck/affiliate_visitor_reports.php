<section class="section">
    <div class="section-header">
        <h1 class="page_title"><i
                    class="bx bx-network-chart"></i> <?php echo $this->lang->line('Clicked vs Signed Up Visitors'); ?>
        </h1>
        <div class="section-header-button">
            <a class="btn btn-primary add_method"
               href="<?php echo base_url("affiliate_system/visitor_reports#visitor_history_div") ?>">
                <i class="bx bx-history"></i> <?php echo $this->lang->line("Visitors History"); ?>
            </a>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            <i class="bx bx-chart"></i> <?php echo $this->lang->line('Visitor Analysis : Last 30 days'); ?>
                        </h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card gradient-bottom">
                    <div class="card-header">
                        <h4><i class="bx bx-data"></i> <?php echo $this->lang->line("Visitors Data"); ?></h4>
                        <div class="card-header-action dropdown">
                            <a href="#" data-toggle="dropdown" class="btn btn-danger dropdown-toggle"
                               id="selected_period"><?php echo $this->lang->line("This Month"); ?></a>
                            <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <li class="dropdown-header"><?php echo $this->lang->line("Select Period"); ?></li>
                                <li><a href="#" class="dropdown-item period_change"
                                       period="today"><?php echo $this->lang->line("Today"); ?></a></li>
                                <li><a href="#" class="dropdown-item period_change"
                                       period="week"><?php echo $this->lang->line("Last 7 Days"); ?></a></li>
                                <li><a href="#" class="dropdown-item period_change active"
                                       period="month"><?php echo $this->lang->line("This Month"); ?></a></li>
                                <li><a href="#" class="dropdown-item period_change"
                                       period="year"><?php echo $this->lang->line("This Year"); ?></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-body" style="height:200px">
                        <div class="text-center waiting hidden" id="period_loader"><i
                                    class="bx bx-sync bx-spin blue text-center" style="font-size: 40px;"></i></div>
                        <ul class="list-unstyled list-unstyled-border" id="period_change_content">
                            <li class="media">
                                <img class="img-fluid mt-1 img-shadow"
                                     src="<?php echo base_url('assets/img/icon/paper-plane.png'); ?>" alt="image"
                                     width="60">
                                <div class="media-body ml-3">
                                    <div class="media-title"><?php echo $this->lang->line('Link Visited'); ?></div>
                                    <div class="text-small text-muted"
                                         id="link_visited_number"><?php echo number_format($link_clicked); ?> <i
                                                class="bx bx-caret-down text-primary"></i></div>
                                </div>
                            </li>
                            <li class="media">
                                <img class="img-fluid mt-1 img-shadow"
                                     src="<?php echo base_url('assets/img/icon/access.png'); ?>" alt="image" width="60">
                                <div class="media-body ml-3">
                                    <div class="media-title"><?php echo $this->lang->line('Signed Up'); ?></div>
                                    <div class="text-small text-muted"
                                         id="signup_number"><?php echo number_format($signedUp); ?> <i
...
<div class="row" id="visitor_history_div">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4><i class="bx bx-history"></i> <?php echo $this->lang->line("Visitors History"); ?></h4>
            </div>
...
<?php
$drop_menu = '<div class="btn-group dropleft float-right"><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">  ' . $this->lang->line("Options") . '  </button>  <div class="dropdown-menu dropleft"> <a class="dropdown-item delete_visitors_old_data" href="' . base_url('affiliate_system/delete_visitor_old_log') . '"><i class="bx bx-trash"></i> ' . $this->lang->line("Delete old data") . '</a></div> </div>';
?>
