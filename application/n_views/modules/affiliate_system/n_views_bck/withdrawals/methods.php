<section class="section section_custom">
    <div class="section-header">
        <h1><i class="bx bx-calendar-plus"></i> <?php echo $page_title; ?></h1>
        <div class="section-header-button">
            <a class="btn btn-primary add_method" href="#">
                <i class="bx bx-plus-circle"></i> <?php echo $this->lang->line("New Method"); ?>
            </a>
        </div>
...
<script>
    ...
    $(document).ready(function ($) {
        ...
        $(document).on('click', '#save_method_info', function (event) {
            ...
            if (method_type == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Please Select Withdrawal Method"); ?>', 'warning');
                return;
            }

            if (method_type == 'paypal' && paypal_email == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Please provide PayPal email address"); ?>', 'warning');
                return;
            }

            if (method_type == 'bank_acc' && bank_acc_no == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Please provide bank account no"); ?>', 'warning');
                return;
            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == '1') {
                        iziToast.success({
                            title: '',
                            message: '<?php echo $this->lang->line("Withdrawal Method has been added successfully"); ?>',
                    ...
                    if (response == '0') {
                        swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Something Went wrong, please try once again."); ?>', 'warning');
                    }
        ...
        $(document).on('click', '.edit_method', function (event) {
            ...
            var loading = '<div class="text-center waiting"><i class="bx bx-sync bx-spin blue text-center" style="font-size:40px"></i></div>';
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == '1') {
                        iziToast.success({
                            title: '',
                            message: '<?php echo $this->lang->line("Withdrawal Method has been updated successfully"); ?>',
                            position: 'bottomRight'
                        });
        ...
        <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12" id="bank_acc_div" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="bank_acc_no" id="bank_acc_no"
                                                  placeholder="<?php echo $this->lang->line("write your details..."); ?>"
            ...
            <div class="modal-footer bg-whitesmoke">
                <div class="col-12 p-0">
                    <button class="btn btn-primary" id="save_method_info" type="button"><i
...
<div class="modal fade" id="edit_witdrawalMethod_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h5 class="modal-title text-center blue">
                    <i class="bx bx-edit"></i> <?php echo $this->lang->line("Update Method"); ?>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            ...
            <div class="modal-footer bg-whitesmoke action_div">
                <div class="col-12 p-0">
                    <button class="btn btn-primary" id="update_method_info" type="button"><i
