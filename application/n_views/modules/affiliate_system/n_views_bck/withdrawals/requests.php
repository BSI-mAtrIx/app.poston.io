...
<section class="section" id="main_body">
    <div class="section-header">
        <h1 class="page_title"><i class="bx bx-help-circle"></i> <?php echo $page_title; ?></h1>
        <div class="section-header-button new_request_button">
            <a class="btn btn-primary add_request" href="#">
                <i class="bx bx-plus-circle"></i> <?php echo $this->lang->line("New Request"); ?>
            </a>
        </div>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a
                        href="<?php echo base_url("affiliate_system"); ?>"><?php echo $this->lang->line("Affiliate System"); ?></a>
            </div>
            ...
            <div class="col-12">
                <div class="card profile-widget mb-0">
                    ...
                    <div class="card-body" id="table_div">
                        <div class="row">
                            <div class="col-12">
                                <form action="<?php echo base_url('affiliate_system/withdrawal_requests/'); ?>"
                                      method="post">
                                    <div class="form-group">
                                        <div class="input-group mb-3" id="searchbox">
                                            ...
                                            <div class="input-group-append" style="margin-top:-1px !important;">
                                                <button class="btn btn-primary no_radius" id="group_search_submit"
                            ...
                            <?php if (!empty($withdrawal_requests)) : ?>
                                <?php foreach ($withdrawal_requests as $value) { ?>
                                    <div class="col-12 col-md-4">
                                        <div class="card pointer" data-toggle="tooltip"
                                             data-title="<?php echo $value['payment_type']; ?>">
                                                ...
                                                <div class="details_section">
                                                    ...
                                                    <ul class="list-group reques_info_body">
                                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                                            <span><i class="bx bx-bookmark text-primary"></i>&nbsp;&nbsp;<?php echo $value['method_id']; ?></span>
                                                            <span class="amount"><?php echo $curency_icon . $value['requested_amount']; ?></span>
                                                        </li>
                                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                                            <span><i class="bx bx-flag text-success"></i> <?php echo $this->lang->line('Status'); ?></span>
                                                            <?php echo $value['request_status_icon']; ?>
                                                        </li>
                                                        <li class="list-group-item d-flex justify-content-between align-items-center mb-3">
                                                            <span><i class="bx bx-star text-warning"></i> <?php echo $this->lang->line('Approved'); ?></span>
                                            ...
                                            <?php if ($value['request_status'] != '1'): ?>
                                                <div class="card-footer text-center bg-light pr-3 pl-3 pt-2 pb-2">
                                                    <?php if ($value['request_status'] == '0') : ?>
                                                        <button class="btn btn-sm btn-primary float-left edit_request"
                                                                table_id="<?php echo $value['id']; ?>"><i
                                                                    class="bx bx-edit"></i> <?php echo $this->lang->line('Edit'); ?>
                                                        </button>
                                                    <?php endif; ?>
                                                    <button class="btn btn-sm btn-danger float-right delete_request"
                                                            table_id="<?php echo $value['id']; ?>"><i
                                                                class="bx bx-trash"></i> <?php echo $this->lang->line('Delete'); ?>
                                                    </button>
                                ...
                                <div class="col-12">
                                    <div class="empty-state p-0">
                                        <img class="img-fluid" width="40%"
                                             src="<?php echo base_url('assets/img/drawkit/drawkit-nature-man-colour.svg'); ?>"
                                             alt="image">
                ...
                <div class="card" id="new_form_div">
                    ...
                    <div class="card-header">
                        <h4><i class="bx bx-paper-plane"></i> <span
                                    class="form_header_title"><?php echo $this->lang->line('New Request'); ?></span>
                        </h4>
                        <div class="card-header-action">
                            <a href="#" class="reverse_form"><i class="bx bx-time" style="font-size:18px;"></i></a>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text"><i class="bx bx-money"></i></div>
                                    </div>

                                    <select name="withdrawal_account" id="withdrawal_account"
                                    ...
                                    <input type="number" class="form-control"
                                           placeholder="<?php echo $this->lang->line('Provide Requested Amount'); ?>"
                                           id="requested_amount" name="requested_amount">
                                    <input type="hidden" class="form-control" id="previous_amount"
                                           name="previous_amount" value="">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary float-left" id="add_request_submit"
                                                submit_action="add"><i class="bx bx-save"></i> <span
    ...
    $(document).ready(function ($) {
        ...
        $(document).on('click', '#add_request_submit', function (event) {
            ...
            if (withdrawal_account == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Please Select a method."); ?>', 'warning');
                return;
            }

            if (requested_amount == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Please Provide your requested amount"); ?>', 'warning');
                return;
            }
