    ...
    <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
            ...
            <div class="card card-primary">
                <div class="card-header"><h4><i class="bx bx-log-in"></i> <?php echo $this->lang->line("Login"); ?></h4>
                </div>
                <?php
                ...
                ?>
                <div class="card-body">
                    <form method="POST" action="<?php echo base_url('affiliate_system/affiliate_login'); ?>"
                          class="needs-validation" novalidate="">
                        <div class="form-group">
                            <label for="affilate_email"><?php echo $this->lang->line("Email"); ?></label>
                            <input id="affilate_email" type="email" class="form-control"
                                   value="<?php echo set_value('affilate_email'); ?>" name="affilate_email" tabindex="1"
                                   required autofocus>
                        ...
                        <div class="form-group">
                            <div class="d-block">
                                ...
                                <div class="float-right">
                                    <a href="<?php echo site_url(); ?>affiliate_system/forget_password"
                                       class="text-small">
                                        <?php echo $this->lang->line("Forgot your password?"); ?>
                                    </a>
                                </div>
                            </div>
                            <input id="affiliate_password" type="password" class="form-control"
                                   name="affiliate_password" tabindex="2" required>
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-primary btn-block login_btn" tabindex="4">
                                <i class="bx bx-log-in"></i> <?php echo $this->lang->line("login"); ?>
                            </button>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-muted text-center">
                                    <br><?php echo $this->lang->line("Do not have an account?"); ?> <a
                                            href="<?php echo base_url('affiliate_system/affiliate_sign_up'); ?>"><?php echo $this->lang->line("Create one"); ?></a>
                                </div>
                            </div>
                        </div>
                    </form>
