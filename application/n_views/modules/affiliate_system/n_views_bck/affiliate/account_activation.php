    ...
    <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
            ...
            <div class="card card-primary">
                <div class="card-header"><h4><i class="bx bx-user-check"></i> <?php echo $page_title; ?></h4></div>
                ...
                <div class="card-body" id="recovery_form">
                    ...
                    <form method="POST" <?php echo site_url('affiliate_system/affiliate_account_activation_action'); ?>>
                        ...
                        <div class="form-group">
                            <label for="affiliate_activation_code"><?php echo $this->lang->line("Account Activation Code"); ?>
                                *</label>
                            <input type="text" class="form-control" id="affiliate_activation_code"
                                   name="affiliate_activation_code" tabindex="1" required>
                            <div class="invalid-feedback"><?php echo $this->lang->line("Please enter activation code"); ?></div>
                        </div>

                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block" tabindex="4" name="submit"
                                    id="submit">
                                <i class="bx bx-user-check"></i> <?php echo $this->lang->line("Activate My Account"); ?>
                            </button>
                        </div>
                    </form>
                </div>
