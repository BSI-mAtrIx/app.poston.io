        ...
        <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
            <div class="login-brand">
                <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/logo.png"
                                                         alt="<?php echo $this->config->item('product_name'); ?>"
                                                         width="200"></a>
            </div>

            <div class="card card-primary">
                <div class="card-header"><h4><i
                                class="bx bx-user-circle"></i> <?php echo $this->lang->line("Sign Up"); ?></h4></div>
                    ...
                    <form method="POST" action="<?php echo site_url('affiliate_system/affiliate_signup_action'); ?>">
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input id="affiliate_name" type="text" class="form-control" name="affiliate_name"
                                       autofocus required value="<?php echo set_value('affiliate_name'); ?>">
                            </div>
                            <div class="form-group col-6">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input id="affiliate_email" type="email" class="form-control" name="affiliate_email"
                                       required value="<?php echo set_value('affiliate_email'); ?>">
                            </div>
                            <div class="form-group col-6">
                                <label for="affiliate_mobile"><?php echo $this->lang->line("Phone Number"); ?></label>
                                <input id="affiliate_mobile" type="text" class="form-control" name="affiliate_mobile"
                                       value="<?php echo set_value('affiliate_mobile'); ?>">
                            </div>
                        </div>

                        <div class="row">
                            <div class="form-group col-6">
                                <label for="affiliate_password"
                                       class="d-block"><?php echo $this->lang->line("Password"); ?> *</label>
                                <input id="affiliate_password" type="password" class="form-control" required
                                       name="affiliate_password" value="<?php echo set_value('affiliate_password'); ?>">
                            </div>
                            <div class="form-group col-6">
                                <label for="affiliate_password2"
                                       class="d-block"><?php echo $this->lang->line("Confirm Password"); ?> *</label>
                                <input id="affiliate_password2" type="password" class="form-control" required
                                       name="affiliate_confirm_password"
                                       value="<?php echo set_value('affiliate_confirm_password'); ?>">
                            </div>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" required name="affiliate_captcha"
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-primary btn-block">
                                <i class="bx bx-user-circle"></i> <?php echo $this->lang->line("sign up"); ?>
                            </button>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-muted text-center">
                                    <br><?php echo $this->lang->line("Already have an account?"); ?> <a
                                            href="<?php echo base_url('affiliate_system/affiliate_login_page'); ?>"><?php echo $this->lang->line("Sign In"); ?></a>
                                </div>
                            </div>
                        </div>
                    </form>
