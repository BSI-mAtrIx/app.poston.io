    ...
    <div class="section-body">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="card card-statistic-1 pointer" data-toggle='tooltip'
                             title="<?php echo $this->lang->line("You will get commission on every user signup who have come through the affiliation link."); ?>">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="card card-statistic-1 pointer" data-toggle='tooltip'
                             title="<?php echo $this->lang->line("Affiliate will get fixed/percentage commission on package buying."); ?>">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="card card-statistic-1 pointer" data-toggle='tooltip'
                             title="<?php echo $this->lang->line("Affiliate will get commission on every user signup who have come through the affiliation link."); ?>">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="bx bx-link"></i> <?php echo $this->lang->line('Affiliate Link'); ?></h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center" id="gif_div">
                                    <img width="30%" class="center-block"
                                         src="<?php echo base_url('assets/pre-loader/loading-animations.gif'); ?>"
                                         alt="Processing...">
                                </div>
                                <div id="link_div" style="display: none;">
                                    <pre class="language-javascript"><code class="dlanguage-javascript"><span
                                                    class="token keyword"><?php echo site_url() . '?ref=' . bin2hex($this->session->userdata('affiliate_userid')); ?></span></code></pre>
                                </div>
                            </div>
                        </div>
                    </div>
