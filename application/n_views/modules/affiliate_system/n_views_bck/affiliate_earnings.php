<section class="section">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="card card-statistic-2">
                <div class="card-stats">
                    <div class="card-stats-title"><i class="bx bx-show"></i> <?php echo $this->lang->line("Summary"); ?>
                    </div>
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4><i class="bx bx-coin-stack"></i> <?php echo $this->lang->line("Affiliate Earning"); ?></h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="statistic-details">
                        <div class="statistic-details-item">
                            <span class="text-muted"><span class="text-primary"><i
                                            class="bx bx-caret-up statistic_icon"></i></span></span>
                        ...
                        <div class="statistic-details-item">
                            <span class="text-muted"><span class="text-danger"><i
                                            class="bx bx-caret-down statistic_icon"></i></span></span>
