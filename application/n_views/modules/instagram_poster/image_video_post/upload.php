<div id="image_block" class="mb-4">
    <div class="form-group mb-1">
        <div class="input-group">
	    	...
	    	<?php if (set_value('image_url')) echo set_value('image_url'); else {
            ...
            <div class="input-group-text p-0">
                <button type="button" class="btn btn-outline-primary float-right" data-toggle="modal"
                        data-target="#video_format_info_modal">
    ...
    <div class="card mr-1 mb-0 no_shadow d_none" id="image_edit_block">
        <div class="card-footer px-2 py-2 bg-primary no_radius">
            <a href="#" data-src="" class="btn btn-light btn-sm float-left edit_media image no_radius"><i
                        class="bx bx-images"></i> <?php echo $this->lang->line("Editor"); ?></a>
            <a href="#" data-src="" class="btn btn-danger btn-sm float-right delete_media image no_radius"><i
                        class="bx bx-trash"></i> <?php echo $this->lang->line("Delete"); ?></a>
        </div>
    </div>
    <div class="col-12">
        <div class="row upload_block">
            ...
            <div class="col-12 p-0 no-gutters">
                <div class="alert alert-warning py-2"><?php echo $this->lang->line("Multi Image Post Limit: 10 Images. In Facebook it will be posted as multi images post, Instagram as carousel. Instagram Carousel post also supports images+videos. For Facebook multi image post, videos will be ignored. For Facebook carousel post") . ', ' . '<a href="' . base_url("ultrapost/carousel_slider_post") . '">' . $this->lang->line('go here') . '</a>';
                    ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mr-1 mb-0 no_shadow d_none" id="video_edit_block">
                <div class="card-footer px-2 py-2 bg-primary no_radius">
                    <a href="#" data-src="" class="btn btn-light btn-sm float-left edit_media video disabled no_radius"><i
                                class="bx bx-images"></i> <?php echo $this->lang->line("Editor"); ?></a>
                    <a href="#" data-src="" class="btn btn-danger btn-sm float-right delete_media video no_radius"><i
                                class="bx bx-trash"></i> <?php echo $this->lang->line("Delete"); ?></a>
                </div>
            </div>
            ...
            <div class="col-12">
                    <fieldset>
                        <div class="checkbox">
                            <input type="checkbox" name="reels_post" id="reels_post"
                                   value="yes" class="checkbox-input" <?php if(isset($all_data[0]['reels_post']) && $all_data[0]['reels_post'] == 'yes') echo 'checked'; ?>>
                            <label for="reels_post">
                                <?php echo $this->lang->line('Reels Post for Instagram'); ?>
                            </label>
                        </div>
