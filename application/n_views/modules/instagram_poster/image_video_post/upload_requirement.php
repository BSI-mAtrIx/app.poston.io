    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    <li class="">Image post only supports <span class="text-danger">single image</span>, if you upload
                        <span class="text-danger">multiple images</span> then it will be posted as carousel post.
                    </li>
                    ...
                    <li>The image's aspect ratio must falls withing a <span class="text-danger"> 4:5 to 1.91:1</span>
                        range
                    </li>
                </ul>
                <br>
                <h5>Video</h5>
                <ul>
                    <li><b>Container:</b> <span class="text-danger">MOV or MP4</span> (MPEG-4 Part 14), no edit lists,
