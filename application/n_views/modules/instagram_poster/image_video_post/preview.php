<div class="col-12 col-sm-8 col-md-3 col-lg-4 colrig">
    <div class="card main_card bg-body">
        <div class="card-header p-0 margin_bottom_22px" style="min-height: 0 !important;">
            <fieldset class="ml-2 mt-2">
                <div class="checkbox">
                    <input type="checkbox" name="selected_social_post_media_type" id="selected_social_post_media_type"
                           value="1" class="checkbox-input">
                    <label for="selected_social_post_media_type"><?php echo $this->lang->line('Instagram'); ?></label>
                </div>

            </fieldset>

        </div>
        <div class="card-body p-0 mt-0 mb-0 border preview_container bg-white rounded" id="preview_for_facebook">
            ...
            <ul class="list-unstyled list-unstyled-border mb-0 pr-2">
                <li class="media">
                    <img class="mr-3 rounded-circle mt-1" width="45" src="<?php echo $profile_picture; ?>" alt="avatar" onerror="this.onerror=null;this.src='<?php echo base_url(); ?>assets/img/avatar/avatar-1.png'">
                    <div class="media-body">
                        <h6 class="media-title mt-1 font-weight-bold"><a
                                    href="#"><?php echo isset($fb_user_info[0]['name']) ? $fb_user_info[0]['name'] : "Username"; ?></a>
                        </h6>
                        <div class="text-small text-muted">
                            <!-- Published by <?php echo isset($app_info[0]['app_name']) ? $app_info[0]['app_name'] : $this->config->item("product_short_name"); ?>  -->
                            1m
                            <div class="bullet text-muted"></div>
            ...
            <div class="preview_message px-2 mt-2 mb-2">Text goes here...</div>

            <div class="preview_video_block d_none">
                <video controls="" width="100%" height="290" class="border">
                    <source src=""></source>
                </video>
                <br/>
            ...
            <img src="<?php echo base_url('assets/img/post_button_fb.png'); ?>"
                 class="preview_img border-top mt-0 pt-0">

        </div>

        <div class="card-body p-0 mt-0 mb-0 border preview_container bg-white rounded" id="preview_for_instagram">
            <?php $profile_picture = (isset($account_list[0]['page_profile']) && $account_list[0]['page_profile'] != "") ? $account_list[0]['page_profile'] : base_url('assets/img/avatar/avatar-1.png'); ?>
            <ul class="list-unstyled list-unstyled-border mb-0 pr-2">
                <li class="media">
                    <img class="mr-3 rounded-circle mt-1" width="45" src="<?php echo $profile_picture; ?>" alt="avatar" onerror="this.onerror=null;this.src='<?php echo base_url(); ?>assets/img/avatar/avatar-1.png'">
                    <div class="media-body">
                        <h6 class="media-title mt-2 font-weight-bold"><a
                                    href="#"><?php echo isset($account_list[0]['insta_username']) ? $account_list[0]['insta_username'] : "Username"; ?></a>
                        </h6>
                        <!-- <div class="text-small text-muted">
            ...
            <div class="preview_video_block d_none mt-3">
                ...
                <img src="<?php echo base_url('assets/img/post_button.png'); ?>" class="preview_img mt-0 pt-0">
            ...
            <div id="not_supported"
                 class="alert alert-light mt-4"><?php echo $this->lang->line("Media type not supported for Instagram"); ?></div>
