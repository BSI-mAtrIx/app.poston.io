<link rel="stylesheet"
      href="<?php echo base_url("plugins/email_optin_form/css/embeded_code_direct_css.css?ver=" . $n_config['theme_version']) ?>">
...
<?php if ($is_direct == 1) : ?>
    ...
    <script src="<?php echo base_url("plugins/email_optin_form/js/submit_form.js?ver=" . $n_config['theme_version']) ?>"></script>
<?php endif; ?>