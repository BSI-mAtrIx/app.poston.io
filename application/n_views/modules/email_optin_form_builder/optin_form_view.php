                    ...
                    <div class="form-group">
                        <label><?php echo $this->lang->line("Contact Group"); ?> <span class="red">*</span>
                            <a href="#" data-placement="top" data-toggle="tooltip"
                               data-original-title="<?php echo $this->lang->line("Select Contact groups so that new subscribers through this form will be assigned at these groups."); ?>"><i
                                        class='bx bx-info-circle'></i> </a>
                        </label>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label class="mb-3"><?php echo $this->lang->line('Response After Submission'); ?> <span
                                    class="red">*</span>
                            <a href="#" data-placement="top" data-toggle="tooltip"
                               data-original-title="<?php echo $this->lang->line("Choose an option to make an event after successfull form submission."); ?>"><i
                                        class='bx bx-info-circle'></i> </a>
                        </label><br>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for=""><i
                            ...
                            <a href="#" data-placement="top" data-toggle="tooltip"
                               data-original-title="<?php echo $this->lang->line("If you enable double opt-in for email subscription, system will send a confirmation email to the submitted email address. By default system subscribe the subscriber directly."); ?>"><i
                                        class='bx bx-info-circle'></i> </a>
                        </label><br>
                        <label class="custom-switch mt-2">
...
<style>
    ...
    <?php //echo base_url("assets/builder_image/2.jpg") ?>
    ');
            } */
