...
?>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo base_url(); ?>n_assets/app-assets/css/pages/app-todo_v2.min.css?ver=<?php echo $n_config['theme_version']; ?>">
    <style>
        .li-placeholder {
    ...
    <div class="row pl-1">
        <a href="<?php echo base_url(); ?>task/board/<?php echo $board_id_active; ?>" class="btn btn-primary mb-1 ml-2">
            <?php echo $this->lang->line('Board view'); ?>
        </a>
                    ...
                    <div class="todo-sidebar d-flex">
                      <span class="sidebar-close-icon">
                        ...
                        <div class="todo-app-menu">
                            <div class="form-group text-center add-task pl-0 pr-0 mt-2 mt-lg-0">
                                <button href="#" class="btn btn-primary mb-1" data-toggle="modal"
                                        data-target="#addBoardModal">
                                    <i class="bx bx-plus-circle"></i> <?php echo $this->lang->line("Create new list"); ?>
                                </button>
                                <button href="#" class="btn btn-primary mb-1" data-toggle="modal"
                            ...
                            <div class="sidebar-menu-list">
                                <div class="list-group">
                                    ...
                                    <?php foreach ($boards as $board): ?>
                                        ...
                                        <a href="<?php echo base_url() . $uri_def; ?>/list/<?php echo $board['board_id']; ?>"
                                           class="list-group-item border-0 <?php if ($board_id_active == $board['board_id']): ?>active<?php endif; ?>"
                                           data-id="<?php echo $board['board_id']; ?>">
                                            <?php
                                            $color_icons = '#5A8DEE';
                                            if ($n_config['theme_appeareance_on'] == 'true') {
                                                $color_icons = $n_config['primary_color'];
                                            }
                                            ?>

                                            <span class="fonticon-wrap mr-50">
            <i class="livicon-evo"
               data-options="name: list.svg; size: 24px; style: lines; strokeColor:<?php echo $color_icons; ?>; eventOn:grandparent;"></i>
          </span>
                            ...
                            <div class="todo-app-list-wrapper">
                                <div class="todo-app-list">
                                    <div class="todo-fixed-search d-flex justify-content-between align-items-center">
                                        ...
                                        <h4 class="card-title mb-0 pl-1"><?php echo $board_name_active; ?></h4>
                                        <button class="kanban-title-button btn  btn-xs nodrag" data-toggle="modal"
                                                data-target="#addColumnModal"
                                                data-board_id="<?php echo $board_id_active; ?>">
                                    ...
                                    <div class="todo-task-list list-group">
                                        ...
                                        <?php foreach ($containers as $container) : ?>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-2"
                                                 style="border-bottom: <?php echo $container['container_color']; ?> 3px solid;">
                                                <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center nodrag">
                                                    ...
                                                    <p class="todo-title mx-50 m-0 truncate font-medium-2"><?php echo $container['container_name']; ?>
                                                        (<?php echo count($tasks[$container['container_id']]); ?>)</p>
                                                </div>

                                            </div>

                                            <ul class="todo-task-list-wrapper list-unstyled kanban-drag sortable pt-2"
                                                rel="<?php echo $container['container_id']; ?>">
                                                <?php foreach ($tasks[$container['container_id']] as $task) : ?>
                                                    <li class="todo-item portlet task_element"
                                                        <?php if ($task['task_color']) : ?>style="border-left: solid 4px <?php echo $task['task_color']; ?>;<?php endif; ?>"
                                                        id="<?php echo $task['task_id']; ?>" data-toggle="modal"
                                                        ...
                                                        <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
                                                            ...
                                                            <div class="todo-item-action d-flex align-items-center">
                                                                ...
                                                                <div class="action_button hidden-xs float-right">
                                                                    ...
                                                                    ?>
                                                                    <a class="time_tracker_action"
                                                                       rel="<?php echo $task['task_id']; ?>"><i
                                            ...
                                            <div>
                                                <button class="kanban-title-button btn btn-default btn-xs nodrag"
