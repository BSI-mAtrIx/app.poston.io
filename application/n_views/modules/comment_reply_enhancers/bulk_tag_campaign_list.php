    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i class="bx bx-tag"></i> <?php echo $this->lang->line("Tag List"); ?></h3>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <input type="text" id="searching1" name="searching1" class="form-control"
                               placeholder="<?php echo $this->lang->line("Search..."); ?>" style='width:300px;'>
                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="bx bx-list-ul"></i> <?php echo $this->lang->line("Tag List"); ?></h4>
            </div>
