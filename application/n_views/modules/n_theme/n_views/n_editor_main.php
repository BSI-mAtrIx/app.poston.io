...
<script type="text/javascript">
    ...
    const editor = grapesjs.init({
        ...
        storageManager: {
            ...
            urlStore: '<?php echo base_url('n_theme'); ?>/page_save/<?php echo $page_lang; ?>',
            urlLoad: '<?php echo base_url('n_theme'); ?>/page_load/<?php echo $page_lang; ?>',
        ...
        assetManager: {
            ...
            upload: '<?php echo base_url(); ?>n_theme/upload_assets/system',
            assets: [],
            uploadFile: function (e) {
                ...
                $.ajax({
                    url: '<?php echo base_url(); ?>n_theme/upload_assets/system',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    crossDomain: true,
