            ...
            <form action="#" id="create_custom_page" method="POST" enctype="multipart/form-data">
                <div class="card">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="page_name" name="page_name"
                                           value="<?php echo set_value("page_name") ?>">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="page_description"
                                              ...
                                              placeholder="<?php echo $this->lang->line("Type your page description here..."); ?>"><?php echo set_value("page_description") ?></textarea>
                    ...
                    <div class="card-footer bg-whitesmoke">
                        <button class="btn btn-primary" id="create_page" type="button"><i
                                    class="bx bx-paper-plane"></i> <?php echo $this->lang->line("Create Page") ?>
                        </button>
