...
<div class="row">
    <div class="col-12">
        <a href="<?php echo base_url("gmb/create_media_campaign"); ?>" class="btn btn-primary mb-1">
            <i class="bx bx-plus-circle"></i> <?php echo $this->lang->line("Create new media campaign"); ?>
        </a>
    </div>
</div>
