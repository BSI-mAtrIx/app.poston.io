<script>
    ...
    $("document").ready(function () {
        ...
        function handleMediaPreview(media_url) {

            var media_type = findFileType(media_url);
        ...
        // Previews media file
        handleMediaPreview(gmb_media_url);
        ...
        $("#media_file").uploadFile({
            ...
            deleteCallback: function (data, pd) {
                ...
                $.post(delete_url, {op: 'delete', name: data}, function (resp, textStatus, jqXHR) {
                        ...
                        if (true === result.status) {
                            // Change media upload status
                            $('#media_upload_status').val('');
                        }
                    }
                );
            },
            onSuccess: function (files, data, xhr, pd) {
                ...
                if (true === data.status) {
                    ...
                    // Change media upload status
                    $('#media_upload_status').val('uploaded');
