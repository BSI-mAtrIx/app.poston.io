            ...
            <div class="card main_card">
                <div class="card-header" style="border-bottom: 0;padding-bottom:0 !important;">
                    <ul class="nav nav-tabs" role="tablist" style="width:100% !important">
                        <li class="nav-item">
                            <a id="cta_post" class="nav-link post_type active" data-toggle="tab" href="#ctaPost"
                ...
                <div class="card-body" style="padding-top:0 !important;margin-top: -3px;">
                    ...
                    <div class="tab-content" id="post_tab_content">
                        ...
                        <!-- starts form -->
                        <form action="<?php echo base_url('gmb/create_campaign'); ?>" enctype="multipart/form-data"
                              id="auto_poster_form" method="post">
                            ...
                            <!-- starts common-fields -->
                            <div id="common-fields" class="d-none">
                                <div class="form-group">
                                    <label for="post_title"><?php echo $this->lang->line('Post Title: '); ?></label>
                            ...
                            <div id="message_textarea" class="form-group">
                                ...
                                <textarea class="form-control" name="message" id="message" maxlength="500"
                                          placeholder="<?php echo $this->lang->line('Type summery here...'); ?>"></textarea>
                            </div>

                            <div class="form-group">
                                <label><?php echo $this->lang->line('Media URL'); ?> <a href="#" data-placement="top"
                                                                                        data-html="true"
                                                                                        data-toggle="popover"
                                                                                        data-trigger="focus"
                                                                                        title="<?php echo $this->lang->line("Photo guidelines") ?>"
                                                                                        data-content="<?php echo $this->lang->line("Your photos look best on Google if they meet the following standards:<br><br><strong>Format</strong>: JPG or PNG.<br><strong>Size</strong>: Between 10 KB and 5 MB.</br><strong>Recommended resolution</strong>: 720 px tall, 720 px wide.<br><strong>Minimum resolution</strong>: 250 px tall, 250 px wide.") ?>"><i
                        ...
                        <div class="post_preview_block">
                            ...
                            <div class="preview_og_info">
                                ...
                                <div class="preview_og_info_coupon inline-block d-none">
                                    ...
                                    <div class="preview_coupon_date d-none"></div>
                                </div>
                            </div>
                        </div>
                    </div>
