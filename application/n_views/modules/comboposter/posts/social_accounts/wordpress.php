<div class="card">
    <div class="card-header border-bottom">
        <h4 class="card-title d-flex align-items-center"><?php echo $this->lang->line('Wordpress'); ?></h4>
        <div class="heading-elements" style="top:20px;">
            <fieldset>
                <div class="checkbox">
                    <input type="checkbox" class="checkbox-input wordpress_all_account_select"
                           id="wordpress_all_account_select">
                    <label for="wordpress_all_account_select" title="<?php echo $this->lang->line("Select all"); ?>"
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <div>
                                ...
                                <div class="font-small-2"><?php echo $single_account['blog_url']; ?></div>
                            </div>
                        </td>
                    </tr>
