<div class="card">
    ...
    <div class="card-header border-bottom">
        <h4 class="card-title d-flex align-items-center"><?php echo $this->lang->line('Medium'); ?></h4>
        <div class="heading-elements" style="top:20px;">
            <fieldset>
                <div class="checkbox">
                    <input type="checkbox" class="checkbox-input medium_all_account_select"
                           id="medium_all_account_select">
                    <label for="medium_all_account_select" title="<?php echo $this->lang->line("Select all"); ?>"
                ...
                <?php foreach ($medium_account_list as $single_account): ?>
                    ...
                    <tr>
                        <td class="width-50 p-0 text-center">
                            <fieldset>
                                <div class="checkbox">
                                    <input type="checkbox" class="checkbox-input medium_single_user"
                                           name="medium_single_user[]" id="medium_single_user-<?php echo $i; ?>"
                                        ...
                                        ?>
                                    >
                                    <label for="medium_single_user-<?php echo $i; ?>"></label>
                                </div>
                            </fieldset>
                        </td>
