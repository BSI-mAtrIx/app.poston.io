        ...
        <div class="breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item active"><a
                                href="<?php echo base_url('comboposter/' . $campaign_type . '_post/campaigns') ?>"><?php echo $this->lang->line(ucfirst($campaign_type) . " post"); ?></a>
                    </li>
            ...
            <div class="card">
                ...
                <div class="card-body data-card">
                    ...
                    <h2 class="section-title"
                        style="margin-top: 10px;"><?php echo $this->lang->line("Campaign Name"); ?></h2>
                    <p class="section-lead"><?php echo $campaigns_info['campaign_name']; ?></p>

                    <?php if ($campaigns_info['title'] != ''): ?>
                        <!-- title section -->
                        <h2 class="section-title"
                            style="margin-top: 10px;"><?php echo $this->lang->line("Title"); ?></h2>
                    ...
                    <?php if (($campaign_type == 'link' || $campaign_type == 'image') && $campaigns_info['link'] != ''): ?>
                        <!-- link section -->
                        <h2 class="section-title"
                            style="margin-top: 10px;"><?php echo $this->lang->line("Link"); ?></h2>
                    ...
                    <?php if ($campaign_type == 'video'): ?>
                        ...
                        <h2 class="section-title hidden"
                            style="margin-top: 10px;"><?php echo $this->lang->line("Privacy Type"); ?></h2>
                    ...
                    <?php if ($campaign_type == 'image' && $campaigns_info['image_url'] != ''): ?>
                        <!-- image section -->
                        <h2 class="section-title"
                            style="margin-top: 10px;"><?php echo $this->lang->line("Image"); ?></h2>
                        <p class="section-lead"><img src="<?php echo $campaigns_info['image_url']; ?>" alt="image"
                    ...
                    <?php if (($campaign_type == 'video' || $campaign_type == 'link') && $campaigns_info['thumbnail_url'] != ''): ?>
                        <!-- thumbnail section -->
                        <h2 class="section-title"
                            style="margin-top: 10px;"><?php echo $this->lang->line("Thumbnail"); ?></h2>
                        <p class="section-lead"><img src="<?php echo $campaigns_info['thumbnail_url']; ?>" alt="image"
                                                     height="250" width="250"></p>
                    <?php endif ?>
                    ...
                    <?php if ($campaign_type == 'video' && $campaigns_info['video_url'] != ''): ?>
                        <!-- video section -->
                        <h2 class="section-title"
                            style="margin-top: 10px;"><?php echo $this->lang->line("Video"); ?></h2>
                    ...
                    <?php if ($campaign_type != 'html' && $campaigns_info['message'] != ''): ?>
                        <!-- message section -->
                        <h2 class="section-title"
                            style="margin-top: 10px;"><?php echo $this->lang->line("Message"); ?></h2>
                    ...
                    <?php if (($campaign_type == 'image' || $campaign_type == 'html') && $campaigns_info['rich_content'] != ''): ?>
                        ...
                        <h2 class="section-title"
                            style="margin-top: 10px;"><?php echo $this->lang->line("Rich Content"); ?></h2>
                    ...
                    <?php else: ?>
                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            ...
                            <?php foreach ($post_report as $key => $single_report): ?>
                                ...
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($i == 0) echo "active show"; ?>"
                                       id="<?php echo lcfirst($key); ?>-tab" data-toggle="tab"
                                       href="#<?php echo lcfirst($key); ?>" role="tab" aria-controls="home"
                                       aria-selected="true"><?php echo $key; ?></a>
                                </li>
                        ...
                        <div class="tab-content table-bordered" style="border-top: none;">
                            ...
                            <?php foreach ($post_report as $key => $single_report): ?>
                                ...
                                <div class="tab-pane fade <?php if ($key == $first_selected_tab) echo "active show"; ?>"
                                     id="<?php echo lcfirst($key); ?>" role="tabpanel"
                                     aria-labelledby="<?php echo lcfirst($key); ?>-tab">
                                                    ...
                                                    <li class="list-group-item list-group-item-action">
                                                        <div class="row">
                                                            <div class="col-12 col-md-9">
                                                                <img class="mr-3 rounded-circle mCS_img_loaded"
                                                                     width="35"
                                                                     src="<?php echo isset($report["display_account_image"]) ? $report["display_account_image"] : ''; ?>"
                                                                     alt="avatar">
                                                                <h6 style="font-size: 14px;font-weight: 400;"
                                                                    class="page_list_media_title media-title mt-2 d-inline"><?php echo isset($report["display_name"]) ? $report["display_name"] : ''; ?></h6>
                                                            </div>
                                                            ...
                                                            <div class="col-10 col-md-3">
                                                                ...
                                                                if (isset($report['report']) && $first_4_http_check == 'http'): ?>
                                                                    <a class="btn btn-outline-primary btn-rounded float-right"
                                                                       href="<?php echo $report['report']; ?>"><?php echo $this->lang->line("Visit Post"); ?></a>
