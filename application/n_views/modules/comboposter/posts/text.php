            ...
            <div class="breadcrumbs-top">
                ...
                <div class="breadcrumb-wrapper d-none d-sm-block">
                    <ol class="breadcrumb p-0 mb-0 pl-1">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="<?php echo base_url("comboposter/text_post/campaigns"); ?>"><?php echo $this->lang->line("Text post"); ?></a>
                        </li>
                        ...
                        <div class="row pills-stacked">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <ul class="nav nav-pills flex-column text-center text-md-left">
                                    ...
                                    <?php if ($this->session->userdata('user_type') == 'Admin' || in_array(107, $this->module_access)) : ?>
                                        <li class="nav-item">
                                            <a href="#bxl-blogger" class="nav-link align-items-center" data-toggle="pill" aria-expanded="true">
                                    ...
                                    <?php if ($this->session->userdata('user_type') == 'Admin' || in_array(108, $this->module_access)) : ?>
                                        <li class="nav-item">
                                            <a href="#bxl-wordpress" class="nav-link align-items-center" data-toggle="pill" aria-expanded="true">
                            ...
                            <div class="col-md-9 col-sm-12">
                                <div class="tab-content p-0 bg-transparent shadow-none">
                                    ...
                                    <!--
                                    <?php if ($this->session->userdata('user_type') == 'Admin' || in_array(107, $this->module_access)) : ?>
                                        <div role="tabpanel" class="tab-pane" id="bxl-blogger" aria-labelledby="brand"  aria-expanded="true">
                                    ...
                                    <!--
                                    <?php if ($this->session->userdata('user_type') == 'Admin' || in_array(108, $this->module_access)) : ?>
                                        <div role="tabpanel" class="tab-pane" id="bxl-wordpress" aria-labelledby="brand"  aria-expanded="true">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-footer p-0">
                                <a class="btn btn-light has-icon" onclick='goBack("comboposter/text_post/campaigns",0)'><i
                                            class="bx bx-time mr-1"></i>
                                    <span><?php echo $this->lang->line("Cancel") ?></span> </a>

                                <button class="btn btn-primary has-icon float-right" post_type="text"
                                        action_type="<?php echo $post_action; ?>" id="submit_post" type="button"><i
                                            class="<?php echo $campaign_btn_icon ?> mr-1"></i>
                                    <span><?php echo $campaign_btn; ?></span></button>
                            </div>
                        </div>
                    </div>
