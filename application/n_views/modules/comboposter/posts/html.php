            ...
            <div class="breadcrumbs-top">
                ...
                <div class="breadcrumb-wrapper d-none d-sm-block">
                    <ol class="breadcrumb p-0 mb-0 pl-1">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="<?php echo base_url("comboposter/html_post/campaigns"); ?>"><?php echo $this->lang->line("Html post"); ?></a>
                        </li>
        ...
        <div class="row">
            <form action="#" enctype="multipart/form-data" id="comboposter_form" method="post" style="width: 100%;">
                ...
                <div class="col-12">
                    <?php
                    /* include form */
                    include $include_view_prefix . 'posts/forms/html_post_form.php';
                    ?>
                </div>
                        ...
                        <div class="row pills-stacked">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <ul class="nav nav-pills flex-column text-center text-md-left">
                                    ...
                                    <?php if ($this->session->userdata('user_type') == 'Admin' || in_array(107, $this->module_access)) : ?>
                                        <li class="nav-item ">
                                            <a href="#bxl-blogger" class="nav-link align-items-center active"
                            ...
                            <div class="col-md-9 col-sm-12">
                                <div class="tab-content p-0 bg-transparent shadow-none">
                                    ...
                                    <?php if ($this->session->userdata('user_type') == 'Admin' || in_array(107, $this->module_access)) : ?>
                                        <div role="tabpanel" class="tab-pane active" id="bxl-blogger"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-footer p-0">
                            <button class="btn btn-primary" post_type="html" action_type="<?php echo $post_action; ?>"
                                    id="submit_post" type="button"><i
                                        class="<?php echo $campaign_btn_icon ?>"></i> <?php echo $campaign_btn; ?>
                            </button>

                            <a class="btn btn-light float-right"
                               onclick='goBack("comboposter/html_post/campaigns",0)'><i
