            ...
            <div class="breadcrumbs-top">
                ...
                <div class="breadcrumb-wrapper d-none d-sm-block">
                    <ol class="breadcrumb p-0 mb-0 pl-1">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="<?php echo base_url("comboposter/video_post/campaigns"); ?>"><?php echo $this->lang->line("Video post"); ?></a>
                        </li>
            ...
            <div class="row">
                <form action="#" enctype="multipart/form-data" id="comboposter_form" method="post" style="width: 100%">
                    ...
                    <div class="col-12">
                        <?php
                        /* include form */
                        include $include_view_prefix . 'posts/forms/video_post_form.php';
                        ?>
                    </div>
                            ...
                            <div class="row pills-stacked">
                                ...
                                <div class="col-md-9 col-sm-12">
                                    <div class="tab-content p-0 bg-transparent shadow-none">
                                        ...
                                        <?php if ($this->session->userdata('user_type') == 'Admin' || in_array(102, $this->module_access)) : ?>
                                            <div role="tabpanel" class="tab-pane" id="bxl-twitter"
                                                 aria-labelledby="brand" aria-expanded="true">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-footer p-0">
                                <button class="btn btn-primary" post_type="video"
                                ...
                                <a class="btn btn-light float-right"
                                   onclick='goBack("comboposter/video_post/campaigns",0)'><i
