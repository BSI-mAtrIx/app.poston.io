    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <label for="campaign_title"><?php echo $this->lang->line("Title (Reddit, Linkedin)"); ?></label>
                <fieldset class="form-group position-relative has-icon-left">
                    <input name="title" id="campaign_title"
                           value="<?php if ($post_action == 'edit' || $post_action == 'clone') echo $campaign_form_info['title']; ?>"
                           class="form-control" type="text"
                           placeholder="<?php echo $this->lang->line("Title (Reddit, Linkedin)"); ?>">
                    <div class="form-control-position">
            ...
            <div class="col-12 col-md-6">
                <label for="thumbnail_url"><?php echo $this->lang->line('Thumbnail URL (Linkedin)'); ?></label>
                <fieldset class="form-group position-relative has-icon-left">
                    <input type="input" class="form-control" name="thumbnail_url" id="thumbnail_url"
                           value="<?php if ($post_action == 'edit' || $post_action == 'clone') echo $campaign_form_info['thumbnail_url']; ?>"
                           placeholder="<?php echo $this->lang->line('Thumbnail URL (Linkedin)'); ?>">
                    <div class="form-control-position">
                ...
                <div class="form-group">
                    <label><?php echo $this->lang->line('Upload thumbnail'); ?>
                        <a href="#" data-placement="top" data-toggle="popover"
                           data-content="<?php echo $this->lang->line("Allowed files are .png,.jpg,.jpeg,.bmp,.tiff"); ?>"><i
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <fieldset class="form-group position-relative has-icon-left">
                        <input class="form-control" name="link" id="link" type="input"
                               value="<?php if ($post_action == 'edit' || $post_action == 'clone') echo $campaign_form_info['link']; ?>"
                               placeholder="<?php echo $this->lang->line("Link"); ?>">
                        <div class="form-control-position">
                            <i class="bx bx-link"></i>
                        </div>
