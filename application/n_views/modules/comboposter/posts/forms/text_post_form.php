<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <label for="campaign_title"><?php echo $this->lang->line("Title (Reddit, Medium)"); ?></label>
                <fieldset class="form-group position-relative has-icon-left">
                    <input name="title" id="campaign_title"
                           value="<?php if ($post_action == 'edit' || $post_action == 'clone') echo $campaign_form_info['title']; ?>"
                           class="form-control" type="text"
                           placeholder="<?php echo $this->lang->line("Title (Reddit, Medium)"); ?>">
                    <div class="form-control-position">
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea style="height: 137px !important;" class="form-control" name="message" id="message"
                              rows="11" placeholder="<?php echo $this->lang->line('Type your message here...'); ?>"
                              spellcheck="false"
                              data-ms-editor="true"><?php if ($post_action == 'edit' || $post_action == 'clone') echo $campaign_form_info['message']; ?></textarea>
