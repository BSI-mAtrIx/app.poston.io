    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <label for="campaign_title"><?php echo $this->lang->line("Title (Wordpress, Blogger, Medium)"); ?></label>
                <fieldset class="form-group position-relative has-icon-left">
                    <input name="title" id="campaign_title"
                           value="<?php if ($post_action == 'edit' || $post_action == 'clone') echo $campaign_form_info['title']; ?>"
                           class="form-control" type="text"
                           placeholder="<?php echo $this->lang->line("Title (Wordpress, Blogger, Medium)"); ?>">
                    <div class="form-control-position">
                ...
                <div class="form-group">
                    <label><?php echo $this->lang->line('Image'); ?> <?php echo $this->lang->line('(Max size: '); ?> <?php echo $this->config->item('comboposter_image_upload_limit') . 'MB)'; ?>
                        <a href="#" data-placement="top" data-toggle="popover"
                           data-content="<?php echo $this->lang->line("You can attach an attachment up to 5MB size.") . ' ' . $this->lang->line("Allowed files are .png,.jpg,.jpeg,.bmp,.tiff"); ?>"><i
                                    class='bx bx-info-circle'></i>
                        </a>
                    </label>
                    <input name="image_url" id="image_file" placeholder="" type="hidden"
                           value="<?php if ($post_action == 'edit' || $post_action == 'clone') echo $campaign_form_info['image_url']; ?>">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <label for="message"><?php echo $this->lang->line('Message (Facebook, Twitter)'); ?></label>
                    <textarea class="form-control" name="message" id="message" rows="11"
                              placeholder="<?php echo $this->lang->line('Type your message here...'); ?>"
                              style="height: 135px !important;"><?php if ($post_action == 'edit' || $post_action == 'clone') echo $campaign_form_info['message']; ?></textarea>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    <label><?php echo $this->lang->line('Rich Content (Blogger, Wordpress, Medium)'); ?></label>
                    <textarea class="form-control" name="rich_content"
                              id="rich_content"><?php if ($post_action == 'edit' || $post_action == 'clone') echo htmlspecialchars_decode($campaign_form_info['rich_content']); ?></textarea>
                </div>
            </div>
        </div>
