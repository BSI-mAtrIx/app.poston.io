...
<script>
    $(document).ready(function ($) {
        ...
        <?php if(!empty($page_info) and $selected_page == 0 and $iframe == 0){ ?>
        window.location.href = base_url + 'messenger_bot_enhancers/checkbox_plugin_list/' + $('#bot_list_select').val();
        <?php } ?>

        <?php if(!empty($page_info) and $selected_page != 0 and $iframe == 0){ ?>
        $('#bot_list_select').val(<?php echo $selected_page; ?>);
        <?php } ?>
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        var embed_js = '<a campaign_id=' + row[1] + ' class="badge badge-status get_js_embed" title="<?php echo $this->lang->line('Get Embed Code') ?>" style="cursor: pointer;"><i class="bx bx-code"></i> <?php echo $this->lang->line('Js Code'); ?></a>';
                        return embed_js;
                    }
                },
                {
