            ...
            <div class="card main_card">
                ...
                <div class="card-body">
                    <form action="#" enctype="multipart/form-data" id="plugin_form">
                            ...
                            <div class="form-group col-12 col-md-4 <?php if (!$this->is_broadcaster_exist) echo 'hidden'; ?>">
                                <label class="d-block">
                                    ...
                                    <a class="blue float-right pointer"
                                       page_id_for_label="<?php echo $xdata["page_id"]; ?>" id="create_label_me_link"><i
                        ...
                        <a href="<?php echo base_url('messenger_bot_enhancers/mme_link_list/' . $xdata['page_id'] . '/1'); ?>"
