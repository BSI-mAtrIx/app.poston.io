        ...
        <div class="modal-content <?php if ($iframe == '1') echo 'no_shadow'; ?>">
            <?php if ($iframe != '1') : ?>
                <div class="modal-header" style="padding: 10px;">
                    <h4 class="modal-title" style="padding-left: 35px;"><i
                                class='bx bx-plus'></i> <?php echo $this->lang->line("Add Sequence"); ?></h4>
                </div>
            <?php endif; ?>
                        ...
                        <form action="#" enctype="multipart/form-data" id="plugin_form" style="padding-left: 0;">
                            ...
                            <div class="card hidden border_me" id="engagement_block">
                                <div class="card-header">
                                    <h4>
                                        <i class="bx bx-show"></i> <?php echo $this->lang->line("Messenger Engagement Re-targeting"); ?>
                                    </h4>
                                </div>
                            ...
                            <div class="card border_me">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="well text-justify"
                                         style="border:1px solid var(--blue);padding:15px;color:var(--blue);">
                                                ...
                                                <div class="form-group col-7 offset-3">
                                                    ...
                                                    <a id="remove_last_day" href=""
                                                       class="btn btn-outline-danger btn-sm float-right"><i
                                                                class="bx bx-time"></i> <?php echo $this->lang->line('Remove Last Day'); ?>
                                                    </a>
                                                </div>
                                                <div class="form-group col-2">
                                                    <a target="_BLANK"
                                                ...
                                                <div class="row <?php echo $hideshowclass; ?>"
                                                    ...
                                                    <div class="form-group col-2">
                                                        <a href=""
                                                           title="<?php echo $this->lang->line("Refresh Template List"); ?>"
                                                           data-toggle="tooltip" data-id="<?php echo $i; ?>"
                                                           class="hour_ref_template btn "><i
                                                                    class="bx bx-sync blue"></i></a>
                                                    </div>
                                                </div>
                                                <?php
                                            }
                                            ...
                                            <div class="row button_container">
                                                <div class="form-group col-7 offset-3">
                                                    ...
                                                    <a id="remove_last_hour" href=""
                                                       class="btn btn-outline-danger btn-sm float-right"><i
                                                                class="bx bx-time"></i> <?php echo $this->lang->line('Remove Last Hour'); ?>
                                                    </a>
                                                </div>
                                                <div class="form-group col-2">
                                                    <a target="_BLANK"
