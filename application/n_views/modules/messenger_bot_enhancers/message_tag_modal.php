    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i class="bx bx-tag"></i> <?php echo $this->lang->line('Message Tags'); ?></h3>
                <button type="button" class="close rounded-pill" data-dismiss="modal" aria-label="Close"><i
                            class="bx bx-x"></i></button>
            </div>
            <div class="modal-body">
                <?php if (strtotime(date("Y-m-d")) <= strtotime("2020-3-4")) : ?> <h5 class="text-center text-primary">
                    NEW TAGS</h5><br> <?php endif; ?>
                <div class="table-responsive2">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr class="row_0">
                            ...
                            <td>
                                <p>Send the user reminders or updates for an event they have registered for (e.g.,
                                    RSVP'ed, purchased tickets). This tag may be used for upcoming events and events in
                                    progress.</p>
                            </td>
                            <td>
                                <ul>
                                    <li>Reminder of upcoming classes, appointments, or events that the user has
                                        scheduled
                                    </li>
                                    <li>Confirmation of user's reservation or attendance to an accepted event or
                                        appointment
                                    </li>
                                    <li>Notification of user's transportation or trip scheduled, such as arrival,
                                        cancellation, baggage delay, or other status changes
                                    </li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li>Promotional content, including but not limited to deals, offers, coupons, and
                                        discounts
                                    </li>
                                    <li>Content related to an event the user has not signed up for (e.g., reminders to
                                        purchase event tickets, cross-sell of other events, tour schedules, etc)
                                    </li>
                        ...
                        <tr class="row_1 _5m29">
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li>Notifications of shipment status, such as product in-transit, shipped,
                                        delivered, or delayed
                                    </li>
                                    <li>Changes related to an order that the user placed, such credit card has declined,
                                        backorder items, or other order updates that require user action
                                    </li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li>Promotional content, including but not limited to deals, promotions, coupons,
                                        and discounts
                                    </li>
                        ...
                        <tr class="row_3 _5m29">
                            ...
                            <td>
                                <p>Allows human agents to respond to user inquiries. Messages can be sent within 7 days
                                    after a user message.</p>
                            </td>
                            <td>
                                <ul>
                                    <li>Human agent support for issues that cannot be resolved within the standard
                                        messaging window (e.g., business is closed for the weekend, issue requires &gt;24
                                        hours to resolve)
                                    </li>
                                </ul>
                            </td>
                        ...
                        <tr class="row_3 _5m29">
                            ...
                            <td>
                                <p>
                                    News messages allow news publishers to send regular news updates to their
                                    subscribers in Messenger. This feature is only available for registered news Pages
                                    under the <br><a href='https://www.facebook.com/help/publisher/316333835842972'>
                                        Facebook News Page Index (NPI)</a> <br> <a target='_BLANK'
                                                                                   href='https://developers.facebook.com/docs/messenger-platform/policy/policy-overview/#news_messaging'>Read
                                        Policy Details here</a>
                                </p>
                            </td>
                            <td>
                                Registered news Pages under the <a target='_BLANK'
                                                                   href='https://www.facebook.com/help/publisher/316333835842972'>
                                    Facebook News Page Index (NPI)</a>
                            </td>
                            <td>
                                <a target='_BLANK'
                                   href='https://developers.facebook.com/docs/messenger-platform/policy/policy-overview/#news_messaging'>Read
                    ...
                    <div class="table-responsive2">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr class="row_0">
                                ...
                                <td>
                                    <p>Send non-promotional messages to help people manage the productivity of their
                                        businesses or related activities.</p>
                                </td>
                                <td>
                                    <ul>
                                        <li>Notifications on services or products that a business has subscribed to or
                                            purchased from a service provider
                                        </li>
                                        <li>Reminders or alerts on upcoming invoices or service maintenance</li>
                                        <li>Reports on performance, metrics, or recommended actions for the business
                                        </li>
                                    </ul>
                                </td>
                                <td>
                            ...
                            <tr class="row_1 _5m29">
                                ...
                                <td>
                                    <p>Notify the message recipient of emergency or utility alerts, or issue a safety
                                        check in your community.</p>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr class="row_2">
                                ...
                                <td>
                                    <p>Send the message recipient reminders of a scheduled event which a person is going
                                        to attend.</p>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr class="row_3 _5m29">
                                ...
                                <td>
                                    <p>Send non-promotional messages under the News, Productivity, and Personal Trackers
                                        categories described in the Messenger Platform's subscription messaging policy.
                                        You can apply for access to use this tag under the Page Settings &gt; Messenger
                                        Platform.</p>
                                </td>
                                <td>
                                    <p>See
                                        <a href="/docs/messenger-platform/policy/policy-overview#subscription_messaging">Platform
                                            Policy Overview - Subscription Messaging</a></p>
                                </td>
                                <td>
                                    <p>After MAR 4, 2020 will only be available to Pages on the <a
                                                href="https://www.facebook.com/help/publisher/316333835842972">Facebook
                                            News Page Index (NPI)</a>,</p>
                                </td>
                            </tr>
                            <tr class="row_4">
                                <td>
                                ...
                                <td>
                                    <p>Notify the message recipient that a pairing has been identified based on a prior
                                        request.</p>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr class="row_9 _5m29">
                                ...
                                <td>
                                    <p>Notify the message recipient of a change in shipping status for a product that
                                        has already been purchased.</p>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr class="row_11 _5m29">
                                ...
                                <td>
                                    <p>Notify the message recipient of an update to a customer service issue that was
                                        initiated in a Messenger conversation.</p>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr class="row_13 _5m29">
                                ...
                                <td>
                                    <p>Notify the message recipient of a change in in-game user progression, global
                                        events, or a live sporting event.</p>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr class="row_14">
                                ...
                                <td>
                                    <p>Notify the message recipient of updates to an existing transportation
                                        reservation.</p>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr class="row_15 _5m29">
                                ...
                                <td>
                                    <p>Notify the message recipient of new features or functionality that become
                                        available in your bot.</p>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr class="row_16">
                                ...
                                <td>
                                    <p>Send the message recipient updates or reminders for an event for which a person
                                        already has a ticket.</p>
                                </td>
                                <td>
                                    <ul>
