                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                echo form_dropdown('broadcast_type', $broadcast_types, '', 'class="select2 form-control" id="broadcast_type"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6" id="message_tag_con">
                            <div class="form-group">
                                ...
                                echo form_dropdown('message_tag', $tag_list, '', 'class="select2 form-control" id="message_tag"'); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="schedule_time_block">
                        <div class="form-group col-12">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mt-2">
                                <input type="checkbox" name="schedule_type" value="later" id="schedule_type"
