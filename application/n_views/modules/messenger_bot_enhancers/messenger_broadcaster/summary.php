<div class="form-group">
    ...
    <label class="full_width">
    	<?php if($pop!='') {?>
    		<a class="float-right" data-toggle="popover" href="#" data-placement="top" data-trigger="focus" title="<?php echo $this->lang->line('Campaign Reach');?>" data-content="<?php echo $pop;?>"><i class="bx bxs-help-circle"></i></a>
    	<?php } ?>
    </label>
  	<ul class="list-group">
