<section class="section section_custom">
    <div class="section-header">
        <h1><i class="bx bx-paper-plane"></i> <?php echo $page_title; ?></h1>
        <div class="section-header-button">
            <a href="<?php echo base_url('messenger_bot_enhancers/create_quick_broadcast_campaign'); ?>"
               class="btn btn-primary"><i
                        class="bx bx-plus-circle"></i> <?php echo $this->lang->line("Create Campaign"); ?></a>
        </div>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a
                        href="<?php echo base_url('messenger_bot_broadcast'); ?>"><?php echo $this->lang->line("Messenger Broadcast"); ?></a>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                  ...
                  <div class="input-group-prepend">
                    ' . form_dropdown('search_page_id', $page_list, '', 'class="select2 form-control" id="search_page_id"') . '
                  </div>
                  <div class="input-group-prepend">'; ?>
