        ...
        <div class="breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item"><a
                                href="<?php echo base_url("messenger_bot_enhancers/subscriber_broadcast_campaign"); ?>"><?php echo $this->lang->line("Subscriber Broadcast"); ?></a>
                    </li>
...
<div class="row multi_layout">
                            ...
                            <div class="form-group">
                                <label>
                                    ...
                                    <a href="#" data-placement="top" data-html='true' data-toggle="popover"
                                       data-trigger="focus" title="<?php echo $this->lang->line("24H Policy"); ?>"
                                ...
                                <?php
                                foreach ($broadcast_types as $key => $val) {
                                    $broadcast_types[$key] = $this->lang->line($val);
                                }
                                echo form_dropdown('broadcast_type', $broadcast_types, $xdata['broadcast_type'], 'class="select2 form-control" id="broadcast_type"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6" id="message_tag_con">
                            <div class="form-group">
                                <label>
                                    ...
                                    <a data-toggle="modal" href='' data-target="#message_tags_modal"><i
                                                class='bx bx-info-circle'></i></a>
                                </label>
                                <?php
                                foreach ($tag_list as $key => $val) {
                                    $tag_list[$key] = $this->lang->line($val);
                                }
                                echo form_dropdown('message_tag', $tag_list, $xdata['message_tag'], 'class="select2 form-control" id="message_tag"'); ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control form-control-new template_types"
    ...
    <div class="col-12 col-md-4 col-lg-4 colmid" id="middle_column">
        <div class="card main_card">
            ...
            <div class="card-body">
                <?php include(FCPATH . "application/n_views/modules/messenger_bot_enhancers/messenger_broadcaster/summary.php") ?>
            </div>
        </div>
    </div>
</div>
