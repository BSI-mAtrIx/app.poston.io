        ...
        <div class="breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item active"><?php echo $this->lang->line("Edit Plugin"); ?></li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="domain_name" disabled autocomplete="off" id="domain_name"
                                       class="form-control" value="<?php echo $xdata['domain_name']; ?>"
                            ...
                            <div class="form-group col-12">
                                ...
                                <?php echo form_dropdown('language', $sdk_list, $xdata['language'], 'class="select2 form-control" id="language" style="width:100%;"'); ?>
                            </div>
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="reference" id="reference" class="form-control"
                                       value="<?php echo $xdata['reference']; ?>" disabled>
                            </div>
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="skin" value="dark" id="dark"
                                                       class="selectgroup-input" <?php if ($xdata['skin'] == 'dark') echo 'checked'; ?>>
                                                <span class="selectgroup-button"> <?php echo $this->lang->line("Light") ?></span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="skin" value="light" id="light"
                                                       class="selectgroup-input" <?php if ($xdata['skin'] == 'light') echo 'checked'; ?>>
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control" name="button_click_success_message"
                                          id="button_click_success_message"
                                          style="width: 100%;"><?php echo $xdata['button_click_success_message']; ?></textarea>
                            </div>
                                                    ...
                                                    <div class="reminder_block">
						                         	<span class="block1">
						                         		<textarea autofocus data-toggle="tooltip"
                                                                  ...
                                                                  id="msg_reminder_text<?php echo $i; ?>"><?php echo isset($messenger_content['reminder'][$i]['reminder_text']) ? $messenger_content['reminder'][$i]['reminder_text'] : ""; ?></textarea>
						                         	</span>
                                                        <span class="block2 ">
                                                        ...
                                                        <span class="block4">
						                         		<textarea data-toggle="tooltip"
                                                                  ...
                                                                  id="msg_reminder_text_checkout<?php echo $i; ?>"><?php echo isset($messenger_content['reminder'][$i]['reminder_text_checkout']) ? $messenger_content['reminder'][$i]['reminder_text_checkout'] : "Stock limited, complete your order before it is out of stock."; ?></textarea>
						                         		<p>
						                         		<input data-toggle="tooltip"
                                                ...
                                                <div class="reminder_block">
					                         	<span class="block1">
					                         		<textarea autofocus data-toggle="tooltip"
                                                              ...
                                                              id="msg_checkout_text"><?php echo isset($messenger_content['checkout']['checkout_text']) ? $messenger_content['checkout']['checkout_text'] : ""; ?></textarea>
					                         	</span>
                                                    <span class="block5">
                                                    ...
                                                    <span class="block4">
					                         		<textarea data-toggle="tooltip"
                                                              ...
                                                              id="msg_reminder_text_checkout_next"><?php echo isset($messenger_content['checkout']['checkout_text_next']) ? $messenger_content['checkout']['checkout_text_next'] : "There are many other exciting products you may like as well. Let's see what's there !"; ?></textarea>
					                         		<p>
					                         		<input data-toggle="tooltip"
                                                           ...
                                                           value="<?php echo isset($messenger_content['checkout']['checkout_btn_next']) ? $messenger_content['checkout']['checkout_btn_next'] : 'Visit Shop'; ?>"
                                                           class="btn btn-block bg-white"
                                                    ...
                                                    <div class="reminder_badge_warpper tab-pane fade <?php if ($i == 1) echo 'active show'; ?>"
						                         	...
						                         	<span class="block4">
						                         		<textarea data-toggle="tooltip"
                                                                  ...
                                                                  id="sms_reminder_text_checkout<?php echo $i; ?>"><?php echo isset($sms_content['reminder'][$i]['reminder_text']) ? $sms_content['reminder'][$i]['reminder_text'] : "Hi, have you forgot something special? Stock limited, complete your order before it is out of stock : {{cart_url}}"; ?></textarea>
						                         	</span>
                                                        </div>
                                                    </div>
                                                    <?php
                                                ...
                                                <div class="reminder_badge_warpper tab-pane fade" id="sms_checkout"
					                         	...
					                         	<span class="block4">
					                         		<textarea data-toggle="tooltip"
                                                              ...
                                                              id="sms_reminder_text_checkout_next"><?php echo isset($sms_content['checkout']['checkout_text']) ? $sms_content['checkout']['checkout_text'] : ""; ?></textarea>
					                         	</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-7">
                                            ...
                                            <div class="tab-content" id="EmailReminderTabContent">
                                                ...
                                                for ($i = 1; $i <= $how_many_reminder; $i++) { ?>
                                                    <div class="reminder_badge_warpper tab-pane fade <?php if ($i == 1) echo 'active show'; ?> "
                                                        ...
                                                        <textarea class="visualeditor" data-toggle="tooltip"
                                                                  ...
                                                                  id="email_reminder_text_checkout<?php echo $i; ?>"><?php echo isset($email_content['reminder'][$i]['reminder_text']) ? $email_content['reminder'][$i]['reminder_text'] : 'Hi {{last_name}},<br>Have you forgot something special? Stock limited, complete your order before it is out of stock : <a href="{{checkout_url}}" target="_blank">Checkout here</a></a><br>Happy shopping :)'; ?></textarea>
                                                    </div>
                                                    <?php
                                                }
                                                ?>
                                                ...
                                                <div class="reminder_badge_warpper tab-pane fade"
                                                    ...
                                                    <textarea class="visualeditor" data-toggle="tooltip"
                                                              ...
                                                              id="email_reminder_text_checkout_next"><?php echo isset($email_content['checkout']['checkout_text']) ? $email_content['checkout']['checkout_text'] : ''; ?></textarea>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="email_subject" id="email_subject" class="form-control"
                                                       value="<?php echo (isset($xdata['email_subject']) && $xdata['email_subject'] != "") ? $xdata['email_subject'] : "Abandoned Cart"; ?>">
                                            </div>
                ...
                <div class="card">
                    <div class="card-footer">
                        <button class="btn btn-primary" id="get_button" name="get_button" type="button"><i
                                    class="bx bx-code"></i> <?php echo $this->lang->line("Edit Plugin"); ?></button>
