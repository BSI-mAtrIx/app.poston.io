    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form class="form-horizontal" name="post-update"
                      action="<?php echo site_url() . 'blog/edit_post_action/' . $post[0]['id']; ?>" method="POST">
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><?php echo $this->lang->line("Title") ?></label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" id="title" name="title" value="<?php echo $post[0]['title']; ?>"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" id="keywords" name="keywords"
                                       value="<?php echo $post[0]['keywords']; ?>" class="form-control inputtags"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <?php echo form_dropdown('category_id', $category_lists, $post[0]['category_id'], array('class' => 'select2 form-control', 'id' => 'category_id')); ?>
                                <div class="red category_id_error"></div>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"
                                   for="body"><?php echo $this->lang->line("Content") ?></label>
                            <div class="col-sm-12 col-md-7">
                                <textarea name="body" id="body"><?php echo $post[0]['body']; ?></textarea>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div id="dropzone" class="dropzone dz-clickable">
                                    <div class="dz-default dz-message" style="">
                                        <input class="form-control" name="thumbnail" id="thumbnail"
                                               value="<?php echo $post[0]['thumbnail']; ?>" placeholder=""
                                               type="hidden">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <?php echo form_dropdown('tags[]', $tag_lists, explode(',', $post[0]['tags']), array('class' => 'select2 form-control', 'id' => 'tags', 'multiple' => true)); ?>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <button name="submit" type="submit" id="update_post" class="btn btn-primary"><i
