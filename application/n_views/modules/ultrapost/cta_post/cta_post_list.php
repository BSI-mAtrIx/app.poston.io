...
<div class="row">
    <div class="col-12">
        <a href="<?php echo base_url("ultrapost/cta_poster"); ?>" class="btn btn-primary mb-1">
                        ...
                        <div class="col-12 col-md-9">
                            <div class="input-group mb-3 float-left" id="searchbox">
                                ...
                                <div class="input-group-append has-icon-left">
                                    <input name="searching" id="campaign_name" autofocus aria-label=""
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i
                            class="bx bxs-volume"></i> <?php echo $this->lang->line("Report of CTA Poster"); ?></h3>
...
<!-- <div class="modal fade" id="view_report" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog  modal-lg" style="min-width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-center"><i class="bx bx-list-ul"></i> <?php echo $this->lang->line("report of CTA Poster") ?></h3>
