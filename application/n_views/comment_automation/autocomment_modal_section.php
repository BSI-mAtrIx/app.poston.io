<link rel="stylesheet"
      href="<?php echo base_url('assets/css/system/select2_100.css?ver=' . $n_config['theme_version']); ?>">
<div class="modal fade" id="auto_reply_message_modal_template" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">

            <div class="modal-header">
                <h3 class="modal-title padding_10_20_10_20px"><?php echo $this->lang->line("Please give the following information for post auto comment") ?></h3>
                    ...
                    <div class="row padding_20px">
                        ...
                        <div class="col-12 margin_top_15">
                            <div class="form-group">
                                ...
                                <br>
                                <input class="form-control" type="text" name="auto_campaign_name_template"
                                       id="auto_campaign_name_template"
                                       placeholder="<?php echo $this->lang->line('Write your campaign name here'); ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group p-0">
                                ...
                                <br>
                                <select class="form-control select2 w-100" id="auto_comment_template_id"
                                        name="auto_comment_template_id">
                                    <?php
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-switch">
                                    <input type="radio" name="schedule_type" value="onetime" id="schedule_now"
                                ...
                                <label class="custom-switch">
                                    <input type="radio" name="schedule_type" value="periodic" id="schedule_later"
                            ...
                            <div class="row">
                                <div class="form-group schedule_block_item col-12 col-md-6">
                                    ...
                                    <input placeholder="<?php echo $this->lang->line('Time'); ?>" name="schedule_time"
                            ...
                            <div class='schedule_block_item_new instagram_padded_bordered_background_schedule_block'>
                                ...
                                <div class="row">
                                    <div class="form-group schedule_block_item_new col-12 col-md-6">
                                        ...
                                        <input placeholder="<?php echo $this->lang->line('Time'); ?>" value="00:00"
                                               name="comment_start_time" id="comment_start_time"
                                    ...
                                    <div class="form-group schedule_block_item_new col-12 col-md-6">
                                        ...
                                        <input placeholder="<?php echo $this->lang->line('Time'); ?>" value="23:59"
                                               name="comment_end_time" id="comment_end_time"
                                               class="form-control datetimepicker2" type="text"/>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group schedule_block_item_new col-12 col-md-12">
                                        ...
                                        <label class="custom-switch">
                                            <input type="radio" name="auto_comment_type" value="random" id="random"
                                                   class="custom-switch-input" checked>
                                            <span class="custom-switch-indicator"></span>
                                        ...
                                        <label class="custom-switch">
                                            <input type="radio" name="auto_comment_type" value="serially" id="serially"
                                                   class="custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
            ...
            <div class="modal-footer padding_0_45px">
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-primary float-left" id="save_button_template"><i class='bx bx-save'></i>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                    ...
                    <div class="row padding_20px">
                        ...
                        <div class="col-12">
                            <div class="form-group p-0">
                                ...
                                <br>
                                <select class="form-control" id="edit_auto_comment_template_id"
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-switch">
                                    <input type="radio" name="edit_schedule_type" value="onetime"
                                           id="edit_schedule_type_o" class="custom-switch-input" checked>
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description"><?php echo $this->lang->line('One Time'); ?></span>
                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <label class="custom-switch">
                                    <input type="radio" name="edit_schedule_type" value="periodic"
                                           id="edit_schedule_type_p" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description"><?php echo $this->lang->line('Periodic'); ?>
                                </label>
                            </div>
                                    ...
                                    <div class="form-group schedule_block_item_new_p col-12 col-md-12">
                                        ...
                                        <label class="custom-switch">
                                            <input type="radio" name="edit_auto_comment_type" value="random"
                                                   id="edit_random" class="custom-switch-input" checked>
                                            <span class="custom-switch-indicator"></span>
                                            <span class="custom-switch-description"><?php echo $this->lang->line('Random'); ?></span>
                                        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <label class="custom-switch">
                                            <input type="radio" name="edit_auto_comment_type" value="serially"
                                                   id="edit_serially" class="custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
                                            <span class="custom-switch-description"><?php echo $this->lang->line('Serially'); ?>
                                        </label>
            ...
            <div class="modal-footer padding_0_45px">
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-primary float-left" id="edit_save_button_template"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><?php echo $this->lang->line("please provide a post id of page") ?> (<span
                            id="manual_page_name"></span>)</h3>
            </div>
            <div class="modal-body ">
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 col-md-offset-2">
                        <form>
                            <div class="form-group">
                                <label for="manual_post_id_template"><?php echo $this->lang->line("post id") ?>
                                    :</label>
                                <input type="text" class="form-control" id="manual_post_id_template"
                                       placeholder="<?php echo $this->lang->line("please give a post id") ?>" value="">
                                <input type="hidden" id="manual_table_id_template">
                            </div>
                            <div class="text-center" id="manual_reply_error_template"></div>

                            <div class="form-group text-center">
                                <button type="button" class="btn btn-primary enable_auto_commnet_template"
                                        id="manual_auto_reply_template"><i
                                            class="bx bx-check-circle"></i> <?php echo $this->lang->line("Enable Auto Comment") ?>
                                </button>
                            </div>
                        </form>
                        <div class="form-group text-center">
                            <button type="button" class="btn btn-outline-warning" id="check_post_id_template"><i
                                        class="bx bx-check"></i> <?php echo $this->lang->line("check existance") ?>
                            </button>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="modal-title"><?php echo $this->lang->line("please provide a post id of page") ?> (<span
                            id="manual_edit_page_name_template"></span>)</h3>
            </div>
            <div class="modal-body ">
                <div class="row">
                    <div class="col-12" id="waiting_div"></div>
                    <div class="col-12 col-md-8 col-md-offset-2">
                        <form>
                            <div class="form-group">
                                <label for="manual_post_id_template"><?php echo $this->lang->line("post id") ?>
                                    :</label>
                                <input type="text" class="form-control" id="manual_edit_post_id_template"
                                       placeholder="<?php echo $this->lang->line("please give a post id") ?>" value="">
                        ...
                        <div class="form-group text-center margin_top_15">
                            <button type="button" class="btn btn-outline-warning edit_reply_info_template"
                                    id="manual_edit_auto_reply_template"><i
                                        class="bx bx-edit"></i> <?php echo $this->lang->line("Edit Auto Comment") ?>
                            </button>
                        </div>
