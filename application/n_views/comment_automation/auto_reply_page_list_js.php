        ...
        $('#bot_list_select').on('change', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    data = data.replaceAll('custom-switch-input', 'custom-control-input');
                    data = data.replaceAll('<span class="custom-switch-indicator"></span>', '<label class="custom-control-label mr-1" for="status"></label>');
                    data = data.replaceAll('<h4 class="full_width">', '<h4 class="w-100">');

                    data = data.replaceAll('<label class="custom-switch float-right">', '<label class="custom-control custom-switch custom-control-inline fullpage_pause_play float-right" id="n_fullpage_pause_play">');

                    data = data.replaceAll('<span class="custom-switch-description"><?php echo $this->lang->line('On'); ?></span>', '');
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i
                            class="bx bx-poll"></i> <?php echo $this->lang->line("latest post for page") ?> - <span
                            id="page_name_div"></span></h3>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-control-inline">
                                    <input type="checkbox" name="auto_template_selection" value="yes"
                                           id="template_select" class="custom-control-input" checked>
...
Add label will only work once private reply is setup.  And you will need to sync subscribers later to update subscriber information. In this way the subscriber will not eligible for BOT subscriber until they reply back in messenger.") . '"><i class="bx bx-info-circle"></i> </a>';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group clearfix"
                                             style="border: 1px dashed #e4e6fc; padding: 10px;">
                                            <label><small>
            ...
            <div class="modal-footer" style="padding-left: 45px; padding-right: 45px; ">
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-info save_button float-left" id="save_and_create"
                                button_name="submit_create_button"><i
                                    class='bx bx-save'></i> <?php echo $this->lang->line("submit & save as template") ?>
                        </button>
                    </div>
                    <div class="col-6">
                        <button class="btn btn-primary save_button float-right" id="save_only"
                                button_name="only_submit"><i class='bx bx-save'></i> <span
...
<div class="modal fade" id="manual_reply_by_post" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><?php echo $this->lang->line("Enable reply by Post ID") ?> (<span
                    ...
                    <div class="col-12">
                        <form>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="manual_post_id"
                                       placeholder="<?php echo $this->lang->line("please give a post id") ?>">
                            </div>
                        ...
                        <div class="form-group text-center">
                            <button type="button" class="btn btn-info" id="check_post_id"><i
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><?php echo $this->lang->line("please provide a post id of page") ?> (<span
                            id="manual_edit_page_name"></span>)</h3>
            </div>
            <div class="modal-body ">
                <div class="row">
                    <div class="col-12" id="waiting_div"></div>
                    <div class="col-12 col-md-8 col-md-offset-2">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="manual_edit_post_id"
                        ...
                        <div class="form-group text-center" style="margin-top: 15px;">
                            <button type="button" class="btn btn-outline-warning edit_reply_info"
                                    id="manual_edit_auto_reply"><i
                                        class="bx bx-edit"></i> <?php echo $this->lang->line("edit auto reply") ?>
                            </button>
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header clearfix">
                ...
                <h3 class="modal-title"><i
                            class="bx bx-videos"></i> <?php echo $this->lang->line("filemanager Library") ?></h3>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="instant_comment_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i
                            class="bx bx-comment-dots"></i> <?php echo $this->lang->line("Instant Comment") ?></h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.get_all_comments', function (e) {
        ...
        $("#all_comments_modal_contents").html('<div class="text-center waiting p-4"><i class="bx bx-loader-alt bx-spin blue text-center font_size_60px"></i></div');
