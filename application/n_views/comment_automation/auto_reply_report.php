            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item"><a
                                href="<?php echo base_url("comment_automation/index"); ?>"><?php echo $this->lang->line("Comment Automation"); ?></a>
                    </li>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i
                            class="bx bx-list-ul"></i> <?php echo $this->lang->line("Report of Auto Reply"); ?>
                    <small>
                        (
                        <?php
...
<div class="modal fade" id="edit_auto_reply_message_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" style="min-width: 70%;">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h3 class="modal-title"><?php echo $this->lang->line("Please give the following information for post auto reply") ?></h3>
