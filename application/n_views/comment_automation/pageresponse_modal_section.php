    ...
    <div class="modal-dialog modal-lg" style="min-width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-center"
                    style="padding: 10px 20px 10px 20px;"><?php echo $this->lang->line("please give the following information for page response") ?></h3>
                <button type="button" id='modal_close' class="close">&times;</button>
            </div>
            <form action="#" id="pageresponse_auto_reply_info_form" method="post">
                <input type="hidden" name="pageresponse_auto_reply_page_id" id="pageresponse_auto_reply_page_id"
                       value="">
                <input type="hidden" name="pageresponse_auto_reply_post_id" id="pageresponse_auto_reply_post_id"
                       value="">
                ...
                <div class="modal-body" id="pageresponse_auto_reply_message_modal_body">
                    ...
                    <div class="row"
                         style="padding: 20px; <?php if (!$commnet_hide_delete_addon) echo "display: none;"; ?> ">
                                ...
                                <div class="row">
                                    <div class="col-6 col-md-6">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="radio" name="pageresponse_delete_offensive_comment"
                                                   value="hide" id="pageresponse_delete_offensive_comment_hide"
                                                   class="custom-control-input" checked>
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_delete_offensive_comment_hide"></label>
                                    ...
                                    <div class="col-6 col-md-6">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="radio" name="pageresponse_delete_offensive_comment"
                                                   value="delete" id="pageresponse_delete_offensive_comment_delete"
                                                   class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_delete_offensive_comment_delete"></label>
                                    ...
                                    <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                        <label><i class="bx bx-tag"></i>
                                            ...
                                            <a href="#" data-placement="bottom" data-toggle="popover"
                                               ...
                                               data-content="<?php echo $this->lang->line('write your'); ?>"> <i
                                                        class='bx bx-info-circle'></i> </a>
                                        </label>
                                        <textarea class="form-control message"
                                                  name="pageresponse_delete_offensive_comment_keyword"
                                                  id="pageresponse_delete_offensive_comment_keyword"
                                    ...
                                    <div class="form-group clearfix" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                        ...
                                        <div>
                                            <select class="form-group private_reply_postback"
                                                    id="pageresponse_private_message_offensive_words"
                                                    name="pageresponse_private_message_offensive_words">
                    ...
                    <div class="row" style="padding: 10px 20px 10px 20px;">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12 col-md-6" style=""><label><i
                                                class="bx bx-sort-down"></i> <?php echo $this->lang->line("do you want to send reply message to a user multiple times?") ?>
                                    </label></div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox" name="pageresponse_multiple_reply" value="yes"
                                                   id="pageresponse_multiple_reply" class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_multiple_reply"></label>
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox" name="pageresponse_comment_reply_enabled" value="yes"
                                                   id="pageresponse_comment_reply_enabled" class="custom-control-input"
                                                   checked>
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_comment_reply_enabled"></label>
                                            <span><?php echo $this->lang->line('Yes'); ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox" name="pageresponse_auto_like_comment" value="yes"
                                                   id="pageresponse_auto_like_comment" class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_auto_like_comment"></label>
                                            <span><?php echo $this->lang->line('Yes'); ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12" <?php if (!$commnet_hide_delete_addon) echo "style='display: none;'"; ?>>
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox" name="pageresponse_hide_comment_after_comment_reply"
                                                   value="yes" id="pageresponse_hide_comment_after_comment_reply"
                                                   class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_hide_comment_after_comment_reply"></label>
                                            <span><?php echo $this->lang->line('Yes'); ?></span>
                                        </div>
                                    </div>
                                </div>
            ...
            <?php endif; ?>
                            <div class="custom-control custom-radio">
                                <input type="radio" name="pageresponse_message_type" value="generic"
                                       id="pageresponse_generic" class="custom-control-input radio_button">
                                <label class="custom-control-label"
                                       for="pageresponse_generic"><?php echo $this->lang->line("generic message for all") ?></label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" name="pageresponse_message_type" value="filter"
                                       id="pageresponse_filter" class="custom-control-input radio_button">
                                <label class="custom-control-label"
                                       for="pageresponse_filter"><?php echo $this->lang->line("send message by filtering word/sentence") ?></label>
                            </div>
                        </div>
                        ...
                        <div class="col-12" style="margin-top: 15px;">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="pageresponse_auto_campaign_name"
                                       id="pageresponse_auto_campaign_name"
                ...
                <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>"
                   data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i
                            class='bx bx-user'></i> <?php echo $this->lang->line("first name") ?></a>
                                ...
                                <textarea class="form-control message" name="pageresponse_generic_message"
                                          id="pageresponse_generic_message"
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <span class="text-danger"
                                                  id="pageresponse_generic_image_for_comment_reply_error"></span>
                                            <input type="text" name="pageresponse_generic_image_for_comment_reply"
                                                   class="form-control"
                                                   id="pageresponse_generic_image_for_comment_reply"
                                        ...
                                        <div class="col-12 col-md-6">
                                            <label class="control-label"><i
                                                ...
                                                [mp4 <?php echo $this->lang->line("Preferred"); ?>]
                                                <a href="#" data-placement="bottom" data-toggle="popover"
                                                   data-trigger="focus"
                                            ...
                                            <span class="text-danger"
                                                  id="pageresponse_generic_video_comment_reply_error"></span>
                                            <input type="hidden" name="pageresponse_generic_video_comment_reply"
                                                   class="form-control" id="pageresponse_generic_video_comment_reply"
                                ...
                                <div>
                                    <select class="form-group private_reply_postback"
                                            id="pageresponse_generic_message_private"
                                            name="pageresponse_generic_message_private">
                                        <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                    </select>
                        ...
                        <div class="col-12" id="pageresponse_filter_message_div" style="display: none;">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <label class="custom-switch">
                                        <input type="radio" name="pageresponse_trigger_matching_type" value="exact"
                                               id="pageresponse_trigger_keyword_exact" class="custom-switch-input"
                                               checked>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="custom-switch">
                                        <input type="radio" name="pageresponse_trigger_matching_type" value="string"
                                               id="pageresponse_trigger_keyword_string" class="custom-switch-input">
                                        <span class="custom-switch-indicator"></span>
                            ...
                            <br/>
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                <div class="form-group clearfix" id="pageresponse_filter_div_<?php echo $i; ?>"
                                    ...
                                    <input class="form-control filter_word" type="text"
                                           name="pageresponse_filter_word_<?php echo $i; ?>"
                                           id="pageresponse_filter_word_<?php echo $i; ?>"
                    ...
                    <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>"
                       data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i
                                class='bx bx-user'></i> <?php echo $this->lang->line("first name") ?></a>
                                    ...
                                    <div class="clearfix"></div>
                                    <textarea class="form-control message"
                                              name="pageresponse_comment_reply_msg_<?php echo $i; ?>"
                                              id="pageresponse_comment_reply_msg_<?php echo $i; ?>"
                                              placeholder="<?php echo $this->lang->line("type your message here...") ?>"
                                              style="height:170px;"></textarea>
                                    ...
                                    <div class="clearfix" <?php if (!$commnet_hide_delete_addon) echo "style='display: none;'"; ?> >
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <span class="text-danger"
                                                      id="pageresponse_generic_image_for_comment_reply_error_<?php echo $i; ?>"></span>
                                                <input type="text"
                                                       name="pageresponse_filter_image_upload_reply_<?php echo $i; ?>"
                                                       class="form-control"
                                                       id="pageresponse_filter_image_upload_reply_<?php echo $i; ?>"
                                                       placeholder="<?php echo $this->lang->line("Put your image url here or click the above upload button") ?>"
                                                       style="margin-top: -14px;"/>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                ...
                                                <span class="text-danger"
                                                      id="pageresponse_edit_generic_video_comment_reply_error_<?php echo $i; ?>"></span>
                                                <input type="hidden"
                                                       name="pageresponse_filter_video_upload_reply_<?php echo $i; ?>"
                                                       class="form-control"
                                                       id="pageresponse_filter_video_upload_reply_<?php echo $i; ?>"
                                                       placeholder="<?php echo $this->lang->line("Put your image url here or click upload") ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <select class="form-group private_reply_postback"
                                                id="pageresponse_filter_message_<?php echo $i; ?>"
                                                name="pageresponse_filter_message_<?php echo $i; ?>">
                                            <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                        </select>
                            ...
                            <div class="clearfix">
                                <input type="hidden" name="pageresponse_content_counter"
                                       id="pageresponse_content_counter"/>
                                <button type="button" class="btn btn-sm btn-outline-primary float-right"
                                        id="pageresponse_add_more_button"><i
                                            class="bx bx-plus"></i> <?php echo $this->lang->line("add more filtering") ?>
                                </button>
                            </div>
                            <div class="form-group clearfix" id="pageresponse_nofilter_word_found_div"
                ...
                <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>"
                   data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i
                            class='bx bx-user'></i> <?php echo $this->lang->line("first name") ?></a>
                                ...
                                <div class="clearfix"></div>
                                <textarea class="form-control message" name="pageresponse_nofilter_word_found_text"
                                          id="pageresponse_nofilter_word_found_text"
                                          placeholder="<?php echo $this->lang->line("type your message here...") ?>"
                                          style="height:170px;"></textarea>
                                ...
                                <div class="clearfix" <?php if (!$commnet_hide_delete_addon) echo "style='display: none;'"; ?> >
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <span class="text-danger"
                                                  id="pageresponse_nofilter_image_upload_reply_error"></span>
                                            <input type="text" name="pageresponse_nofilter_image_upload_reply"
                                                   class="form-control" id="pageresponse_nofilter_image_upload_reply"
                                                   placeholder="<?php echo $this->lang->line("put your image url here or click the above upload button") ?>"
                                                   style="margin-top: -14px;"/>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            ...
                                            <span class="text-danger"
                                                  id="pageresponse_nofilter_video_upload_reply_error"></span>
                                            <input type="hidden" name="pageresponse_nofilter_video_upload_reply"
                                                   class="form-control" id="pageresponse_nofilter_video_upload_reply"
                                                   placeholder="<?php echo $this->lang->line("put your image url here or click upload") ?>"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <select class="form-group private_reply_postback"
                                            id="pageresponse_nofilter_word_found_text_private"
                                            name="pageresponse_nofilter_word_found_text_private">
                                        <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                    </select>
        ...
        <input type="hidden" name="pageresponse_ai_reply_enabled" value="0" id="pageresponse_ai_reply_enabled">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary float-left" id="pageresponse_save_button">
                    <i class="bx bx-save"></i>
                    <span class="align-middle ml-25"><?php echo $this->lang->line("save"); ?></span>
                </button>

                <button class="btn btn-secondary float-right cancel_button">
                    <i class='bx bx-x'></i>
                    <span class="align-middle ml-25"><?php echo $this->lang->line("cancel"); ?></span>
                </button>
...
<div class="modal fade" id="pageresponse_edit_auto_reply_message_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" style="min-width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-center" style="padding: 10px 20px 10px 20px;"><i
                            class="bx bx-share"></i> <?php echo $this->lang->line("please give the following information for page response") ?>
                </h3>
            ...
            <form action="#" id="pageresponse_edit_auto_reply_info_form" method="post">
                <input type="hidden" name="pageresponse_edit_auto_reply_page_id"
                       id="pageresponse_edit_auto_reply_page_id" value="">
                <input type="hidden" name="pageresponse_edit_auto_reply_post_id"
                       id="pageresponse_edit_auto_reply_post_id" value="">
                <div class="modal-body" id="pageresponse_edit_auto_reply_message_modal_body">
                    ...
                    <div class="row"
                        ...
                        <div class="col-12" style="margin-bottom: 20px;">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="radio" name="pageresponse_edit_delete_offensive_comment"
                                                   value="hide" id="pageresponse_edit_delete_offensive_comment_hide"
                                                   class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_edit_delete_offensive_comment_hide"></label>
                                            <span><?php echo $this->lang->line('hide'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="radio" name="pageresponse_edit_delete_offensive_comment"
                                                   value="delete" id="pageresponse_edit_delete_offensive_comment_delete"
                                                   class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_edit_delete_offensive_comment_delete"></label>
                                            <span><?php echo $this->lang->line('delete'); ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12 col-md-6"
                                     id="pageresponse_edit_delete_offensive_comment_keyword_div">
                                    <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                        <label><i class="bx bx-tag"></i>
                                            <small><?php echo $this->lang->line("write down the offensive keywords in comma separated") ?></small>
                                            <a href="#" data-placement="bottom" data-toggle="popover"
                                        ...
                                        <textarea class="form-control message"
                                                  name="pageresponse_edit_delete_offensive_comment_keyword"
                                                  id="pageresponse_edit_delete_offensive_comment_keyword"
                                                  placeholder="<?php echo $this->lang->line("Type keywords here in comma separated (keyword1,keyword2)...Keep it blank for no actions"); ?>"
                                                  style="height:59px !important;"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group clearfix" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                        ...
                                        <div>
                                            <select class="form-group private_reply_postback"
                                                    id="pageresponse_edit_private_message_offensive_words"
                                                    name="pageresponse_edit_private_message_offensive_words">
                                                <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                            </select>
                    ...
                    <div class="row" style="padding: 10px 20px 10px 20px;">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox" name="pageresponse_edit_multiple_reply" value="yes"
                                                   id="pageresponse_edit_multiple_reply" class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_edit_multiple_reply"></label>
                                            <span><?php echo $this->lang->line('Yes'); ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox" name="pageresponse_edit_comment_reply_enabled"
                                                   value="yes" id="pageresponse_edit_comment_reply_enabled"
                                                   class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_edit_comment_reply_enabled"></label>
                                            <span><?php echo $this->lang->line('Yes'); ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox" name="pageresponse_edit_auto_like_comment"
                                                   value="yes" id="pageresponse_edit_auto_like_comment"
                                                   class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_edit_auto_like_comment"></label>
                                            <span><?php echo $this->lang->line('Yes'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox"
                                                   name="pageresponse_edit_hide_comment_after_comment_reply" value="yes"
                                                   id="pageresponse_edit_hide_comment_after_comment_reply"
                                                   class="custom-control-input">
                                            <label class="custom-control-label mr-1"
                                                   for="pageresponse_edit_hide_comment_after_comment_reply"></label>
                                            <span><?php echo $this->lang->line('Yes'); ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <?php endif; ?>
                            <div class="custom-control custom-radio">
                                <input type="radio" name="pageresponse_edit_message_type" value="generic"
                                       id="pageresponse_edit_generic" class="custom-control-input radio_button">
                                <label class="custom-control-label"
                                       for="pageresponse_edit_generic"><?php echo $this->lang->line("generic message for all") ?></label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" name="pageresponse_edit_message_type" value="filter"
                                       id="pageresponse_edit_filter" class="custom-control-input radio_button">
                                <label class="custom-control-label"
                                       for="pageresponse_edit_filter"><?php echo $this->lang->line("send message by filtering word/sentence") ?></label>
                            </div>
                        </div>
                        <div class="col-12" style="margin-top: 15px;">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="pageresponse_edit_auto_campaign_name"
                                       id="pageresponse_edit_auto_campaign_name"
                                       placeholder="<?php echo $this->lang->line("write your auto reply campaign name here") ?>">
                            </div>
                        </div>
                ...
                <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>"
                   data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i
                            class='bx bx-user'></i> <?php echo $this->lang->line("first name") ?></a>
                                ...
                                <div class="clearfix"></div>
                                <textarea class="form-control message" name="pageresponse_edit_generic_message"
                                          id="pageresponse_edit_generic_message"
                                          placeholder="<?php echo $this->lang->line("type your message here...") ?>"
                                          style="height:170px;"></textarea>
                                ...
                                <div class="clearfix" <?php if (!$commnet_hide_delete_addon) echo "style='display: none;'"; ?> >
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <span class="text-danger"
                                                  id="pageresponse_generic_image_for_comment_reply_error"></span>
                                            <input type="text" name="pageresponse_edit_generic_image_for_comment_reply"
                                                   class="form-control"
                                                   id="pageresponse_edit_generic_image_for_comment_reply"
                                                   placeholder="<?php echo $this->lang->line("put your image url here or click the above upload button") ?>"
                                                   style="margin-top: -14px;"/>
                                            <div class="overlay_wrapper">
                                                <span></span>
                                                <img src="" alt="image"
                                                     id="pageresponse_edit_generic_image_for_comment_reply_display"
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <span class="text-danger"
                                                  id="pageresponse_edit_generic_video_comment_reply_error"></span>
                                            <input type="hidden" name="pageresponse_edit_generic_video_comment_reply"
                                                   class="form-control"
                                                   id="pageresponse_edit_generic_video_comment_reply"
                                                   placeholder="<?php echo $this->lang->line("put your image url here or click upload") ?>"/>
                                            <div class="overlay_wrapper">
                                                <span></span>
                                                <video width="100%" height="240" controls
                                                    ...
                                                    <source src=""
                                                            id="pageresponse_edit_generic_video_comment_reply_display"
                                                            type="video/mp4">
                                ...
                                <div>
                                    <select class="form-group private_reply_postback"
                                            id="pageresponse_edit_generic_message_private"
                                            name="pageresponse_edit_generic_message_private">
                                        <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                    </select>
                        ...
                        <div class="col-12" id="pageresponse_edit_filter_message_div" style="display: none;">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <label class="custom-switch">
                                        <input type="radio" name="pageresponse_edit_trigger_matching_type" value="exact"
                                               id="pageresponse_edit_trigger_keyword_exact" class="custom-switch-input"
                                               checked>
                                        <span class="custom-switch-indicator"></span>
                                        <span class="custom-switch-description"><?php echo $this->lang->line('Reply if the filter word exactly matches.'); ?></span>
                                    </label>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="custom-switch">
                                        <input type="radio" name="pageresponse_edit_trigger_matching_type"
                                               value="string" id="pageresponse_edit_trigger_keyword_string"
                            ...
                            <br/>
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                <div class="form-group clearfix" id="pageresponse_edit_filter_div_<?php echo $i; ?>"
                                     style="border: 1px dashed #e4e6fc; padding: 20px; margin-bottom: 50px;">
                                    <label>
                                        <i class="bx bx-tag"></i> <?php echo $this->lang->line("filter word/sentence") ?>
                                        <span class="text-danger">*</span>
                                    ...
                                    <input class="form-control filter_word" type="text"
                                           name="pageresponse_edit_filter_word_<?php echo $i; ?>"
                                           id="pageresponse_edit_filter_word_<?php echo $i; ?>"
                                           placeholder="<?php echo $this->lang->line("write your filter word here") ?>">
                                    <br/>
                ...
                <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>"
                   data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i
                            class='bx bx-user'></i> <?php echo $this->lang->line("first name") ?></a>
                                    ...
                                    <div class="clearfix"></div>
                                    <textarea class="form-control message"
                                              name="pageresponse_edit_comment_reply_msg_<?php echo $i; ?>"
                                              id="pageresponse_edit_comment_reply_msg_<?php echo $i; ?>"
                                              placeholder="<?php echo $this->lang->line("type your message here...") ?>"
                                              style="height:170px;"></textarea>
                                    ...
                                    <div class="clearfix" <?php if (!$commnet_hide_delete_addon) echo "style='display: none;'"; ?> >
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <span class="text-danger"
                                                      id="pageresponse_edit_generic_image_for_comment_reply_error_<?php echo $i; ?>"></span>
                                                <input type="text"
                                                       name="pageresponse_edit_filter_image_upload_reply_<?php echo $i; ?>"
                                                       class="form-control"
                                                       id="pageresponse_edit_filter_image_upload_reply_<?php echo $i; ?>"
                                                       placeholder="<?php echo $this->lang->line("put your image url here or click the above upload button") ?>"
                                                       style="margin-top: -14px;"/>
                                                <div class="overlay_wrapper">
                                                    <span></span>
                                                    <img src="" alt="image"
                                                         id="pageresponse_edit_filter_image_upload_reply_display_<?php echo $i; ?>"
                                                         height="240" width="100%" style="display:none;"/>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                ...
                                                <span class="text-danger"
                                                      id="pageresponse_edit_generic_video_comment_reply_error_<?php echo $i; ?>"></span>
                                                <input type="hidden"
                                                       name="pageresponse_edit_filter_video_upload_reply_<?php echo $i; ?>"
                                                       class="form-control"
                                                       id="pageresponse_edit_filter_video_upload_reply_<?php echo $i; ?>"
                                                       placeholder="<?php echo $this->lang->line("put your image url here or click upload") ?>"/>
                                                <div class="overlay_wrapper">
                                                    <span></span>
                                                    <video width="100%" height="240" controls
                                                           style="border:1px solid #ccc;display:none;margin-top:20px;">
                                                        <source src=""
                                                                id="pageresponse_edit_filter_video_upload_reply_display<?php echo $i; ?>"
                                                                type="video/mp4">
                                                        <?php echo $this->lang->line("your browser does not support the video tag.") ?>
                                                    </video>
                                                </div>
                                    ...
                                    <div>
                                        <select class="form-group private_reply_postback"
                                                id="pageresponse_edit_filter_message_<?php echo $i; ?>"
                                                name="pageresponse_edit_filter_message_<?php echo $i; ?>">
                                            <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                        </select>
                            ...
                            <div class="clearfix">
                                <input type="hidden" name="pageresponse_edit_content_counter"
                                       id="pageresponse_edit_content_counter"/>
                                <button type="button" class="btn btn-sm btn-outline-primary float-right"
                                        id="pageresponse_edit_add_more_button"><i
                                            class="bx bx-plus"></i> <?php echo $this->lang->line("add more filtering") ?>
                                </button>
                            </div>
                            <div class="form-group clearfix" id="pageresponse_edit_nofilter_word_found_div"
                                 style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 20px;">
                                <label>
                                    <i class="bx bx-envelope"></i> <?php echo $this->lang->line("comment reply if no matching found") ?>
                                    <a href="#" data-placement="bottom" data-toggle="popover" data-trigger="focus"
                ...
                <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>"
                   data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i
                            class='bx bx-user'></i> <?php echo $this->lang->line("first name") ?></a>
                                ...
                                <div class="clearfix"></div>
                                <textarea class="form-control message" name="pageresponse_edit_nofilter_word_found_text"
                                          id="pageresponse_edit_nofilter_word_found_text"
                                          placeholder="<?php echo $this->lang->line("type your message here...") ?>"
                                          style="height:170px;"></textarea>
                                ...
                                <div class="clearfix" <?php if (!$commnet_hide_delete_addon) echo "style='display: none;'"; ?> >
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <span class="text-danger"
                                                  id="pageresponse_edit_nofilter_image_upload_reply_error"></span>
                                            <input type="text" name="pageresponse_edit_nofilter_image_upload_reply"
                                                   class="form-control"
                                                   id="pageresponse_edit_nofilter_image_upload_reply"
                                                   placeholder="<?php echo $this->lang->line("put your image url here or click the above upload button") ?>"
                                                   style="margin-top: -14px;"/>
                                            <div class="overlay_wrapper">
                                                <span></span>
                                                <img src="" alt="image"
                                                     id="pageresponse_edit_nofilter_image_upload_reply_display"
                                                     height="240" width="100%" style="display:none;"/>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            ...
                                            <span class="text-danger"
                                                  id="pageresponse_edit_nofilter_video_upload_reply_error"></span>
                                            <input type="hidden" name="pageresponse_edit_nofilter_video_upload_reply"
                                                   class="form-control"
                                                   id="pageresponse_edit_nofilter_video_upload_reply"
                                                   placeholder="<?php echo $this->lang->line("put your image url here or click upload") ?>"/>
                                            <div class="overlay_wrapper">
                                                <span></span>
                                                <video width="100%" height="240" controls
                                                       style="border:1px solid #ccc;display:none;">
                                                    <source src=""
                                                            id="pageresponse_edit_nofilter_video_upload_reply_display"
                                                            type="video/mp4">
                                                    <?php echo $this->lang->line("your browser does not support the video tag.") ?>
                                                </video>
                                            </div>
                                ...
                                <div>
                                    <select class="form-group private_reply_postback"
                                            id="pageresponse_edit_nofilter_word_found_text_private"
                                            name="pageresponse_edit_nofilter_word_found_text_private">
                                        <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                    </select>
        ...
        <input type="hidden" name="pageresponse_edit_ai_reply_enabled" value="0" id="pageresponse_edit_ai_reply_enabled">
            ...
            <div class="modal-footer" style="padding-left: 45px; padding-right: 45px; ">
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-primary float-left" id="pageresponse_edit_save_button"><i
