    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#save_button_template', function () {
            ...
            if (typeof (schedule_type) === 'undefined') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', Youdidntselectanyoptionyet, 'warning');
                return false;
            }

            if (auto_campaign_name_template == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', TypeAutoCampaignname, 'warning');
                return false;
            }
            ...
            if (schedule_type == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', YouDidnotchosescheduleType, 'warning');
                return false;
            }

            if (schedule_type == "onetime") {
                if (schedule_time == '') {
                    swal.fire('<?php echo $this->lang->line("Warning"); ?>', YouDidnotchosescheduletime, 'warning');
                    return false;
                }
                if (time_zone == '') {
                    swal.fire('<?php echo $this->lang->line("Warning"); ?>', YouDidnotchosescheduletimezone, 'warning');
                    return false;
                }
            }
            if (schedule_type == "periodic") {
                if (periodic_time == '') {
                    swal.fire('<?php echo $this->lang->line("Warning"); ?>', YoudidnotSelectPerodicTime, 'warning');
                    return false;
                }
                ...
                if (campaign_start_time == '') {
                    swal.fire('<?php echo $this->lang->line("Warning"); ?>', YoudidnotSelectCampaignStartTime, 'warning');
                    return false;
                }
                if (campaign_end_time == '') {
                    swal.fire('<?php echo $this->lang->line("Warning"); ?>', YoudidnotSelectCampaignEndTime, 'warning');
                    return false;
                }
                ...
                if (comment_start_time == '' || comment_end_time == '') {
                    swal.fire('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line('Please select comment between times.');?>", 'warning');
                    return false;
                }

                if (rep1 >= rep2) {
                    swal.fire('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line('Comment between start time must be less than end time.');?>", 'warning');
                    return false;
                }
            }
        ...
        $(document).on('click', '#edit_save_button_template', function () {
            ...
            if ($("#edit_auto_comment_template_id").val() == 0) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("you have not select any template.");?>', 'warning');
                return false;
            }
