<script type="text/javascript">
    ...
    function get_subscriber_action_content(id, subscribe_id, page_id) {
        $(".multi_layout").html(' <div class="text-center waiting"><i class="bx bx-loader-alt bx-spin blue text-center"></i></div>');
        ...
        $.ajax({
            ...
            success: function (response) {
                response = response.replaceAll('fas fa-ellipsis-v', 'bx bx-dots-vertical-rounded');
    ...
    $("document").ready(function () {
        $(document).on('click', '.client_thread_subscribe_unsubscribe', function (e) {
            ...
            $.ajax({
                ...
                data: {
                    client_subscribe_unsubscribe_status: client_subscribe_unsubscribe_status,
                    subscriber_details_page: '1',
        ...
        $(document).on('click', '.client_thread_start_stop', function (e) {
            ...
            $.ajax({
                ...
                data: {
                    client_thread_start_stop: client_thread_start_stop,
                    call_from_conversation: call_from_conversation
                },
                success: function (response) {
                    $(this).removeClass('btn-progress');
                    $("#save_changes").removeClass('btn-progress');
        ...
        $(document).on('click', '#save_changes', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    iziToast.success({
                        title: '',
                        message: '<?php echo $this->lang->line("Subscriber information has been saved successfully."); ?>',
                        position: 'bottomRight'
                    });
                }
            });
                    ...
                    if (willDelete.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                iziToast.success({
                                    title: '',
                                    message: '<?php echo $this->lang->line("Subscriber has been deleted successfully."); ?>',
                                    position: 'bottomRight'
                                });
                            }
                        });
