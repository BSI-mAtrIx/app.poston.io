...
<div class="card <?php if ($iframe == '1') echo 'shadow-none'; ?>">
    <div class="card-body <?php if ($iframe == '1') echo 'p-0 overflow-hidden'; ?>">
        ...
        <div class="row">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-6">
                                            <div class="custom-control custom-switch custom-control-inline">
                                                ...
                                                <label class="custom-control-label mr-1" for="parent_postback"></label>
                                        ...
                                        <div class="col-6">
                                            <div class="custom-control custom-switch custom-control-inline">
                                                ...
                                                <label class="custom-control-label mr-1" for="child_postback"></label>
                                                <span><?php echo $this->lang->line("Child"); ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="postback_section">
                                ...
                                <input
                                        ...
                                        elseif ((isset($action_type) && $action_type == 'clone')) echo "";
                                            ...
                                            if (isset($bot_info['postback_id'])) echo $bot_info['postback_id'];
                                        }
                                        ?>"
                                ...
                                if ((!(isset($action_type) && $action_type == 'clone'))) {
                                    echo " : <b>";
                                    if (set_value('postback_id')) echo set_value('postback_id'); else {
                                        if (isset($bot_info['postback_id'])) echo $bot_info['postback_id'];
                                    }
                                    echo "</b>";
                                }
                    ...
                    <div class="row" id="keywords_div" style="display: none;">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="keywords_list"
                                          id="keywords_list"><?php if (isset($bot_info['keywords'])) echo $bot_info['keywords']; ?></textarea>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="<?php if ($iframe == '1') echo 'col-5'; else echo 'col-7' ?>">
                                                        <label class="custom-switch mt-2 float-left">
                                                            <input type="checkbox"
                                                                   ...
                                                                   class="custom-control-input" <?php if (isset($full_message[$k]["typing_on_settings"]) && $full_message[$k]["typing_on_settings"] == 'on') echo 'checked'; ?> >
                                                ...
                                                <div id="quick_reply_sort_<?php echo $k; ?>">
                                                    ...
                                                    for ($i = 1; $i <= 11; $i++) : ?>
                                                        <div class="row button_border"
                                                             id="quick_reply_row_<?php echo $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['quick_replies'][$i - 1])) echo 'style="display: none;"'; else $quickreply_add_button_display++; ?> >
                                                            ...
                                                            <div class="col-10 col-sm-3">
                                                                <div class="form-group"
                                                                    ...
                                                                    <div>
                                                                        <select class="form-control push_postback select2 this_page-dropdown-item"
                                        ...
                                        <div class="row" id="media_div_<?php echo $k; ?>"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div id="media_postback_sort_<?php echo $k; ?>">
                                                    ...
                                                    for ($i = 1; $i <= 3; $i++) : ?>
                                                        <div class="row button_border"
                                                             id="media_row_<?php echo $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['attachment']['payload']['elements'][0]['buttons'][$i - 1])) echo 'style="display: none;"'; else $media_add_button_display++; ?> >
                                                            <div class="col-12 col-sm-4">
                                                                <div class="form-group">
                                                                    <label><?php echo $this->lang->line("button text"); ?></label>
                                                                    <input type="text" class="form-control"
                                                            ...
                                                            <div class="col-10 col-sm-3">
                                                                <div class="form-group"
                                                                     id="media_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['attachment']['payload']['elements'][0]['buttons'][$i - 1]['payload']) || $full_message[$k]['attachment']['payload']['elements'][0]['buttons'][$i - 1]['type'] != 'postback') echo 'style="display: none;"'; ?> >
                               ...
                               class='btn-sm full_lead_first_name button-outline'><i
                                        class='bx bx-user'></i> <?php echo $this->lang->line("Full Name") ?></a>
                                                ...
                                                <div id="text_button_sort_<?php echo $k; ?>">
                                                    ...
                                                    for ($i = 1; $i <= 3; $i++) : ?>
                                                        <div class="row button_border"
                                                             id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['attachment']['payload']['buttons'][$i - 1])) echo 'style="display: none;"'; else $textwithbutton_add_button_display++; ?> >
                                                            <div class="col-12 col-sm-4">
                                                                <div class="form-group">
                                                                    <label><?php echo $this->lang->line("button text"); ?></label>
                                                                    <input type="text" class="form-control"
                                                            ...
                                                            <div class="col-10 col-sm-3">
                                                                <div class="form-group"
                                                                     id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['attachment']['payload']['buttons'][$i - 1]['payload']) || $full_message[$k]['attachment']['payload']['buttons'][$i - 1]['type'] != 'postback') echo 'style="display: none;"'; ?> >
                                                ...
                                                <div class="card card-secondary">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div id="generic_button_sort_<?php echo $k; ?>">
                                                            ...
                                                            for ($i = 1; $i <= 3; $i++) : ?>
                                                                <div class="row button_border"
                                                                     id="generic_template_row_<?php echo $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['attachment']['payload']['elements'][0]['buttons'][$i - 1])) echo 'style="display: none;"'; else $generic_add_button_display++; ?> >
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            <label><?php echo $this->lang->line("button text"); ?></label>
                                                                            <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="col-10 col-sm-3">
                                                                        <div class="form-group"
                                                                             id="generic_template_button_postid_div_<?php echo $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['attachment']['payload']['elements'][0]['buttons'][$i - 1]['payload']) || $full_message[$k]['attachment']['payload']['elements'][0]['buttons'][$i - 1]['type'] != 'postback') echo 'style="display: none;"'; ?>>
                                        ...
                                        <div class="row" id="carousel_div_<?php echo $k; ?>"
                                            ...
                                            <div class="col-12" id="carousel_reply_sort_<?php echo $k; ?>">
                                                ...
                                                <?php $carousel_template_counter = 0;
                                                for ($j = 1; $j <= 10; $j++) : ?>
                                                    <div class="col-12"
                                                         id="carousel_div_<?php echo $j; ?>_<?php echo $k; ?>"
                                                         style="<?php if (!isset($full_message[$k]['attachment']['payload']['elements'][$j - 1])) echo 'display: none;'; else $carousel_template_counter++; ?>">
                                                        <div class="card card-secondary">
                                                            <div class="card-header">
                                                                <h4 class="full_width">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div id="carousel_button_sort_<?php echo $j; ?>_<?php echo $k; ?>">
                                                                    ...
                                                                    for ($i = 1; $i <= 3; $i++) : ?>
                                                                        <div class="row button_border"
                                                                             id="carousel_row_<?php echo $j . "_" . $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['attachment']['payload']['elements'][$j - 1]['buttons'][$i - 1])) echo 'style="display: none;"'; else $carousel_add_button_display++; ?>>
                                                                            <div class="col-12 col-sm-4">
                                                                                <div class="form-group">
                                                                                    <label><?php echo $this->lang->line("button text"); ?></label>
                                                                                    <input type="text"
                                                                            ...
                                                                            <div class="col-10 col-sm-3">
                                                                                <div class="form-group"
                                                                                     id="carousel_button_postid_div_<?php echo $j . "_" . $i; ?>_<?php echo $k; ?>" <?php if (!isset($full_message[$k]['attachment']['payload']['elements'][$j - 1]['buttons'][$i - 1]['payload']) || $full_message[$k]['attachment']['payload']['elements'][$j - 1]['buttons'][$i - 1]['type'] != 'postback') echo 'style="display: none;"'; ?> >
            ...
            <div class="d-none d-lg-block col-lg-3 img_holder <?php if ($iframe == "1") echo 'hidden'; ?>">
