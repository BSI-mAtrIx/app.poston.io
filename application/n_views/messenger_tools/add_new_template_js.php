...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#submit', function (e) {
                    ...
                    for (var n = 1; n <= submited_media_counter; n++) {
                        ...
                        if (media_type_check == '') {
                            ...
                            if (media_post_id_check == template_postback_id) {
                                swal.fire('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line('Please use different ID for main postback and button type postback.')?>", 'warning');
                                return;
                            }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (is_iframe == '1') {
                        swal.fire('<?php echo $this->lang->line("Success"); ?>', "<?php echo $this->lang->line('Template has been created successfully.'); ?>", 'success');
                    } else {
        ...
        //    <?php //if($is_iframe==1){
        //    echo "
        //        parent.resizeIframe_parent('#add_template_modal iframe');
        //        ";
        //}?>
        //},5000);
    });
