        ...
        <div class="breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item"><a
                                href="<?php echo base_url("messenger_bot_broadcast/rcn_subscriber_broadcast_campaign"); ?>"><?php echo $this->lang->line("RCN Subscriber Broadcast"); ?></a>
                    </li>
...
<div class="row multi_layout">  
  ...
  <div class="col-12 col-md-4 col-lg-4 colmid" id="middle_column">
      <div class="card main_card">
        ...
        <div class="card-body">
          <?php include(FCPATH."application/n_views/messenger_tools/rcn_manager/summary.php") ?>
        </div>
     </div>
  </div>
</div>
