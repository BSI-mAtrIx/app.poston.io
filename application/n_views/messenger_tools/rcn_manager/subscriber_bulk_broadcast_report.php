...
?>
    ...
    <div class="row">
        <div class="col-12">
            <a href="<?php echo base_url('messenger_bot_broadcast/rcn_create_subscriber_broadcast_campaign'); ?>"
          ...
          <div class="card-body data-card">
            <div class="row">
              ...
              <div class="col-12 col-md-3">
              	...
              	<?php
				echo $drop_menu ='<a href="javascript:;" id="campaign_date_range" class="btn btn-primary float-right icon-left btn-icon"><i class="fas fa-calendar"></i> '.$this->lang->line("Choose Date").'</a><input type="hidden" id="campaign_date_range_val">';
				?>
