                                    ...
                                    <div class="card card-primary"
                                        ...
                                        <div class="card-header">
                                            <h4 class="full_width"><?php echo $this->lang->line('Reply') . " " . $k; ?>
                                                ...
                                                <?php if ($k != 1) : ?>
                                                    <i class="bx bx-time remove_reply float-right red"
                                                                ...
                                                                <div class="row button_border"
                                                                    ...
                                                                    <div class="col-10 col-sm-3">
                                                                        ...
                                                                        <div class="form-group"
                                                                            ...
                                                                            <a href="" class="ref_template float-right"><i
                                                                                        class="bx bx-refresh"></i> <?php echo $this->lang->line("Refresh"); ?>
                                                                            </a>
                                                                        </div>
                                                                    ...
                                                                    <?php if ($i != 1) : ?>
                                                                        <div class="col-2 col-sm-1">
                                                                            <br/>
                                                                            <i class="bx bx-time red item_remove"
                                                                            ...
                                                                            <div class="col-12 col-sm-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control generic_template_button_type_class"
                                                                                        ...
                                                                                        <option value="post_back"
                                                                                                id="unsubscribe_postback" <?php echo $hide_generic_item; ?>><?php echo $this->lang->line("unsubscribe"); ?></option>
                                                                                        <option value="post_back"
                                                                                                id="resubscribe_postback" <?php echo $hide_generic_item; ?>><?php echo $this->lang->line("re-subscribe"); ?></option>

                                                                                        <option value="post_back"
                                                                                                id="human_postback" <?php echo $hide_generic_item; ?>><?php echo $this->lang->line("Chat with Human"); ?></option>
                                                                                        <option value="post_back"
                                                                                                id="robot_postback" <?php echo $hide_generic_item; ?>><?php echo $this->lang->line("Chat with Robot"); ?></option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-10 col-sm-3">
                                                                ...
                                                                <div class="card card-secondary">
                                                                    <div class="card-header">
                                                                        <h4 class="full_width"><?php echo $this->lang->line('Carousel Template') . ' ' . $j; ?>
                                                                            <?php if ($j != 1) : ?>
                                                                                <i class="bx bx-time remove_carousel_template float-right red"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <button id="submit" class="btn  btn-primary"><i
                                                class="bx bx-send"></i> <?php echo $this->lang->line('submit'); ?>
                                    </button>
                                </div>
                                <div class="col-6">
                                    <a class="btn  btn-secondary float-right"
                                       href="<?php echo base_url("messenger_bot/ig_bot_settings/") . $page_info['id'] . "/1"; ?>"><i
...
$drop_menu = '<a href="' . $builder_load_url . '" class="float-right btn btn-primary" type="button" target="_BLANK"><i class="bx bx-plus-circle"></i> ' . $this->lang->line("Set Keywords") . '</a> <a id="add_bot_settings" href="" class="float-right btn btn-primary"><i class="bx bx-plus-circle"></i> ' . $this->lang->line('Use Classic Builder') . '</a>';
?>
...
<div class="table-responsive data-card" id="bot_list_datatable">
    <table class="table table-bordered table-sm table-striped" id="mytable">
        ...
        foreach ($bot_settings as $key => $value) {
            ...
            if ($value['status'] == '1') {
                $current_status = '<i class="bx bx-circle green"></i> ' . $this->lang->line("Live");
            } else {
                $current_status = '<i class="bx bx-circle gray"></i> ' . $this->lang->line("Paused");
            }
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i
                            class="bx bx-info-circle"></i> <?php echo $this->lang->line('campaign error'); ?></h4>
            </div>
            <div class="modal-body">
