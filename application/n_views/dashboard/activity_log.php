<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="breadcrumbs-top">
            <h5 class="content-header-title float-left pr-1 mb-0"><?php echo $this->lang->line("Recent Activity"); ?></h5>
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>dashboard"><i
                                    class="bx bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active"><?php echo $this->lang->line("Recent Activity"); ?></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card-body" style="padding: 0 !important;">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4><i class="bx bx-share"></i> <?php echo $this->lang->line("Facebook Poster Campaign") ?>
                            </h4>
                        </div>
                        <div class="card-body data-card">
                            ...
                            foreach ($facebook_poster as $key => $value) {
                                ...
                                echo "<td class='text-center'><a href='" . $value["post_url"] . "' target='_blank'><i class='bx bx-hand-right'></i> " . $this->lang->line('Go to Post.') . "</a></td>";
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4><i class="bx bx-send"></i> <?php echo $this->lang->line("Bulk Message Campaign") ?></h4>
                        </div>
                        <div class="card-body data-card">
                            <?php
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4><i class="bx bx-reply-all"></i> <?php echo $this->lang->line("Auto reply Campaign") ?>
                            </h4>
                        </div>
                        <div class="card-body data-card">
                            <?php
                ...
                <?php if ($this->basic->is_exist("add_ons", array("project_id" => 21))) : ?>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4><i class="bx bx-tv"></i> <?php echo $this->lang->line("Facebook Live Campaign") ?>
                                </h4>
                            </div>
                            <div class="card-body data-card">
                                <?php
                ...
                <?php if ($this->basic->is_exist("add_ons", array("project_id" => 20))) : ?>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4><i class="bx bx-task"></i> <?php echo $this->lang->line("Comboposter Campaign") ?>
                                </h4>
                            </div>
                            <div class="card-body data-card">
                                <?php
