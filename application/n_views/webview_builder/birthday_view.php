            ...
            <div class="card">
                <form id="webview-form">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group"><label><?php echo $this->lang->line('Birth Date'); ?></label><input
                                    placeholder="YYYY-MM-DD" name="birthdate" type="text"
                                    class="datepicker_x form-control" placeholder=""/>
                        </div>
...
//PSID variable comes from bare-them.php file. 
        ...
        $("form").on('submit', function (event) {
            ...
            if ($("input[name='birthdate']").val() == '') {
                swal.fire('<?php echo $this->lang->line("Error"); ?>', '<?php echo $this->lang->line("Please select your birth date."); ?>', 'error');
                return false;
            }
