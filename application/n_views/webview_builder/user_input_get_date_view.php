            ...
            <div class="card">
                <form id="webview-form">
                    ...
                    <div class="card-body <?php echo $pclass; ?>">
                        ...
                        <div class="form-group"><input placeholder="<?php echo $placeholder; ?>" name="select_date"
                                                       id="select_date" type="text"
                                                       class="<?php echo $picker_class; ?> form-control no_radius"
                                                       placeholder=""/>
                        </div>
    ...
    $(document).ready(function () {
        ...
        $("form").on('submit', function (event) {
            ...
            if ($("input[name='select_date']").val() == '') {
                swal.fire('<?php echo $this->lang->line("Error"); ?>', '<?php echo $this->lang->line("Please select a Date."); ?>', 'error');
                return false;
            }
