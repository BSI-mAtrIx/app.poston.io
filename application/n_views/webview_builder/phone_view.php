            ...
            <div class="card">
                <form id="webview-form">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group"><label><?php echo $this->lang->line('Phone Number'); ?></label><input
                                    name="phone" type="text" class="form-control" placeholder=""/>
                        </div>
...
//PSID variable comes from bare-them.php file. 
        ...
        $("form").on('submit', function (event) {
            ...
            if ($("input[name='phone']").val() == '') {
                swal.fire('<?php echo $this->lang->line("Error"); ?>', '<?php echo $this->lang->line("Please Enter your Phone."); ?>', 'error');
                return false;
            }
