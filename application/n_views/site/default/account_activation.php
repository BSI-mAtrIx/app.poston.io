            ...
            <div class="card bg-authentication mb-0">
                <div class="row m-0">
                        ...
                        <div class="card disable-rounded-right d-flex justify-content-center mb-0 p-2 h-100">
                            ...
                            <div class="card-body" id="recovery_form">
                                ...
                                <form method="POST" action="<?php echo site_url(); ?>home/account_activation_action">
                                    ...
                                    <div class="form-group">
                                        <label class="text-bold-600"
                                               for="code"><?php echo $this->lang->line("Account Activation Code"); ?>
                                            *</label>
                                    ...
                                    <button type="submit" id="submit"
                                            class="btn btn-primary glow position-relative w-100"><?php echo $this->lang->line("Activate My Account"); ?>
                    ...
                    <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                        <?php if ($n_config['account_activation_view'] == 'false') { ?>
                            <div class="d-flex"><img class="img-fluid"
                                                     src="<?php echo base_url(); ?>n_assets/app-assets/images/pages/lock-screen.png"
                                                     alt="branding logo"></div>
                        <?php } else {
                            $current_language = $this->language;

                            $import_modal = 'false';
                            if (file_exists(APPPATH . 'n_eco_user/account_activation_html_' . strtolower($current_language) . '.php')) {
                                $import_modal = APPPATH . 'n_eco_user/account_activation_html_' . strtolower($current_language) . '.php';
                            } else {
                                if (file_exists(APPPATH . 'n_eco_user/account_activation_html_' . $n_config['account_activation_default_view'] . '.php')) {
                                    $import_modal = APPPATH . 'n_eco_user/account_activation_html_' . $n_config['account_activation_default_view'] . '.php';
                                }
                            }
