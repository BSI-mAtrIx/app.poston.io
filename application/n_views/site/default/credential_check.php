        ...
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
            ...
            <div class="card card-primary">
                <div class="card-header"><h4><i
                                class="bx bx-copyright"></i> <?php echo $this->lang->line("Register your software"); ?>
                    </h4></div>
                ...
                <div class="card-body" id="recovery_form">
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input id="purchase_code" type="text" class="form-control" id="purchase_code" name="email"
                        ...
                        <div class="form-group">
                            <button type="submit" id="submit" class="btn btn-primary btn-block" tabindex="4">
                                <i class="bx bx-paper-plane"></i> <?php echo $this->lang->line("Submit Purchase Code"); ?>
                            </button>
                        </div>
                    </form>
                </div>
