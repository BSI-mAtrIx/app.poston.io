    ...
    <div class="row">
        <div class="col-12">
            <form action="#" id="update_email_campaign_form" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="selected-tab" id="selected-tab"
                       value="<?php echo $template_id ? 'drag-and-drop-tab' : 'rich-text-editor-tab'; ?>">
                <div class="card">
                    <div class="card-body">
                        <div class="row" id="campaign_details">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="campaign_name" name="campaign_name"
                                           value="<?php echo $campaign_data[0]['campaign_name']; ?>"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input placeholder="<?php echo $this->lang->line('Email Subject'); ?>"
                                           ...
                                           value="<?php if (isset($campaign_data[0]['email_subject'])) echo $campaign_data[0]['email_subject']; else echo set_value('subject'); ?>"
                            ...
                            <div class="col-12">
                                ...
                                <ul class="nav nav-pills" id="email-template-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo $template_id ? '' : 'active'; ?>"
                                           id="rich-text-editor-tab" data-toggle="tab" href="#rich-text-editor"
                                           role="tab" aria-controls="rich-text-editor"
                                           aria-selected="true"><?php echo $this->lang->line('Rich Text Editor'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo $template_id ? 'active' : ''; ?>"
                                           id="drag-and-drop-tab" data-toggle="tab" href="#drag-and-drop" role="tab"
                                           aria-controls="drag-and-drop"
                                           aria-selected="false"><?php echo $this->lang->line('Drag and Drop'); ?></a>
                                    </li>
                                </ul>

                                <div class="tab-content" id="rich-text-editor-content">
                                    <div class="tab-pane fade show <?php echo $template_id ? '' : 'active' ?>"
                                         id="rich-text-editor" role="tabpanel" aria-labelledby="rich-text-editor-tab">
                                        <div class="form-group">
                                            ...
                                            <textarea id="message" name="message" class="form-control"
                                                      placeholder="<?php echo $this->lang->line("type your message here...") ?>"><?php if (isset($campaign_data[0]['email_message']) && !$template_id) echo $campaign_data[0]['email_message']; else echo set_value('message'); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade show <?php echo $template_id ? 'active' : '' ?>"
                                         id="drag-and-drop" role="tabpanel" aria-labelledby="drag-and-drop-tab">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-12 col-md-4">
                                                        ...
                                                        echo form_dropdown('user_gender', $gender_list, $campaign_data[0]['user_gender'], ' class="select2 form-control" id="user_gender"');
                                                        ?>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-12 col-md-4">
                                                        ...
                                                        echo form_dropdown('user_time_zone', $time_zone_numeric, $campaign_data[0]['user_time_zone'], ' class="select2 form-control" id="user_time_zone"');
                                                        ?>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-12 col-md-4">
                                                        ...
                                                        echo form_dropdown('user_locale', $locale_list, $campaign_data[0]['user_locale'], ' class="select2 form-control" id="user_locale"');
                                                        ?>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input placeholder="<?php echo $this->lang->line("Choose time"); ?>"
                                           ...
                                           value="<?php echo $campaign_data[0]['schedule_time']; ?>"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('time_zone', $time_zone, $campaign_data[0]['time_zone'], ' class="select2 form-control" id="time_zone" style="width:100%;"');
                                    ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer brTop">
                        <button class="btn btn-primary" id="update_campaign" name="update_campaign" type="button"><i
