<?php
include(FCPATH . 'application/n_views/sms_email_manager/email/email_section_css.php');
...
<div class="row">
    <div class="col-12">
        <a href="<?php echo base_url('sms_email_manager/create_email_campaign'); ?>" class="btn btn-primary mb-1">
            <i class="bx bx-plus-circle"></i> <?php echo $this->lang->line("New Email Campaign"); ?>
        </a>
    </div>
</div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="input-group float-left" id="searchbox">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-primary" id="email_search_submit"
    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i class="bx bx-list-ul"></i> <?php echo $this->lang->line("Email History") ?>
                </h3>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="javascript:;" id="sms_log_date_range"
                           class="btn btn-primary float-right has-icon-left btn-icon"><i
