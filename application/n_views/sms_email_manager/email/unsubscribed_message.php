...
<link rel="stylesheet"
      href="<?php echo base_url('plugins/alertifyjs/css/alertify.min.css?ver=' . $n_config['theme_version']) ?>"/>
<link rel="stylesheet"
      href="<?php echo base_url('plugins/alertifyjs/css/themes/default.min.css?ver=' . $n_config['theme_version']) ?>"/>
<link rel="stylesheet"
    ...
    <div class="inner-container">
        <svg id="svg" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 590 484.7">
            ...
            <g id="envelope">
                ...
                <g id="paper-group">
                    <rect id="paper" x="157.3" y="87.6" width="275.3" height="266.33" rx="26" ry="26" fill="#fff"
                          stroke="#543093" stroke-miterlimit="10" stroke-width="5"/>
                    <g id="face">
                        <g id="mouth">
                            <path id="mouth-scared" d="M275,220a18.7,18.7,0,0,1,35.9.1" fill="none" stroke="#543093"
                            ...
                            <path id="mouth-worry" d="M271.1,218.7c10-11.1,28.2-15,43.6-9.4" fill="none"
                                  stroke="#543093" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
                        ...
                        <g id="eye-group">
                            <g id="eyes" class="eyes">
                                <ellipse id="eye-right" cx="349" cy="172.8" rx="11.2" ry="13.8" fill="#543093"
                                         stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
                                <ellipse id="eye-left" cx="235.5" cy="172.8" rx="11.2" ry="13.8" fill="#543093"
                                         stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
                                <path id="eyebrow-sad-right" d="M341.9,133.7c2.6,5.3,14.8,14.1,24.3,14.7" fill="none"
                                      stroke="#543093" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
                                <path id="eyebrow-sad-left" d="M240.7,133.7c-2.6,5.3-14.8,14.1-24.3,14.7" fill="none"
                                      stroke="#543093" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
                            ...
                            <g id="eyebrows-happy">
                                <path id="eyebrow-happy-right" d="M366.2,146.3c-2.6-5.3-14.8-14.1-24.3-14.7" fill="none"
                                      stroke="#543093" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
                                <path id="eyebrow-happy-left" d="M216.4,146.3c2.6-5.3,14.8-14.1,24.3-14.7" fill="none"
                                      stroke="#543093" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5"/>
                            </g>
                        </g>
                    </g>
                ...
                <g id="shadow">
                    <path id="shadow-3" d="M263.3,279.7s11.3-8.1,13.1-9.3c9.9-6.5,27-5.8,36.9,0,1.7,1,13.5,9.3,13.5,9.3"
                ...
                <g id="Front">
                    <path id="Front-2" data-name="Front"
                          d="M139.8,381.9s127.5-99.5,136.5-105.4,27-5.8,36.9,0S449.8,382.1,449.8,382.1" fill="none"
                          stroke="#543093" stroke-miterlimit="10" stroke-width="5"/>
        ...
        <div class="bottom">
            ...
            <div class="buttons">
                <button class="btn btn-primary" id="subscribed" button-type="sub"><i
                            class="bx bx-bell"></i> <?php echo $this->lang->line("Subscribe"); ?></button>
                <button class="btn btn-danger" id="unsubscribe" button-type="unsub"><i
                            class="bx bx-bell-off"></i> <?php echo $this->lang->line("Unsubscribe"); ?></button>
            </div>
        </div>
    </div>
...
<script src="https://code.jquery.com/jquery-3.1.1.min.js?ver=<?php echo $n_config['theme_version']; ?>"></script>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="https://use.fontawesome.com/24f7885cb9.js?ver=<?php echo $n_config['theme_version']; ?>"></script>
<script src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/MorphSVGPlugin.min.js?ver=<?php echo $n_config['theme_version']; ?>"></script>
<script src="<?php echo base_url('plugins/alertifyjs/alertify.min.js?ver=' . $n_config['theme_version']) ?>"></script>
            ...
            if (contactid != '' || email != '') {
                $.ajax({
                    ...
                    data: {
                        ...
                        cam_id: cam_id,
                        cam_temp_table_id: cam_temp_table_id,
                    ...
                    success: function (response) {
                        ...
                        if (response == "1") {
                            ...
                            iziToast.success({
                                title: '',
                                message: '<?php echo $this->lang->line("you have successfully unsubscribed from our mailing services.")?>',
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response == "1") {
                            iziToast.success({
                                title: '',
                                message: '<?php echo $this->lang->line("you have successfully subscribed into our mailing services.")?>',
                                position: 'bottomRight'
                            });
                            $("#subscribed").hide();
                            $("#unsubscribe").show();
