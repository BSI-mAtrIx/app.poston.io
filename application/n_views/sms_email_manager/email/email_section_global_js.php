    ...
    $(document).ready(function ($) {
        ...
        var firstName = function (context) {
            ...
            var button = ui.button({
                contents: '<i class="bx bx-user"/> ' + '<?php echo $this->lang->line("First Name") ?>',
                container: 'body',
        ...
        var lastName = function (context) {
            ...
            // create button
            var button = ui.button({
                contents: '<i class="bx bx-user"/> ' + '<?php echo $this->lang->line("Last Name") ?>',
                container: 'body',
        ...
        var unsubscriberlink = function (context) {
            ...
            // create button
            var button = ui.button({
                contents: '<i class="bx bx-bell-off"/> ' + '<?php echo $this->lang->line("Unsubscribe Link") ?>',
                container: 'body',
        ...
        $(document).on('click', '#send_test_email', function (event) {
            ...
            if (!validateEmail(email) && email != "") {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Please provide valid email address"); ?>', 'warning');
                return;
            }
        ...
        $(document).on('click', '#save_smtp', function (event) {
            ...
            if (smtp_email == "" || smtp_email == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("SMTP Email is Required"); ?>', 'warning');
                return;
            }
            ...
            if (smtp_host == "" || smtp_host == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("SMTP Host is Required"); ?>', 'warning');
                return;
            }
            if (smtp_port == "" || smtp_port == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("SMTP Port is Required"); ?>', 'warning');
                return;
            }
            if (smtp_username == "" || smtp_username == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("SMTP Username is Required"); ?>', 'warning');
                return;
            }
            if (smtp_password == "" || smtp_password == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("SMTP Password is Required"); ?>', 'warning');
                return;
            }
            if (smtp_type == "") {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("SMTP Type is Required"); ?>', 'warning');
                return;
            }
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (response == '1') {
                                    iziToast.success({
                                        title: '',
                                        message: '<?php echo $this->lang->line('API Information has been Deleted Successfully.'); ?>',
        ...
        $(document).on('click', '#save_mailgun', function (event) {
            ...
            if (mailgun_email == "" || mailgun_email == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Email is Required"); ?>', 'warning');
                return;
            }
            ...
            if (mailgun_domain == "" || mailgun_domain == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Domain is Required"); ?>', 'warning');
                return;
            }
            if (mailgun_api_key == "" || mailgun_api_key == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("API Key is Required"); ?>', 'warning');
                return;
            }
        ...
        $(document).on('click', '#save_mandrill', function (event) {
            ...
            if (name == "" || name == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Name is Required"); ?>', 'warning');
                return;
            }
        ...
        $(document).on('click', '#save_sendgrid', function (event) {
            ...
            if (sendgrid_username == "" || sendgrid_username == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Username is Required"); ?>', 'warning');
                return;
            }
            ...
            if (sendgrid_password == "" || sendgrid_password == null) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', '<?php echo $this->lang->line("Password is Required"); ?>', 'warning');
                return;
            }
        ...
        $(document).on('change', '#page,#label_ids,#excluded_label_ids,#user_gender,#user_time_zone,#user_locale', function () {
            ...
            $("#total_targetted_subscribers").html('<i class="bx bx-loader-alt bx-spin"></i>');
        ...
        $(document).on('change', '#contacts_id', function (event) {
            ...
            $("#contact_emails").html('<i class="bx bx-loader-alt bx-spin"></i>');
            $("#total_targetted_subscribers").html('<i class="bx bx-loader-alt bx-spin"></i>');
        ...
        $(document).on('click', '#create_campaign', function () {
            ...
            if (email_subject == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line("Email Subject is Required"); ?>", 'warning');
                return;
            }

            /* Email Message field can't be empty */
            if ('' === message && '' === template_id) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line("Please write your message or select an email template."); ?>", 'warning');
                return;
            }

            /* Must select an email API to send emails */
            if (from_email == '') {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line("Please select a Email API"); ?>", 'warning');
                return;
            }

            // contact group and manual number
            if (page_name == "" && (contacts_id == "" || contacts_id == null || typeof (contacts_id) == 'undefined')) {
                swal.fire('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line("Please Select Contacts from Page or Contact Groups."); ?>", 'warning');
                return;
