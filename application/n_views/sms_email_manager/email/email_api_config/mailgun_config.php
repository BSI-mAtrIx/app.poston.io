...
<div class="row">
    <div class="col-12">
        <a href="#" class="btn btn-primary mb-1 new_mailgun">
            <i class="bx bx-plus-circle"></i> <?php echo $this->lang->line("New Mailgun API"); ?>
        </a>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header bbw">
                <h3 class="modal-title blue"><i
                            class="bx bx-plus-circle"></i> <?php echo $this->lang->line('New Mailgun API'); ?></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mailgun_domain"
                                               name="mailgun_domain">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mailgun_api_key"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch custom-control-inline">
                                            <input type="checkbox" name="mailgun_status" value="1" id="mailgun_status"
                                                   class="custom-control-input" checked>
                                            <label class="custom-control-label mr-1" for="mailgun_status"></label>
            ...
            <div class="modal-footer bg-whitesmoke">
                <button type="button" class="btn btn-primary" id="save_mailgun"><i class="bx bxs-save"></i> <span
...
<div class="modal fade" id="update_mailgun_api_form_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bbw">
                <h3 class="modal-title blue"><i
                            class="bx bx-edit"></i> <?php echo $this->lang->line('Update Mailgun API'); ?></h3>
                <button type="button" class="close rounded-pill" data-dismiss="modal" aria-label="Close"><i
                            class="bx bx-x"></i></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer bg-whitesmoke">
                <button type="button" class="btn btn-primary" id="update_mailgun"><i
