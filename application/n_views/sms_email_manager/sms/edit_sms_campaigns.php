    ...
    <div class="row">
        <div class="col-12">
            <form action="#" id="updated_sms_campaign_form" method="POST" enctype="multipart/form-data">
                <input type="hidden" value="<?php echo $campaign_data[0]["id"]; ?>" class="form-control"
                       name="campaign_id" id="campaign_id">
                <input type="hidden" value="<?php echo $campaign_data[0]["total_thread"]; ?>" class="form-control"
                       name="previous_thread" id="previous_thread">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center waiting">
                                    <i class="bx bx-sync bx-spin blue text-center"></i>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="campaign_name" name="campaign_name"
                                           value="<?php if (isset($campaign_data[0]['campaign_name'])) echo $campaign_data[0]['campaign_name']; else echo set_value('campaign_name'); ?>">
                                </div>
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('SMS API'); ?></label>
                                    <select name='from_sms' id='from_sms' class='form-control select2'
                                            style="width:100%;">
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('Message'); ?>
                                        <a href="#" data-placement="top" data-toggle="popover"
                                           ...
                                           data-content="<?php echo $this->lang->line("You can include Contacts #FIRST_NAME#, #LAST_NAME# as variable inside your message. The variable will be replaced by corresponding real values when we will send it."); ?>"><i
                                                    class='bx bx-info-circle'></i> </a>
                                    </label>
                                    <span class='float-right'>
                                            <a data-toggle="tooltip" data-placement="top"
                                               title='<?php echo $this->lang->line("You can include #LAST_NAME# variable inside your message. The variable will be replaced by real name when we will send it.") ?>'
                                               class='btn-outline btn-sm' id='contact_last_name'><i
                                                        class='bx bx-user'></i> <?php echo $this->lang->line("Last Name") ?></a>
                                        </span>
                                    <span class='float-right'>
                                            <a data-toggle="tooltip" data-placement="top"
                                               title='<?php echo $this->lang->line("You can include #FIRST_NAME# variable inside your message. The variable will be replaced by real name when we will send it.") ?>'
                                    ...
                                    <textarea id="message" name="message" class="form-control"
                                              ...
                                              style="height:140px !important;"><?php echo $campaign_data[0]['campaign_message']; ?></textarea>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-md-6">
                                                                <li class="list-group-item d-flex justify-content-between align-items-center pointer"
                                                                    title='<?php echo $this->lang->line('Total Page Subscribers With Phone Number'); ?>'>
                                                                    <?php echo $this->lang->line("Page Subscribers"); ?>
                                                                    <span class="badge badge-primary"
                                                                          id="page_subscriber">0</span>
                                                                </li>
                                                            </div>
                                                            <div class="col-12 col-md-6">
                                                                <li class="list-group-item d-flex justify-content-between align-items-center pointer"
                                                                    title='<?php echo $this->lang->line('Targetted Reach'); ?>'>
                                                                    <?php echo $this->lang->line("Targetted Reach"); ?>
                                                                    <span class="badge badge-primary"
                                                                          id="targetted_subscriber">0</span>
                                                                </li>
                                                            </div>
                                                        </div>
                                                    </ul>
                                            ...
                                            <div class="card-body right_body">
                                                <div class="form-group">
                                                    <ul class="list-group">
                                                        <div class="row">
                                                            <div class="col-12 col-md-6">
                                                                <li class="list-group-item d-flex justify-content-between align-items-center pointer"
                                                                    title='<?php echo $this->lang->line('Total Contact Group Numbers'); ?>'>
                                                                    <?php echo $this->lang->line("Contact Numbers"); ?>
                                                                    <span class="badge badge-primary"
                                                                          id="contact_numbers">0</span>
                                                                </li>
                                                            </div>
                                                            <div class="col-12 col-md-6">
                                                                <li class="list-group-item d-flex justify-content-between align-items-center pointer"
                                                                    title='<?php echo $this->lang->line('Total Manual Numbers'); ?>'>
                                                                    <?php echo $this->lang->line("Manual Numbers"); ?>
                                                                    <span class="badge badge-primary"
                                                                          id="manual_numbers">0</span>
                                                                </li>
                                                            </div>
                                                        </div>
                                                    </ul>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select multiple="multiple" class="form-control select2"
                                                            id="contacts_id" name="contacts_id[]" style="width:100%;">
                                                        <?php
                                                ...
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('Numbers To Send'); ?>
                                                        <a href="#" data-placement="top" data-toggle="popover"
                                                           title="<?php echo $this->lang->line("include lead user first name"); ?>"
                                                           data-content="<?php echo $this->lang->line("Beside contact groups If you also want to send messages to manual numbers, you can simply put your numbers in below field with comma separated. System will send message to both your contact numbers and also to your manual numbers."); ?>"><i
                                                                    class='bx bx-info-circle'></i> </a>
                                                    </label>
                                                    <span class="float-right">
                                                            <a href="#" data-placement="top" data-toggle="popover"
                                                               title="<?php echo $this->lang->line("include lead user first name"); ?>"
                                                               data-content="<?php echo $this->lang->line("If you want to upload numbers from your CSV file, you can upload your CSV file. You will see your uploaded files number at the below box."); ?>"><i
                                                                        class='bx bx-info-circle'></i> </a>
                                                            <a style="border-radius:5px;" id="import_from_csv"
                                                               data-toggle="modal" href='#csv_import_modal'
                                                               class="btn btn-outline-primary btn-sm"><i
                                                                        class="bx bx-upload"></i> <?php echo $this->lang->line('Upload CSV'); ?></a>
                                                        </span>
                                                    <textarea style='height:120px !important'
                                                              placeholder="<?php echo $this->lang->line('You can type comma seperated numbers with country code here. You can also import numbers from a CSV file and numbers will be mereged here.'); ?>"
                                                              id="to_numbers" name="to_numbers"
                                                              class="form-control"><?php echo $campaign_data[0]['manual_phone'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('Delay (second)'); ?>
                                        <a href="#" data-placement="top" data-toggle="popover"
                                           title="<?php echo $this->lang->line("Add Campaign Delay"); ?>"
                                           data-content="<?php echo $this->lang->line("If you want any delay during sending sms to phone numbers, then provide a delay, keep it blank if you do not need any delay."); ?>"><i
                                                    class='bx bx-info-circle'></i> </a>
                                    </label>
                                    <input type="text" class="form-control" id="campaign_delay" name="campaign_delay"
                                           value="<?php echo $campaign_data[0]['campaign_delay']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('Country Code'); ?>
                                        <a href="#" data-placement="top" data-toggle="popover"
                                           title="<?php echo $this->lang->line("Add or remove country code"); ?>"
                                           data-content="<?php echo $this->lang->line("If you want to add your country code to your contact numbers, then simply put you contry code here, then select add option from dropdown. Country Code will be added into your every contact number. You can also remove country code by selecting remove option from dropdown menu."); ?>"><i
                                                    class='bx bx-info-circle'></i> </a>
                                    </label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="country_code" name="country_code">
                                        <div class="input-group-append">
                                            <select class="custom-select select2" name="country_code_action"
                                                    id="country_code_action" style="width:100%;">
                                                <option value=""><?php echo $this->lang->line('Actions'); ?></option>
                                                <option value="1"
                                                        id="item-1"><?php echo $this->lang->line("Add"); ?></option>
                                                <option value="0"
                                                        id="item-2"><?php echo $this->lang->line("Remove"); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input placeholder="<?php echo $this->lang->line("Choose time"); ?>"
                                           ...
                                           value="<?php echo $campaign_data[0]['schedule_time'] ?>" type="text"/>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                    ...
                    <div class="card-footer bg-whitesmoke">
                        <button class="btn btn-primary" id="update_sms_campaign_btn" name="update_sms_campaign_btn"
                                type="button"><i
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title blue"><i
                            class="bx bxs-file-txt"></i> <?php echo $this->lang->line('Import numbers from CSV'); ?>
                </h3>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><i
                            class="bx bx-x-circle"></i> <?php echo $this->lang->line('Cancel'); ?></button>
                <button type="button" id="import_submit" class="btn btn-primary"><i
                            class="bx bx-upload"></i> <?php echo $this->lang->line('Import'); ?></button>
            </div>
        </div>
    </div>
</div>
