...
<head>
    ...
    <title><?php echo $this->lang->line("CSRF Token Mismatch!"); ?></title>
                ...
                <div class="col-xl-7 col-md-8 col-12">
                    <div class="card bg-transparent shadow-none">
                        <div class="card-body text-center bg-transparent">
                            ...
                            <h1 class="my-2 error-title"><?php echo $this->lang->line("CSRF Token Mismatch!"); ?></h1>
                            <p><?php echo $this->lang->line("We tried it, but failed when requesting data to the server."); ?></p>
