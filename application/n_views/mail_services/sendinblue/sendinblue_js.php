...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '#sendinblue-details-button', function (event) {
            ...
            var block_ele = $('#sendinblue-details-modal .modal-body');
            $(block_ele).block({
