...
<div class="row">
    <div class="col-12">
        <a id="add_feed" href="#" data-target="#sendinblue-integration-modal" data-toggle="modal"
...
<div class="modal fade" tabindex="-1" role="dialog" id="sendinblue-integration-modal" aria-hidden="true"
     data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i class="bx bx-plus-circle"></i> Sendinblue
                ...
                <form class="" id="sendinblue-integration-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="api-key" placeholder="Sendinblue API Key"
...
<div class="modal fade" role="dialog" id="sendinblue-details-modal" aria-hidden="true" data-backdrop="static"
     data-keyboard="false">
    <div class="modal-dialog" role="document" style="min-width:50%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Sendinblue - <?= $this->lang->line('Account Details') ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
