...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '#activecampaign-details-button', function (event) {
            ...
            var block_ele = $('#activecampaign-details-modal .modal-body');
            $(block_ele).block({
