...
<div class="row">
    <div class="col-12">
        <a id="add_feed" href="#" data-target="#acelle-integration-modal" data-toggle="modal"
...
<div class="modal fade" tabindex="-1" role="dialog" id="acelle-integration-modal" aria-hidden="true"
     data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><i class="bx bx-plus-circle"></i> Acelle
                ...
                <form class="" id="acelle-integration-form">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="tracking-name" name="tracking-name"
                                   autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="mt-5">
                        <button type="submit" class="btn btn-primary btn-shadow float-left" id="acelle-submit-button"><i
...
<div class="modal fade" role="dialog" id="acelle-details-modal" aria-hidden="true" data-backdrop="static"
     data-keyboard="false">
    <div class="modal-dialog" role="document" style="min-width:40%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Acelle - <?= $this->lang->line('Account Details') ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
            <div class="modal-body">
                <div class="card shadow-none">
                    <div class="card-header p-1 pb-0">
                        <h4 id="display-tracking-name"><?php echo $this->lang->line('Test Account'); ?></h4>
                    </div>
