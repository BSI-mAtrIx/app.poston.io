    ...
    <div class="section-body">
        <div class="row">
            ...
            <?php foreach ($comment_growth_tools[$media_type] as $growth_tool) :
                ...
                ?>
                <div class="col-12 <?php if ($media_type == 'fb') echo 'col-lg-2'; else echo 'col-lg-2'; ?> col-lg-2">
                        ...
                        <div class="wizard-steps mb-3">
                            <div class="wizard-step mx-1 my-0">
                                <div class="wizard-step-icon">
                                    <img class="img-fluid"
                                         width="<?php if ($media_type == 'fb') echo '80'; else echo '100'; ?>"
                                         src="<?php echo $growth_tool['img_path']; ?>" alt="">
                                </div>
            ...
            <?php if ($media_type == 'ig' AND file_exists(APPPATH.'modules/n_igstats/controllers/N_igstats.php')){ ?>
                <div class="col-12 <?php if ($media_type == 'fb') echo 'col-lg-2'; else echo 'col-lg-2'; ?> col-lg-2">
                    <a href="<?php echo base_url("n_igstats/index"); ?>" class="text-dark action_tag">
                        <div class="wizard-steps mb-3">
                            <div class="wizard-step mx-1 my-0">
                                <div class="wizard-step-icon">
                                    <img class="img-fluid"
                                         width="80"
                                         src="<?php echo base_url("assets/img/icon/clock.png"); ?>" alt="">
                                </div>
                                <div class="wizard-step-label"><?php echo $this->lang->line("Statistics"); ?></div>
                            </div>
                        </div>
                    </a>
                </div>
...
<style>
    ...
    .action_tag:hover .wizard-step-label {
