...
<div class="">
		  ...
		  <h5 class="text-center"><?php echo $this->lang->line("Sign Up"); ?></h5>

            <input type="hidden" name="csrf_token" id="csrf_token" value="<?php echo $this->session->userdata('csrf_token_session'); ?>">
              <div class="form-group col-md-6 p-x-0">
              ...
              <div class="form-group col-md-12 p-x-0">
            ...
            <div class="form-group col-md-6 p-x-0">
              <div class="custom-control custom-checkbox">
                ...
                <label class="custom-control-label" for="agree"><a target="_BLANK" href="<?php echo site_url();?>home/terms_use"><?php echo $this->lang->line("I agree with user terms");?></a></label>
              </div>
            </div>
            ...
            <div class="form-group col-md-6 p-x-0">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" name="agree" required class="custom-control-input" id="agree">
                <label class="custom-control-label" for="agree"><a target="_BLANK" href="<?php echo site_url();?>home/gdpr">I agree with GDPR policy</a></label>
              </div>
            </div>
          ...
          <div class="row sm-gutters">
            <div class="col-md-12">
	             <div class="text-muted text-center">
	            	<br>Have an account? <a href="<?php echo base_url('home/login'); ?>">Login here</a>
	        	</div>
	      	</div>
          </div>
