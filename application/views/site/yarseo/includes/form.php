...
<h5 class="modal-title" id="contactLabel"><?php echo $this->lang->line('Contact Us');?></h5>
<p class="modal-description"><?php echo $this->lang->line('Feel free to contact with us.'); ?></p>
...
<button type="submit" class="btn btn-blue"><?php echo $this->lang->line("Send Message");?></button>
</div>
</div>
</div>
</form>
