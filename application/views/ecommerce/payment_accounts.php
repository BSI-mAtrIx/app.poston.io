                  ...
                  <div class="card-footer p-3" style="border:1px solid #e4e6fc">
					  ...
					  <div class="row">
                        ...
                        <div class="form-group">
                            <label for=""><i class="fas fa-key"></i> Tap Secret Key </label>
                            <input name="tap_secret_api_key" value="<?php echo isset($xvalue['tap_secret_api_key']) ? $xvalue['tap_secret_api_key'] :""; ?>"  class="form-control" type="text">              
                            <span class="red"><?php echo form_error('tap_secret_api_key'); ?></span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card" id="payment_options">
                    ...
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
						...
						<div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo $this->lang->line("Tap checkout"); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                <input type="radio" name="Tap_enabled" value="1" class="selectgroup-input" <?php if($xdata2["Tap_enabled"]=='1') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("Yes") ?></span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="Tap_enabled" value="0" class="selectgroup-input" <?php if($xdata2["Tap_enabled"]=='0') echo 'checked'; ?>>
