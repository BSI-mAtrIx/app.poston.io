<?php 
$n_eco_builder_config['store_logo_light'] = 'upload/ecommerce/store_logo_light_388_1701674011276493.png';
...
$n_eco_builder_config['background_color_header_top'] = '#c27ba0';
$n_eco_builder_config['background_color_header_middle'] = 'black';
...
$n_eco_builder_config['header_text'] = '𝑴𝒂𝒌𝒆 𝒀𝒐𝒖𝒓 𝑺𝒕𝒚𝒍𝒆 𝑺𝒐 𝑭𝒊𝒕 𝒂𝒏𝒅 𝑪𝒉𝒊𝒄!';
...
$n_eco_builder_config['add_to_cart_color_bg'] = '#d9d2e9';
$n_eco_builder_config['add_to_cart_color_bg_hover'] = '#e69138';
$n_eco_builder_config['add_to_cart_color_font'] = 'black';
$n_eco_builder_config['add_to_cart_color_font_hover'] = 'black';
$n_eco_builder_config['home_add_to_cart_color_bg'] = '#d9d2e9';
$n_eco_builder_config['home_add_to_cart_color_bg_hover'] = '#e69138';
$n_eco_builder_config['home_add_to_cart_color_font'] = 'black';
$n_eco_builder_config['home_add_to_cart_color_font_hover'] = 'black';
$n_eco_builder_config['footer_background'] = '#222';
$n_eco_builder_config['footer_background_text_color'] = '#ffffff';
$n_eco_builder_config['footer_background_link_color'] = '#999999';
...
$n_eco_builder_config['menu_font_color_hover'] = '#a64d79';
$n_eco_builder_config['menu_font_color_active'] = '#e06666';
$n_eco_builder_config['product_single_items_related_title'] = 'Related Items';
$n_eco_builder_config['site_keywords'] = 'Fit &apos;n Wear
Dress
Hoodies
Jeans
Skirt
Tees and Blouse';
$n_eco_builder_config['site_description'] = 'Fit N Wear is not just a clothing shop; it&apos;s an experience tailored for those who appreciate both style and comfort. Nestled in the heart of the city, its storefront invites you with a sleek, modern design that hints at the fashion-forward pieces waiting inside.

Fit N Wear prides itself on offering an eclectic mix of clothing, ranging from athleisure to casual chic and formal wear. The quality of the fabrics and craftsmanship is evident upon closer inspection, emphasizing durability without compromising on style. Whether you&apos;re seeking the perfect pair of yoga pants for an active lifestyle or a sophisticated ensemble for a special event, this shop has it all.

Overall, Fit N Wear isn&apos;t merely a clothing shop—it&apos;s a destination where fashion, comfort, and conscientiousness intersect, providing an enriching shopping experience for those seeking style with substance.';
$n_eco_builder_config['store_lang'] = '';
$n_eco_builder_config['guest_register_form_type'] = 'btn';
$n_eco_builder_config['guest_register_form_type_btn_font_color'] = 'black';
$n_eco_builder_config['guest_register_form_type_btn_font_color_hover'] = '#9fc5e8';
$n_eco_builder_config['guest_register_form_type_btn_bg_color'] = '#6fa8dc';
$n_eco_builder_config['guest_register_form_type_btn_bg_color_hover'] = '';
...
$n_eco_builder_config['menu_mobile_float_background'] = '#444444';
$n_eco_builder_config['category_single_description'] = 'false';
$n_eco_builder_config['closed_alert'] = 'false';
$n_eco_builder_config['og_image_website'] = 'upload/ecommerce/og_image_website_388_1701703626168830.png';
...
$n_eco_builder_config['menu_swiper_name_hover_color'] = '#c27ba0';
$n_eco_builder_config['menu_swiper_radius'] = '50';
$n_eco_builder_config['font_color_product_dark'] = 'black';
...
$n_eco_builder_config['onesignal_app_key'] = '4e68f5a4-b5e1-4a25-8d9f-f8ae92aa490f';
