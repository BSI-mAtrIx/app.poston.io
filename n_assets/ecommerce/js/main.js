...
(function ($) {
    ...
    QuantityInput.prototype.init = function ($el) {
        ...
        self.$value = $el.val(self.value = parseInt($el.attr('data-quantityinput')));
...
(function ($) {
    ...
    var thumbsRefresh = function (self) {
        console.log(self.thumbsIsVertical);
        self.thumbsIsVertical = false;
    ...
    function openImageGallery(e) {
        ...
        if ($images.length) {
            ...
            if (typeof PhotoSwipe !== 'undefined') {
                ...
                photoSwipe.listen('imageLoadComplete', function(index, item) {
