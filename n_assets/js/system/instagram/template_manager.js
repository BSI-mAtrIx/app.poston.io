...
$(document).on('click', '#save_button', function () {
    ...
    if(page_table_id == '') {
        swal.fire(global_lang_warning, instagram_select_an_account, 'warning');
        return false;
    }

    if (typeof(reply_type) === 'undefined') {
        swal.fire(global_lang_warning, Youdidntselectanyoption, 'warning');
        return false;
    }
...
$(document).on('click','.add_template',function(e){
    ...
    if(page_id=="")
    {
      swal.fire(global_lang_warning, selectAnAccountFirst, 'warning');
      return false;
    }
