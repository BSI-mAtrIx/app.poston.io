 ...
 $(document).ready(function(){
    ...
    {     
        ...
        output += '<div class="card-header"><h4 class="modal-title text-center"><i class="bx bx-comments"></i> '+AutoComment+'</h4></div> <div class="card-body"><textarea type="text" name="auto_reply_comment_text[]" id="auto_reply_comment_text_'+x+'" class="form-control name_list w-100 height_70px" placeholder="'+AddComments+'"></textarea><span class="clearfix"><a href="#" class="font_size_10px text-center  btn btn-sm btn-outline-danger remove_field float-right clearfix"><i class="bx bx-times"></i> '+remove+'</a></span></div>';
        output += '</div>';
    ...
    $(document).on('click', '.edit', function(e){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $('#action').val('edit');
                $('.modal-title').html("<i class='bx bx-comments'></i> "+instagram_auto_comment_template_autocomment);
                $('.modal-header .modal-title').html("<i class='bx bx-comments'></i> "+instagram_auto_comment_template_please_give_the_following_information_for_post_auto_comment);
