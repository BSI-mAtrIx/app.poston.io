function MenuEditor(l, t) {
    var i = $("#" + l),
        r = {
            labelEdit: '<i class="bx bx-edit clickable"></i>',
            labelRemove: '<i class="bx bx-trash clickable"></i>',
            ...
            listOptions: {
                ...
                opener: {
                    as: "html",
                    close: '<i class="bx bx-minus"></i>',
                    open: '<i class="bx bx-plus"></i>',
                    openerCss: {
                        "margin-right": "10px",
                        float: "none"
                    },
    ...
    function f() {
        var e = $("<div>").addClass("btn-group float-right"),
            ...
            l = p({
                ...
                text: '<i class=\'bx bx-chevron-up-circle\' ></i>'
            }),
            n = p({
                classCss: "btn btn-secondary btn-sm btnDown btnMove",
                text: '<i class=\'bx bx-chevron-down-circle\' ></i>'
            }),
            o = p({
