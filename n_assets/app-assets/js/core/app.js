  ...
  if ($body.attr('data-framework') === 'laravel') {
    ...
    i18next
      ...
      .init({
        ...
        fallbackLng: "en",
        backend: {
          loadPath: base_url+"n_assets/app-assets/data/locales/{{lng}}.json"
        },
        returnObjects: true
      },
        function (err, t) {
  ...
  $(".search-input .input").on("keyup", function (e) {
    if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
      ...
      if (value != "") {
        ...
        // if($filename=='starter-list'){
          var url = base_url+"n_theme/module_search/"
        // }else{
        //   var url = base_url+"n_assets/app-assets/data/" + $filename + ".json"
        // }
