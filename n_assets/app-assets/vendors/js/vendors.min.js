                    ...
                    return n.wrapInner(f), f = e(".sliding-menu-wrapper", n), e("a", this).on("click", (function(t) {
                        ...
                        if (f.is(":animated")) t.preventDefault();
                            ...
                            e(this).closest("ul").hasClass("menu-panel-root") && (c = o), h ? ("#menu-panel-back" == i && (d = c.prev()), properties = !0 === l ? {
                                ...
                                marginLeft: s + p
                            }, f.stop(!0, !0).animate(properties, "fast")) : (d.insertAfter(c), !0 === u.backLabel ? e(".back", d).html('<i class="bx bx-left-arrow-circle back-in"></i>' + r) : e(".back", d).text(u.backLabel), properties = !0 === l ? {
                                marginRight: a - p
                            } : {
                                marginLeft: s - p
